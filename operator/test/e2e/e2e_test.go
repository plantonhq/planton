...
var _ = Describe("Manager", Ordered, func() {
	...
	// The manager's lifecycle is the shared helpers' (e2e_helpers_test.go),
	// so this container and the vault lanes each stand on their own.
	BeforeAll(deployManager)
	...
	AfterEach(func() {
		dumpManagerOnFailure(controllerPodName)
	...
	Context("Manager", func() {
		It("should run successfully", func() {
			...
			verifyControllerUp := func(g Gomega) {
				controllerPodName = managerPodName(g)
