...
func NewTLSRouteList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1alpha3:TLSRouteList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTLSRouteList(ctx *pulumi.Context,
	...
	var resource TLSRouteList
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1alpha3:TLSRouteList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
