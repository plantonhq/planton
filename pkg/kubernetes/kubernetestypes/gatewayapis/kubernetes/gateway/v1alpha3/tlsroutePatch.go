...
func NewTLSRoutePatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1:TLSRoutePatch"),
		},
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1alpha2:TLSRoutePatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TLSRoutePatch
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1alpha3:TLSRoutePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTLSRoutePatch(ctx *pulumi.Context,
	...
	var resource TLSRoutePatch
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1alpha3:TLSRoutePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
