...
func NewTLSRoute(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1alpha3:TLSRoute"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TLSRoute
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:TLSRoute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTLSRoute(ctx *pulumi.Context,
	...
	var resource TLSRoute
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:TLSRoute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
