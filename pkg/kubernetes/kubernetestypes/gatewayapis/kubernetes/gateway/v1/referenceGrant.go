...
func NewReferenceGrant(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:ReferenceGrant", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReferenceGrant(ctx *pulumi.Context,
	...
	var resource ReferenceGrant
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:ReferenceGrant", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
