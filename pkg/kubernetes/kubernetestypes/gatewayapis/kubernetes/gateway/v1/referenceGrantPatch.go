...
func NewReferenceGrantPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:ReferenceGrantPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReferenceGrantPatch(ctx *pulumi.Context,
	...
	var resource ReferenceGrantPatch
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:ReferenceGrantPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
