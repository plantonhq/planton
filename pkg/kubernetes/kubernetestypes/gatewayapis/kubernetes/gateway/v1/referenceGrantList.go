...
func NewReferenceGrantList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:ReferenceGrantList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReferenceGrantList(ctx *pulumi.Context,
	...
	var resource ReferenceGrantList
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:ReferenceGrantList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
