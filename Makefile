...
e2e-test-kubernetes-terraform-tier4:  ## Run Kubernetes Tier 4 Terraform (operators, addons) E2E tests
	go test -tags=e2e -timeout=150m -v -count=1 -run "Test(KubernetesZalandoPostgresOperator|KubernetesStrimziKafkaOperator|KubernetesElasticOperator|KubernetesAltinityOperator|KubernetesGatewayApiCrds|KubernetesGhaRunnerScaleSetController|KubernetesRookCephOperator|KubernetesExternalSecrets|KubernetesTekton|KubernetesGatewayClass|KubernetesGateway|KubernetesHttpRoute|KubernetesGrpcRoute|KubernetesTcpRoute|KubernetesTlsRoute|KubernetesReferenceGrant)_Terraform" ./e2e/...
