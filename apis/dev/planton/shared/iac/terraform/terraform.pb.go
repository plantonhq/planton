...
// 	protoc        (unknown)
// source: dev/planton/shared/iac/terraform/terraform.proto
...
func (TerraformOperationType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_shared_iac_terraform_terraform_proto_enumTypes[0].Descriptor()
}

func (TerraformOperationType) Type() protoreflect.EnumType {
	return &file_dev_planton_shared_iac_terraform_terraform_proto_enumTypes[0]
}
...
func (TerraformOperationType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_shared_iac_terraform_terraform_proto_rawDescGZIP(), []int{0}
}
...
func (TerraformBackendType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_shared_iac_terraform_terraform_proto_enumTypes[1].Descriptor()
}

func (TerraformBackendType) Type() protoreflect.EnumType {
	return &file_dev_planton_shared_iac_terraform_terraform_proto_enumTypes[1]
}
...
func (TerraformBackendType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_shared_iac_terraform_terraform_proto_rawDescGZIP(), []int{1}
}

var File_dev_planton_shared_iac_terraform_terraform_proto protoreflect.FileDescriptor

const file_dev_planton_shared_iac_terraform_terraform_proto_rawDesc = "" +
	"\n" +
	"0dev/planton/shared/iac/terraform/terraform.proto\x12 dev.planton.shared.iac.terraform*{\n" +
	...
	"$com.dev.planton.shared.iac.terraformB\x0eTerraformProtoP\x01ZBgithub.com/plantonhq/planton/apis/dev/planton/shared/iac/terraform\xa2\x02\x05DPSIT\xaa\x02 Dev.Planton.Shared.Iac.Terraform\xca\x02 Dev\\Planton\\Shared\\Iac\\Terraform\xe2\x02,Dev\\Planton\\Shared\\Iac\\Terraform\\GPBMetadata\xea\x02$Dev::Planton::Shared::Iac::Terraformb\x06proto3"

var (
	file_dev_planton_shared_iac_terraform_terraform_proto_rawDescOnce sync.Once
	file_dev_planton_shared_iac_terraform_terraform_proto_rawDescData []byte
)

func file_dev_planton_shared_iac_terraform_terraform_proto_rawDescGZIP() []byte {
	file_dev_planton_shared_iac_terraform_terraform_proto_rawDescOnce.Do(func() {
		file_dev_planton_shared_iac_terraform_terraform_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_shared_iac_terraform_terraform_proto_rawDesc), len(file_dev_planton_shared_iac_terraform_terraform_proto_rawDesc)))
	})
	return file_dev_planton_shared_iac_terraform_terraform_proto_rawDescData
}

var file_dev_planton_shared_iac_terraform_terraform_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_dev_planton_shared_iac_terraform_terraform_proto_goTypes = []any{
...
var file_dev_planton_shared_iac_terraform_terraform_proto_depIdxs = []int32{
...
func init() { file_dev_planton_shared_iac_terraform_terraform_proto_init() }
func file_dev_planton_shared_iac_terraform_terraform_proto_init() {
	if File_dev_planton_shared_iac_terraform_terraform_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_shared_iac_terraform_terraform_proto_rawDesc), len(file_dev_planton_shared_iac_terraform_terraform_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_shared_iac_terraform_terraform_proto_goTypes,
		DependencyIndexes: file_dev_planton_shared_iac_terraform_terraform_proto_depIdxs,
		EnumInfos:         file_dev_planton_shared_iac_terraform_terraform_proto_enumTypes,
	}.Build()
	File_dev_planton_shared_iac_terraform_terraform_proto = out.File
	file_dev_planton_shared_iac_terraform_terraform_proto_goTypes = nil
	file_dev_planton_shared_iac_terraform_terraform_proto_depIdxs = nil
}
