...
// 	protoc        (unknown)
// source: dev/planton/shared/cloudresourcekind/cloud_resource_provider.proto
...
func (CloudResourceProvider) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_enumTypes[0].Descriptor()
}

func (CloudResourceProvider) Type() protoreflect.EnumType {
	return &file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_enumTypes[0]
}
...
func (CloudResourceProvider) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescGZIP(), []int{0}
}
...
func (x *CloudResourceProviderMeta) Reset() {
	*x = CloudResourceProviderMeta{}
	mi := &file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_msgTypes[0]
...
var file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "dev/planton/shared/cloudresourcekind/cloud_resource_provider.proto",
	},
}
...
var (
	...
	E_ProviderMeta = &file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_extTypes[0]
)

var File_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto protoreflect.FileDescriptor

const file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_rawDesc = "" +
	"\n" +
	"Bdev/planton/shared/cloudresourcekind/cloud_resource_provider.proto\x12$dev.planton.shared.cloudresourcekind\x1a google/protobuf/descriptor.proto\"T\n" +
	...
	"\rprovider_meta\x12!.google.protobuf.EnumValueOptions\x18\xcd\xf9\x04 \x01(\v2?.dev.planton.shared.cloudresourcekind.CloudResourceProviderMetaR\fproviderMetaB\xc2\x02\n" +
	"(com.dev.planton.shared.cloudresourcekindB\x1aCloudResourceProviderProtoP\x01ZFgithub.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind\xa2\x02\x04DPSC\xaa\x02$Dev.Planton.Shared.Cloudresourcekind\xca\x02$Dev\\Planton\\Shared\\Cloudresourcekind\xe2\x020Dev\\Planton\\Shared\\Cloudresourcekind\\GPBMetadata\xea\x02'Dev::Planton::Shared::Cloudresourcekindb\x06proto3"

var (
	file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescOnce sync.Once
	file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescData []byte
)

func file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescGZIP() []byte {
	file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescOnce.Do(func() {
		file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_rawDesc), len(file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_rawDesc)))
	})
	return file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescData
}

var file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_goTypes = []any{
...
var file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_depIdxs = []int32{
...
func init() { file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_init() }
func file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_init() {
	if File_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_rawDesc), len(file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_goTypes,
		DependencyIndexes: file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_depIdxs,
		EnumInfos:         file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_enumTypes,
		MessageInfos:      file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_msgTypes,
		ExtensionInfos:    file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_extTypes,
	}.Build()
	File_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto = out.File
	file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_goTypes = nil
	file_dev_planton_shared_cloudresourcekind_cloud_resource_provider_proto_depIdxs = nil
}
