...
**Provider:** snowflake  
**Component Path:** `apis/dev/planton/provider/snowflake/snowflakedatabase/v1/`  
**Enum Value:** 52  
**ID Prefix:** snowdb
...
- Folder exists: `apis/dev/planton/provider/snowflake/snowflakedatabase/v1/`
...
```bash
cd apis/dev/planton/provider/snowflake/snowflakedatabase/v1/
go test -v
```
