...
// 	protoc        (unknown)
// source: dev/planton/provider/snowflake/snowflakedatabase/v1/spec.proto
...
func (x *SnowflakeDatabaseSpec) Reset() {
	*x = SnowflakeDatabaseSpec{}
	mi := &file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_msgTypes[0]
...
func (*SnowflakeDatabaseSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *SnowflakeDatabaseUserTask) Reset() {
	*x = SnowflakeDatabaseUserTask{}
	mi := &file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SnowflakeDatabaseUserTask) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc = "" +
	"\n" +
	">dev/planton/provider/snowflake/snowflakedatabase/v1/spec.proto\x123dev.planton.provider.snowflake.snowflakedatabase.v1\"\xc9\a\n" +
	...
	"traceLevel\x12k\n" +
	"\tuser_task\x18\x12 \x01(\v2N.dev.planton.provider.snowflake.snowflakedatabase.v1.SnowflakeDatabaseUserTaskR\buserTask\"\xcd\x01\n" +
	...
	"7com.dev.planton.provider.snowflake.snowflakedatabase.v1B\tSpecProtoP\x01Zigithub.com/plantonhq/planton/apis/dev/planton/provider/snowflake/snowflakedatabase/v1;snowflakedatabasev1\xa2\x02\x05DPPSS\xaa\x023Dev.Planton.Provider.Snowflake.Snowflakedatabase.V1\xca\x023Dev\\Planton\\Provider\\Snowflake\\Snowflakedatabase\\V1\xe2\x02?Dev\\Planton\\Provider\\Snowflake\\Snowflakedatabase\\V1\\GPBMetadata\xea\x028Dev::Planton::Provider::Snowflake::Snowflakedatabase::V1b\x06proto3"

var (
	file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc), len(file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_goTypes = []any{
	(*SnowflakeDatabaseSpec)(nil),     // 0: dev.planton.provider.snowflake.snowflakedatabase.v1.SnowflakeDatabaseSpec
	(*SnowflakeDatabaseUserTask)(nil), // 1: dev.planton.provider.snowflake.snowflakedatabase.v1.SnowflakeDatabaseUserTask
}
var file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.snowflake.snowflakedatabase.v1.SnowflakeDatabaseSpec.user_task:type_name -> dev.planton.provider.snowflake.snowflakedatabase.v1.SnowflakeDatabaseUserTask
...
func init() { file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_init() }
func file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_init() {
	if File_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc), len(file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto = out.File
	file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_depIdxs = nil
}
