...
func createListener(
	...
	provider *oci.Provider,
	lb *loadbalancer.LoadBalancer,
	lnSpec *ociapplicationloadbalancerv1.OciApplicationLoadBalancerSpec_Listener,
	deps []pulumi.Resource,
) error {
	protocolMap := map[ociapplicationloadbalancerv1.OciApplicationLoadBalancerSpec_Listener_Protocol]string{
		ociapplicationloadbalancerv1.OciApplicationLoadBalancerSpec_Listener_http:  "HTTP",
		ociapplicationloadbalancerv1.OciApplicationLoadBalancerSpec_Listener_http2: "HTTP2",
		ociapplicationloadbalancerv1.OciApplicationLoadBalancerSpec_Listener_tcp:   "TCP",
		ociapplicationloadbalancerv1.OciApplicationLoadBalancerSpec_Listener_grpc:  "GRPC",
	}
...
func buildListenerSslConfiguration(ssl *ociapplicationloadbalancerv1.OciApplicationLoadBalancerSpec_SslConfiguration) *loadbalancer.ListenerSslConfigurationArgs {
...
func buildConnectionConfiguration(cc *ociapplicationloadbalancerv1.OciApplicationLoadBalancerSpec_ConnectionConfiguration) *loadbalancer.ListenerConnectionConfigurationArgs {
