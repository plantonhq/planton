...
Splitting these into separate Planton components (e.g., OciAutonomousTransactionProcessing, OciAutonomousDataWarehouse) would mean:
...
Six fields accept `StringValueOrRef`, enabling `valueFrom` references to other Planton-managed resources:
