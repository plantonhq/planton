...
// 	protoc        (unknown)
// source: dev/planton/provider/auth0/auth0client/v1/stack_outputs.proto
...
func (x *Auth0ClientStackOutputs) Reset() {
	*x = Auth0ClientStackOutputs{}
	mi := &file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_msgTypes[0]
...
func (*Auth0ClientStackOutputs) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
func (x *Auth0SigningKey) Reset() {
	*x = Auth0SigningKey{}
	mi := &file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Auth0SigningKey) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"=dev/planton/provider/auth0/auth0client/v1/stack_outputs.proto\x12)dev.planton.provider.auth0.auth0client.v1\"\xbb\x03\n" +
	...
	"\fsigning_keys\x18\x06 \x03(\v2:.dev.planton.provider.auth0.auth0client.v1.Auth0SigningKeyR\vsigningKeys\x122\n" +
	...
	"thumbprintB\xe8\x02\n" +
	"-com.dev.planton.provider.auth0.auth0client.v1B\x11StackOutputsProtoP\x01ZYgithub.com/plantonhq/planton/apis/dev/planton/provider/auth0/auth0client/v1;auth0clientv1\xa2\x02\x05DPPAA\xaa\x02)Dev.Planton.Provider.Auth0.Auth0client.V1\xca\x02)Dev\\Planton\\Provider\\Auth0\\Auth0client\\V1\xe2\x025Dev\\Planton\\Provider\\Auth0\\Auth0client\\V1\\GPBMetadata\xea\x02.Dev::Planton::Provider::Auth0::Auth0client::V1b\x06proto3"

var (
	file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescData []byte
)

func file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDesc)))
	})
	return file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescData
}

var file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_goTypes = []any{
	(*Auth0ClientStackOutputs)(nil), // 0: dev.planton.provider.auth0.auth0client.v1.Auth0ClientStackOutputs
	(*Auth0SigningKey)(nil),         // 1: dev.planton.provider.auth0.auth0client.v1.Auth0SigningKey
}
var file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.auth0.auth0client.v1.Auth0ClientStackOutputs.signing_keys:type_name -> dev.planton.provider.auth0.auth0client.v1.Auth0SigningKey
...
func init() { file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_init() }
func file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_init() {
	if File_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto = out.File
	file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_goTypes = nil
	file_dev_planton_provider_auth0_auth0client_v1_stack_outputs_proto_depIdxs = nil
}
