...
// 	protoc        (unknown)
// source: dev/planton/provider/auth0/auth0resourceserver/v1/spec.proto
...
func (x *Auth0ResourceServerSpec) Reset() {
	*x = Auth0ResourceServerSpec{}
	mi := &file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_msgTypes[0]
...
func (*Auth0ResourceServerSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *Auth0ResourceServerScope) Reset() {
	*x = Auth0ResourceServerScope{}
	mi := &file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Auth0ResourceServerScope) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<dev/planton/provider/auth0/auth0resourceserver/v1/spec.proto\x121dev.planton.provider.auth0.auth0resourceserver.v1\x1a\x1bbuf/validate/validate.proto\x1a(dev/planton/shared/options/options.proto\"\xf8\x05\n" +
	...
	"\x06scopes\x18\n" +
	" \x03(\v2K.dev.planton.provider.auth0.auth0resourceserver.v1.Auth0ResourceServerScopeR\x06scopes\"X\n" +
	"\x18Auth0ResourceServerScope\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescriptionB\x98\x03\n" +
	"5com.dev.planton.provider.auth0.auth0resourceserver.v1B\tSpecProtoP\x01Zigithub.com/plantonhq/planton/apis/dev/planton/provider/auth0/auth0resourceserver/v1;auth0resourceserverv1\xa2\x02\x05DPPAA\xaa\x021Dev.Planton.Provider.Auth0.Auth0resourceserver.V1\xca\x021Dev\\Planton\\Provider\\Auth0\\Auth0resourceserver\\V1\xe2\x02=Dev\\Planton\\Provider\\Auth0\\Auth0resourceserver\\V1\\GPBMetadata\xea\x026Dev::Planton::Provider::Auth0::Auth0resourceserver::V1b\x06proto3"

var (
	file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDesc), len(file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_goTypes = []any{
	(*Auth0ResourceServerSpec)(nil),  // 0: dev.planton.provider.auth0.auth0resourceserver.v1.Auth0ResourceServerSpec
	(*Auth0ResourceServerScope)(nil), // 1: dev.planton.provider.auth0.auth0resourceserver.v1.Auth0ResourceServerScope
}
var file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.auth0.auth0resourceserver.v1.Auth0ResourceServerSpec.scopes:type_name -> dev.planton.provider.auth0.auth0resourceserver.v1.Auth0ResourceServerScope
...
func init() { file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_init() }
func file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_init() {
	if File_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDesc), len(file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto = out.File
	file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_auth0_auth0resourceserver_v1_spec_proto_depIdxs = nil
}
