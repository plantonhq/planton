...
// 	protoc        (unknown)
// source: dev/planton/provider/auth0/auth0resourceserver/v1/stack_outputs.proto
...
func (x *Auth0ResourceServerStackOutputs) Reset() {
	*x = Auth0ResourceServerStackOutputs{}
	mi := &file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_msgTypes[0]
...
func (*Auth0ResourceServerStackOutputs) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Edev/planton/provider/auth0/auth0resourceserver/v1/stack_outputs.proto\x121dev.planton.provider.auth0.auth0resourceserver.v1\"\xa9\x04\n" +
	...
	"5com.dev.planton.provider.auth0.auth0resourceserver.v1B\x11StackOutputsProtoP\x01Zigithub.com/plantonhq/planton/apis/dev/planton/provider/auth0/auth0resourceserver/v1;auth0resourceserverv1\xa2\x02\x05DPPAA\xaa\x021Dev.Planton.Provider.Auth0.Auth0resourceserver.V1\xca\x021Dev\\Planton\\Provider\\Auth0\\Auth0resourceserver\\V1\xe2\x02=Dev\\Planton\\Provider\\Auth0\\Auth0resourceserver\\V1\\GPBMetadata\xea\x026Dev::Planton::Provider::Auth0::Auth0resourceserver::V1b\x06proto3"

var (
	file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescData []byte
)

func file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDesc)))
	})
	return file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescData
}

var file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_goTypes = []any{
	(*Auth0ResourceServerStackOutputs)(nil), // 0: dev.planton.provider.auth0.auth0resourceserver.v1.Auth0ResourceServerStackOutputs
}
var file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_init() }
func file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_init() {
	if File_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto = out.File
	file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_goTypes = nil
	file_dev_planton_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_depIdxs = nil
}
