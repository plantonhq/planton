...
Planton adds composability (StringValueOrRef for resource_group) and consistency (same API pattern across all cloud providers) on top of Terraform/Pulumi.
...
## 6. Planton Design: The 80/20 Applied
...
- Tags the workspace with Planton metadata
