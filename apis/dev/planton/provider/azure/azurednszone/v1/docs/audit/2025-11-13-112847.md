...
**Provider:** azure  
**Component Path:** `apis/dev/planton/provider/azure/azurednszone/v1/`  
**Enum Value:** 403  
**ID Prefix:** azdns
...
✅ **Passed:**
- Folder exists under correct provider hierarchy: `apis/dev/planton/provider/azure/azurednszone/`
...
**Test Output:**
```
ok  	github.com/plantonhq/planton/apis/dev/planton/provider/azure/azurednszone/v1	0.397s
```
...
1. **Complete Terraform Implementation**
   ...
   - **Why:** Critical gap. Component cannot be deployed with Terraform currently. This blocks dual-IaC support which is a core Planton principle.
   - **How:** 
...
**Path to reference:** `apis/dev/planton/provider/gcp/gcpdnszone/v1/`
