...
✅ **Passed:**
- Folder exists at correct path: `apis/dev/planton/provider/azure/azurenatgateway/v1/`
...
- Tests execute successfully: `ok github.com/plantonhq/planton/apis/dev/planton/provider/azure/azurenatgateway/v1 0.399s`
...
- Shows Planton approach with example YAML configurations
...
4. **Fix v1/README.md**
   ...
   - **How:** Replace with NAT Gateway overview:
     ...
     - Why Planton created this component
...
**Path to reference:** `apis/dev/planton/provider/azure/azurevpc/v1/`
