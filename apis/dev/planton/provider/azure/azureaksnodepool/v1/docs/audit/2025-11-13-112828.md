...
**Provider:** azure  
**Component Path:** `apis/dev/planton/provider/azure/azureaksnodepool/v1/`  
**Enum Value:** 401  
**ID Prefix:** aksnp
...
✅ **Passed:**
- Folder exists under correct provider hierarchy: `apis/dev/planton/provider/azure/azureaksnodepool/`
...
- Tests execute successfully: `go test ./apis/dev/planton/provider/azure/azureaksnodepool/v1/`
...
5. **Re-run audit to verify improvements** - Use `@audit-planton-component AzureAksNodePool`
