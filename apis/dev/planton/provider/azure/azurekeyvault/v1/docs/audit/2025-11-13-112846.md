...
✅ **Passed:**
- Folder exists under correct provider hierarchy (apis/dev/planton/provider/azure/azurekeyvault/)
...
**Path to reference:** `apis/dev/planton/provider/aws/awssecretsmanager/v1/`
