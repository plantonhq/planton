...
- **Leaf resource** -- Currently, no other Planton resources reference AzurePrivateEndpoint outputs. It serves as the final networking component in the infra chart DAG.
