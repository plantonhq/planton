...
This document captures the research, design rationale, and 80/20 scoping decisions behind the `AzureFunctionApp` Planton component.
...
Private endpoints give the Function App a private IP address within the VNet, making it inaccessible from the public internet. This is modeled as a separate `AzurePrivateEndpoint` component in Planton, not as a field on AzureFunctionApp.
