...
**Provider:** azure  
**Component Path:** `apis/dev/planton/provider/azure/azureakscluster/v1/`  
**Enum Value:** 400  
**ID Prefix:** aks
...
- Folder exists under correct provider hierarchy: `apis/dev/planton/provider/azure/azureakscluster/`
...
- Tests execute successfully: `go test ./apis/dev/planton/provider/azure/azureakscluster/v1/`
...
PASS
ok  	github.com/plantonhq/planton/apis/dev/planton/provider/azure/azureakscluster/v1	0.487s
```
...
1. **Add v1/examples.md**
   ...
   - **File:** `apis/dev/planton/provider/azure/azureakscluster/v1/examples.md`
...
**Path to reference:** `apis/dev/planton/provider/aws/awsekscluster/v1/`
