...
// 	protoc        (unknown)
// source: dev/planton/provider/civo/civocertificate/v1/spec.proto
...
func (CivoCertificateType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_civo_civocertificate_v1_spec_proto_enumTypes[0].Descriptor()
}

func (CivoCertificateType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_civo_civocertificate_v1_spec_proto_enumTypes[0]
}
...
func (CivoCertificateType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
type CivoCertificateSpec struct {
	...
	Type CivoCertificateType `protobuf:"varint,2,opt,name=type,proto3,enum=dev.planton.provider.civo.civocertificate.v1.CivoCertificateType" json:"type,omitempty"`
...
func (x *CivoCertificateSpec) Reset() {
	*x = CivoCertificateSpec{}
	mi := &file_dev_planton_provider_civo_civocertificate_v1_spec_proto_msgTypes[0]
...
func (x *CivoCertificateLetsEncryptParams) Reset() {
	*x = CivoCertificateLetsEncryptParams{}
	mi := &file_dev_planton_provider_civo_civocertificate_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoCertificateLetsEncryptParams) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *CivoCertificateCustomParams) Reset() {
	*x = CivoCertificateCustomParams{}
	mi := &file_dev_planton_provider_civo_civocertificate_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoCertificateCustomParams) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_civo_civocertificate_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDesc = "" +
	"\n" +
	"7dev/planton/provider/civo/civocertificate/v1/spec.proto\x12,dev.planton.provider.civo.civocertificate.v1\x1a\x1bbuf/validate/validate.proto\x1a(dev/planton/shared/options/options.proto\"\xf3\x03\n" +
	...
	"\x04type\x18\x02 \x01(\x0e2A.dev.planton.provider.civo.civocertificate.v1.CivoCertificateTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\x12s\n" +
	"\flets_encrypt\x18\x03 \x01(\v2N.dev.planton.provider.civo.civocertificate.v1.CivoCertificateLetsEncryptParamsH\x00R\vletsEncrypt\x12c\n" +
	"\x06custom\x18\x04 \x01(\v2I.dev.planton.provider.civo.civocertificate.v1.CivoCertificateCustomParamsH\x00R\x06custom\x12*\n" +
	...
	"0com.dev.planton.provider.civo.civocertificate.v1B\tSpecProtoP\x01Z`github.com/plantonhq/planton/apis/dev/planton/provider/civo/civocertificate/v1;civocertificatev1\xa2\x02\x05DPPCC\xaa\x02,Dev.Planton.Provider.Civo.Civocertificate.V1\xca\x02,Dev\\Planton\\Provider\\Civo\\Civocertificate\\V1\xe2\x028Dev\\Planton\\Provider\\Civo\\Civocertificate\\V1\\GPBMetadata\xea\x021Dev::Planton::Provider::Civo::Civocertificate::V1b\x06proto3"

var (
	file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDesc), len(file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_civo_civocertificate_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_civo_civocertificate_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_civo_civocertificate_v1_spec_proto_goTypes = []any{
	(CivoCertificateType)(0),                 // 0: dev.planton.provider.civo.civocertificate.v1.CivoCertificateType
	(*CivoCertificateSpec)(nil),              // 1: dev.planton.provider.civo.civocertificate.v1.CivoCertificateSpec
	(*CivoCertificateLetsEncryptParams)(nil), // 2: dev.planton.provider.civo.civocertificate.v1.CivoCertificateLetsEncryptParams
	(*CivoCertificateCustomParams)(nil),      // 3: dev.planton.provider.civo.civocertificate.v1.CivoCertificateCustomParams
}
var file_dev_planton_provider_civo_civocertificate_v1_spec_proto_depIdxs = []int32{
	0, // 0: dev.planton.provider.civo.civocertificate.v1.CivoCertificateSpec.type:type_name -> dev.planton.provider.civo.civocertificate.v1.CivoCertificateType
	2, // 1: dev.planton.provider.civo.civocertificate.v1.CivoCertificateSpec.lets_encrypt:type_name -> dev.planton.provider.civo.civocertificate.v1.CivoCertificateLetsEncryptParams
	3, // 2: dev.planton.provider.civo.civocertificate.v1.CivoCertificateSpec.custom:type_name -> dev.planton.provider.civo.civocertificate.v1.CivoCertificateCustomParams
...
func init() { file_dev_planton_provider_civo_civocertificate_v1_spec_proto_init() }
func file_dev_planton_provider_civo_civocertificate_v1_spec_proto_init() {
	if File_dev_planton_provider_civo_civocertificate_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_civo_civocertificate_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDesc), len(file_dev_planton_provider_civo_civocertificate_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_civo_civocertificate_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_civo_civocertificate_v1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_civo_civocertificate_v1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_civo_civocertificate_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_civo_civocertificate_v1_spec_proto = out.File
	file_dev_planton_provider_civo_civocertificate_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_civo_civocertificate_v1_spec_proto_depIdxs = nil
}
