...
**Provider:** civo  
**Component Path:** `apis/dev/planton/provider/civo/civocertificate/v1/`  
**Enum Value:** 1501  
**ID Prefix:** cicert
...
1. **Create README.md at v1/ level**
   ...
   - **File:** `apis/dev/planton/provider/civo/civocertificate/v1/README.md`
...
2. **Create examples.md**
   ...
   - **File:** `apis/dev/planton/provider/civo/civocertificate/v1/examples.md`
...
- Folder exists: `apis/dev/planton/provider/civo/civocertificate/v1/`
...
**Path to reference:** `apis/dev/planton/provider/digital_ocean/digitalocean_certificate/v1/`
