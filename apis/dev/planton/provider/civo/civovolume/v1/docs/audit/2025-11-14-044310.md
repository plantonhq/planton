...
**Provider:** civo  
**Component Path:** `apis/dev/planton/provider/civo/civovolume/v1/`  
**Enum Value:** 1510  
**ID Prefix:** civol
...
- Folder exists: `apis/dev/planton/provider/civo/civovolume/v1/`
...
- No Planton perspective overview
...
- `apis/dev/planton/provider/civo/civobucket/v1/`
- `apis/dev/planton/provider/civo/civocertificate/v1/`
- `apis/dev/planton/provider/civo/civodatabase/v1/`
...
# 4. Re-audit
@audit-planton-component civovolume
```
