...
**Provider:** civo  
**Component Path:** `apis/dev/planton/provider/civo/civokubernetesnodepool/v1/`  
**Enum Value:** 1508  
**ID Prefix:** ciknp
...
- Folder exists: `apis/dev/planton/provider/civo/civokubernetesnodepool/v1/`
...
- Could add more concrete examples of Planton API usage
...
1. **Create spec_test.go with comprehensive tests**
   ...
   - **How:**
     ...
     - Run: `go test ./apis/dev/planton/provider/civo/civokubernetesnodepool/v1/ -v`
...
**Path to reference:** `apis/dev/planton/provider/digital_ocean/digitaloceankubernetesnodepool/v1/`
