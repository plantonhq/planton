...
**Provider:** civo  
**Component Path:** `apis/dev/planton/provider/civo/civocomputeinstance/v1/`  
**Enum Value:** 1502  
**ID Prefix:** ciinst
...
1. **Create spec_test.go**
   ...
   - **File:** `apis/dev/planton/provider/civo/civocomputeinstance/v1/spec_test.go`
...
2. **Create README.md at v1/ level**
   ...
   - **File:** `apis/dev/planton/provider/civo/civocomputeinstance/v1/README.md`
...
3. **Create examples.md**
   ...
   - **File:** `apis/dev/planton/provider/civo/civocomputeinstance/v1/examples.md`
...
2. **Empty Terraform Module**
   ...
   - **Files:**
     - `apis/dev/planton/provider/civo/civocomputeinstance/v1/iac/tf/main.tf`
     - `apis/dev/planton/provider/civo/civocomputeinstance/v1/iac/tf/provider.tf`
     - `apis/dev/planton/provider/civo/civocomputeinstance/v1/iac/tf/locals.tf`
     - `apis/dev/planton/provider/civo/civocomputeinstance/v1/iac/tf/outputs.tf`
...
3. **Missing User-Facing Documentation**
   ...
   - **Files:**
     - `apis/dev/planton/provider/civo/civocomputeinstance/v1/README.md`
     - `apis/dev/planton/provider/civo/civocomputeinstance/v1/examples.md`
...
- Folder exists: `apis/dev/planton/provider/civo/civocomputeinstance/v1/`
...
- Planton's design philosophy and integration approach
...
4. **Complete or Remove Terraform Module**
   - **Files:** `apis/dev/planton/provider/civo/civocomputeinstance/v1/iac/tf/*`
...
5. **Create Pulumi README.md**
   ...
   - **File:** `apis/dev/planton/provider/civo/civocomputeinstance/v1/iac/pulumi/README.md`
...
6. **Create Pulumi overview.md**
   - **File:** `apis/dev/planton/provider/civo/civocomputeinstance/v1/iac/pulumi/overview.md`
...
7. **Add Pulumi examples.md**
   ...
   - **File:** `apis/dev/planton/provider/civo/civocomputeinstance/v1/iac/pulumi/examples.md`
...
8. **Add Terraform README.md (if Terraform is completed)**
   - **File:** `apis/dev/planton/provider/civo/civocomputeinstance/v1/iac/tf/README.md`
...
**Path to reference:** `apis/dev/planton/provider/digital_ocean/digitalocean/droplet/v1/`
