...
**Provider:** civo  
**Component Path:** `apis/dev/planton/provider/civo/civodnszone/v1/`  
**Enum Value:** 1504  
**ID Prefix:** cidns
...
- Folder exists: `apis/dev/planton/provider/civo/civodnszone/v1/`
...
5. **Create Pulumi supporting documentation**
   ...
   - **Why:** Helps users running Pulumi directly (not through Planton CLI)
   - **How:**
...
7. **Add IaC-specific examples documentation**
   ...
   - **How:** Show direct Pulumi/Terraform usage (not just Planton abstraction)
   - **Impact:** +10.00% score
...
**Path to reference:** `apis/dev/planton/provider/digital_ocean/digitaloceandnszone/v1/`

**Other good references:**

- `apis/dev/planton/provider/aws/awsroute53zone/v1/` (AWS DNS zone)
- `apis/dev/planton/provider/gcp/gcpdnszone/v1/` (GCP DNS zone)
- `apis/dev/planton/provider/cloudflare/cloudflarednezone/v1/` (Cloudflare DNS zone)
...
**Audited by:** Planton Code Auditor
