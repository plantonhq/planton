...
**Provider:** civo  
**Component Path:** `apis/dev/planton/provider/civo/civobucket/v1/`  
**Enum Value:** 1500  
**ID Prefix:** cibkt
...
- Folder exists: `apis/dev/planton/provider/civo/civobucket/v1/`
...
```bash
cd apis/dev/planton/provider/civo/civobucket/v1/
go test -v
```
...
```
?       github.com/plantonhq/planton/apis/dev/planton/provider/civo/civobucket/v1 [no test files]
```
...
**Path to reference:** `apis/dev/planton/provider/digital_ocean/digitaloceanbucket/v1/`
...
6. Re-run audit to verify improvements: `@audit-planton-component CivoBucket`
