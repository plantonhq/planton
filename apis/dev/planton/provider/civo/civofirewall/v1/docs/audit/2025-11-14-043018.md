...
**Provider:** civo  
**Component Path:** `apis/dev/planton/provider/civo/civofirewall/v1/`  
**Enum Value:** 1505  
**ID Prefix:** cifw
...
1. **Create spec_test.go with validation tests**
   ...
   - **File:** `apis/dev/planton/provider/civo/civofirewall/v1/spec_test.go`
   - **Impact:** +5.55% score
...
2. **Create user-facing README.md**
   ...
   - **File:** `apis/dev/planton/provider/civo/civofirewall/v1/README.md`
   - **Impact:** +6.67% score
...
3. **Create examples.md file**
   ...
   - **File:** `apis/dev/planton/provider/civo/civofirewall/v1/examples.md`
   - **Impact:** +6.66% score
...
2. **Empty Terraform Implementation**
   ...
   - **File:** `apis/dev/planton/provider/civo/civofirewall/v1/iac/tf/main.tf` (and related files)
...
- Folder exists: `apis/dev/planton/provider/civo/civofirewall/v1/`
...
```bash
cd apis/dev/planton/provider/civo/civofirewall/v1/
go test -v
```
...
- Explains Planton's choice of Pulumi + Protobuf abstraction
...
**Path to reference:** `apis/dev/planton/provider/civo/civovpc/v1/`
