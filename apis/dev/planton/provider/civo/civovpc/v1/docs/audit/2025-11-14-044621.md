...
**Provider:** civo  
**Component Path:** `apis/dev/planton/provider/civo/civovpc/v1/`  
**Enum Value:** 1511  
**ID Prefix:** civpc
...
1. **Create spec_test.go with validation tests**
   ...
   - **File:** `apis/dev/planton/provider/civo/civovpc/v1/spec_test.go`
...
2. **Create README.md at v1 level**
   ...
   - **File:** `apis/dev/planton/provider/civo/civovpc/v1/README.md`
...
3. **Create examples.md at v1 level**
   ...
   - **File:** `apis/dev/planton/provider/civo/civovpc/v1/examples.md`
...
- Folder exists: `apis/dev/planton/provider/civo/civovpc/v1/`
...
```bash
cd apis/dev/planton/provider/civo/civovpc/v1/
go test -v
```
