...
**Provider:** civo  
**Component Path:** `apis/dev/planton/provider/civo/civokubernetescluster/v1/`  
**Enum Value:** 1507  
**ID Prefix:** cikc
...
1. **Create spec_test.go**
   ...
   - **File:** `apis/dev/planton/provider/civo/civokubernetescluster/v1/spec_test.go`
...
2. **Create README.md at v1 level**
   ...
   - **File:** `apis/dev/planton/provider/civo/civokubernetescluster/v1/README.md`
...
3. **Create examples.md**
   ...
   - **File:** `apis/dev/planton/provider/civo/civokubernetescluster/v1/examples.md`
...
2. **Incomplete Terraform Implementation**
   ...
   - **Files:**
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/tf/main.tf` (currently 0 bytes)
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/tf/locals.tf` (missing)
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/tf/outputs.tf` (missing)
...
3. **Missing Supporting Documentation**
   ...
   - **Files:**
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/pulumi/README.md` (missing)
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/pulumi/overview.md` (missing)
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/tf/README.md` (missing)
...
- Folder exists: `apis/dev/planton/provider/civo/civokubernetescluster/v1/`
...
2. **Complete Terraform Module**
   ...
   - **Files:**
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/tf/main.tf` (currently 0 bytes)
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/tf/locals.tf`
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/tf/outputs.tf`
...
3. **Create Supporting Documentation**
   - **Files:**
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/pulumi/README.md`
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/pulumi/overview.md`
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/tf/README.md`
...
1. **Expand Terraform variables.tf**
   ...
   - **File:** `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/tf/variables.tf`
...
2. **Add Optional IaC Examples**
   - **Files:**
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/pulumi/examples.md`
     - `apis/dev/planton/provider/civo/civokubernetescluster/v1/iac/tf/examples.md`
...
**Path to reference:** `apis/dev/planton/provider/civo/civobucket/v1/`
...
5. **Re-run audit to verify improvements**:
   ```bash
   @audit-planton-component CivoKubernetesCluster
   ```
