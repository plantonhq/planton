...
**Provider:** civo  
**Component Path:** `apis/dev/planton/provider/civo/civoipaddress/v1/`  
**Enum Value:** 1506  
**ID Prefix:** ciip
...
1. **Create user-facing README.md**
   ...
   - **File:** `apis/dev/planton/provider/civo/civoipaddress/v1/README.md`
...
2. **Create examples.md**
   ...
   - **File:** `apis/dev/planton/provider/civo/civoipaddress/v1/examples.md`
...
3. **Add spec_test.go with validation tests**
   ...
   - **File:** `apis/dev/planton/provider/civo/civoipaddress/v1/spec_test.go`
...
2. **Incomplete Terraform Module**
   ...
   - **Files:** `apis/dev/planton/provider/civo/civoipaddress/v1/iac/tf/main.tf`, `iac/tf/locals.tf`, `iac/tf/outputs.tf`
...
3. **Missing User Documentation**
   ...
   - **Files:** `apis/dev/planton/provider/civo/civoipaddress/v1/README.md`, `apis/dev/planton/provider/civo/civoipaddress/v1/examples.md`
...
- Folder exists: `apis/dev/planton/provider/civo/civoipaddress/v1/`
...
```bash
cd apis/dev/planton/provider/civo/civoipaddress/v1/
go test -v
```
