...
// 	protoc        (unknown)
// source: dev/planton/provider/cloudflare/cloudflared1database/v1/spec.proto
...
func (CloudflareD1Region) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_enumTypes[0].Descriptor()
}

func (CloudflareD1Region) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_enumTypes[0]
}
...
func (CloudflareD1Region) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (CloudflareD1ReadReplicationMode) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_enumTypes[1].Descriptor()
}

func (CloudflareD1ReadReplicationMode) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_enumTypes[1]
}
...
func (CloudflareD1ReadReplicationMode) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
type CloudflareD1DatabaseSpec struct {
	...
	Region CloudflareD1Region `protobuf:"varint,3,opt,name=region,proto3,enum=dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1Region" json:"region,omitempty"`
...
func (x *CloudflareD1DatabaseSpec) Reset() {
	*x = CloudflareD1DatabaseSpec{}
	mi := &file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_msgTypes[0]
...
type CloudflareD1ReadReplication struct {
	...
	Mode          CloudflareD1ReadReplicationMode `protobuf:"varint,1,opt,name=mode,proto3,enum=dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1ReadReplicationMode" json:"mode,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CloudflareD1ReadReplication) Reset() {
	*x = CloudflareD1ReadReplication{}
	mi := &file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Bdev/planton/provider/cloudflare/cloudflared1database/v1/spec.proto\x127dev.planton.provider.cloudflare.cloudflared1database.v1\x1a\x1bbuf/validate/validate.proto\"\xb6\x05\n" +
	...
	"\x06region\x18\x03 \x01(\x0e2K.dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1RegionR\x06region\x12\x7f\n" +
	"\x10read_replication\x18\x04 \x01(\v2T.dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1ReadReplicationR\x0freadReplication\x12\x94\x01\n" +
	...
	"\x04mode\x18\x01 \x01(\x0e2X.dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1ReadReplicationModeBc\xbaH`\xba\x01U\n" +
	...
	";com.dev.planton.provider.cloudflare.cloudflared1database.v1B\tSpecProtoP\x01Zpgithub.com/plantonhq/planton/apis/dev/planton/provider/cloudflare/cloudflared1database/v1;cloudflared1databasev1\xa2\x02\x05DPPCC\xaa\x027Dev.Planton.Provider.Cloudflare.Cloudflared1database.V1\xca\x027Dev\\Planton\\Provider\\Cloudflare\\Cloudflared1database\\V1\xe2\x02CDev\\Planton\\Provider\\Cloudflare\\Cloudflared1database\\V1\\GPBMetadata\xea\x02<Dev::Planton::Provider::Cloudflare::Cloudflared1database::V1b\x06proto3"

var (
	file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDesc), len(file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_goTypes = []any{
	(CloudflareD1Region)(0),              // 0: dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1Region
	(CloudflareD1ReadReplicationMode)(0), // 1: dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1ReadReplicationMode
	(*CloudflareD1DatabaseSpec)(nil),     // 2: dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1DatabaseSpec
	(*CloudflareD1ReadReplication)(nil),  // 3: dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1ReadReplication
}
var file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_depIdxs = []int32{
	0, // 0: dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1DatabaseSpec.region:type_name -> dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1Region
	3, // 1: dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1DatabaseSpec.read_replication:type_name -> dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1ReadReplication
	1, // 2: dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1ReadReplication.mode:type_name -> dev.planton.provider.cloudflare.cloudflared1database.v1.CloudflareD1ReadReplicationMode
...
func init() { file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_init() }
func file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_init() {
	if File_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDesc), len(file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto = out.File
	file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_depIdxs = nil
}
