...
**Provider:** cloudflare  
**Component Path:** `apis/dev/planton/provider/cloudflare/cloudflared1database/v1/`  
**Enum Value:** 1805  
**ID Prefix:** cfd1db
...
- Folder exists: `apis/dev/planton/provider/cloudflare/cloudflared1database/v1/`
...
- All proto files follow correct package naming: `dev.planton.provider.cloudflare.cloudflared1database.v1`
...
```bash
cd apis/dev/planton/provider/cloudflare/cloudflared1database/v1/
go test -v
```
