...
**Provider:** cloudflare  
**Component Path:** `apis/dev/planton/provider/cloudflare/cloudflarekvnamespace/v1/`  
**Enum Value:** 1801  
**ID Prefix:** cfkvn
...
1. **Create README.md at v1/ level**
   ...
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarekvnamespace/v1/README.md`
...
2. **Create examples.md**
   ...
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarekvnamespace/v1/examples.md`
...
- Folder exists: `apis/dev/planton/provider/cloudflare/cloudflarekvnamespace/v1/`
...
```bash
cd apis/dev/planton/provider/cloudflare/cloudflarekvnamespace/v1/
go test -v
```
...
**Path to reference:** `apis/dev/planton/provider/cloudflare/cloudflaредnszone/v1/`
