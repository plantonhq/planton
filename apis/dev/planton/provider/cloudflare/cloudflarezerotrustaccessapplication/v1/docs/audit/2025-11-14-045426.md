...
**Provider:** cloudflare  
**Component Path:** `apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/`  
**Enum Value:** 1806  
**ID Prefix:** cfzta
...
1. **Create README.md at v1 level**
   ...
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/README.md`
...
2. **Create examples.md at v1 level**
   ...
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/examples.md`
...
3. **Create iac/pulumi/README.md**
   ...
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/iac/pulumi/README.md`
...
- Folder exists: `apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/`
...
```bash
cd apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/
go test -v
```
...
- Explains 80/20 scoping decisions:
  ...
  - Planton's design philosophy is explicitly documented
...
2. **Create iac/pulumi/overview.md**
   ...
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/iac/pulumi/overview.md`
...
3. **Create iac/tf/README.md**
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/iac/tf/README.md`
...
1. **Add iac/pulumi/examples.md** (optional)
   ...
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/iac/pulumi/examples.md`
...
2. **Add iac/tf/examples.md** (optional)
   ...
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/iac/tf/examples.md`
...
3. **Expand spec_test.go with additional validation scenarios**
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/spec_test.go`
...
**Path to reference:** `apis/dev/planton/provider/cloudflare/cloudflareworker/v1/`
