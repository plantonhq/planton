...
// 	protoc        (unknown)
// source: dev/planton/provider/cloudflare/cloudflarednszone/v1/stack_outputs.proto
...
func (x *CloudflareDnsZoneStackOutputs) Reset() {
	*x = CloudflareDnsZoneStackOutputs{}
	mi := &file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_msgTypes[0]
...
func (*CloudflareDnsZoneStackOutputs) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Hdev/planton/provider/cloudflare/cloudflarednszone/v1/stack_outputs.proto\x124dev.planton.provider.cloudflare.cloudflarednszone.v1\"\xdf\x03\n" +
...
var (
	file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_rawDescData []byte
)

func file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_rawDesc)))
	})
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_rawDescData
}

var file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_goTypes = []any{
	(*CloudflareDnsZoneStackOutputs)(nil), // 0: dev.planton.provider.cloudflare.cloudflarednszone.v1.CloudflareDnsZoneStackOutputs
}
var file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_init() }
func file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_init() {
	if File_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto = out.File
	file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_goTypes = nil
	file_dev_planton_provider_cloudflare_cloudflarednszone_v1_stack_outputs_proto_depIdxs = nil
}
