...
**Provider:** cloudflare  
**Component Path:** `apis/dev/planton/provider/cloudflare/cloudflarednszone/v1/`  
**Enum Value:** 1800  
**ID Prefix:** cfdns
...
1. **Create user-facing README.md**
   ...
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarednszone/v1/README.md`
...
2. **Create examples.md**
   ...
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarednszone/v1/examples.md`
...
3. **Create Pulumi README.md**
   ...
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarednszone/v1/iac/pulumi/README.md`
...
1. **Terraform module is empty (main.tf, provider.tf are 0 bytes)**
   ...
   - **File:** `apis/dev/planton/provider/cloudflare/cloudflarednszone/v1/iac/tf/main.tf`
...
2. **Missing Terraform supporting files (locals.tf, outputs.tf)**
   ...
   - **Files:** `apis/dev/planton/provider/cloudflare/cloudflarednszone/v1/iac/tf/{locals.tf,outputs.tf}`
...
3. **Missing all user-facing documentation**
   ...
   - **Files:** `apis/dev/planton/provider/cloudflare/cloudflarednszone/v1/{README.md,examples.md}`
...
- Folder exists: `apis/dev/planton/provider/cloudflare/cloudflarednszone/v1/`
...
```bash
cd apis/dev/planton/provider/cloudflare/cloudflarednszone/v1/
go test -v
```
...
- Documents Planton's approach and abstractions
