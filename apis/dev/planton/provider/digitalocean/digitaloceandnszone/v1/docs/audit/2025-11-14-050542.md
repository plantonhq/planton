...
**Component Path:** `apis/dev/planton/provider/digitalocean/digitaloceandnszone/v1/`  
**Enum Value:** 1204  
**ID Prefix:** dodns
...
- Folder exists: `apis/dev/planton/provider/digitalocean/digitaloceandnszone/v1/`
...
```bash
cd apis/dev/planton/provider/digitalocean/digitaloceandnszone/v1/
go test -v
```
...
**Path to reference:** `apis/dev/planton/provider/cloudflare/cloudflarednszone/v1/`
