...
// 	protoc        (unknown)
// source: dev/planton/provider/digitalocean/digitaloceandnszone/v1/spec.proto
...
func (x *DigitalOceanDnsZoneSpec) Reset() {
	*x = DigitalOceanDnsZoneSpec{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_msgTypes[0]
...
func (*DigitalOceanDnsZoneSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *DigitalOceanDnsZoneRecord) Reset() {
	*x = DigitalOceanDnsZoneRecord{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanDnsZoneRecord) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Cdev/planton/provider/digitalocean/digitaloceandnszone/v1/spec.proto\x128dev.planton.provider.digitalocean.digitaloceandnszone.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1aGdev/planton/shared/networking/enums/dnsrecordtype/dns_record_type.proto\x1a(dev/planton/shared/options/options.proto\"\xd7\x01\n" +
	"\x17DigitalOceanDnsZoneSpec\x12M\n" +
	"\vdomain_name\x18\x01 \x01(\tB,\xbaH)\xc8\x01\x01r$2\"^(?:[A-Za-z0-9-]+\\.)+[A-Za-z]{2,}$R\n" +
	"domainName\x12m\n" +
	"\arecords\x18\x02 \x03(\v2S.dev.planton.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneRecordR\arecords\"\xa5\x03\n" +
...
var (
	file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc), len(file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_goTypes = []any{
	(*DigitalOceanDnsZoneSpec)(nil),   // 0: dev.planton.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneSpec
	(*DigitalOceanDnsZoneRecord)(nil), // 1: dev.planton.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneRecord
...
var file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneSpec.records:type_name -> dev.planton.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneRecord
	2, // 1: dev.planton.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneRecord.values:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 2: dev.planton.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneRecord.type:type_name -> dev.planton.shared.networking.enums.dnsrecordtype.DnsRecordType
...
func init() { file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_init() }
func file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_init() {
	if File_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc), len(file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto = out.File
	file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_digitalocean_digitaloceandnszone_v1_spec_proto_depIdxs = nil
}
