...
// 	protoc        (unknown)
// source: dev/planton/provider/digitalocean/provider.proto
...
type DigitalOceanProviderConfig struct {
	...
	DefaultRegion DigitalOceanRegion `protobuf:"varint,2,opt,name=default_region,json=defaultRegion,proto3,enum=dev.planton.provider.digitalocean.DigitalOceanRegion" json:"default_region,omitempty"`
...
func (x *DigitalOceanProviderConfig) Reset() {
	*x = DigitalOceanProviderConfig{}
	mi := &file_dev_planton_provider_digitalocean_provider_proto_msgTypes[0]
...
func (*DigitalOceanProviderConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_provider_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_digitalocean_provider_proto protoreflect.FileDescriptor

const file_dev_planton_provider_digitalocean_provider_proto_rawDesc = "" +
	"\n" +
	"0dev/planton/provider/digitalocean/provider.proto\x12!dev.planton.provider.digitalocean\x1a\x1bbuf/validate/validate.proto\x1a.dev/planton/provider/digitalocean/region.proto\"\xfd\x01\n" +
	"\x1aDigitalOceanProviderConfig\x12#\n" +
	"\tapi_token\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\bapiToken\x12d\n" +
	"\x0edefault_region\x18\x02 \x01(\x0e25.dev.planton.provider.digitalocean.DigitalOceanRegionB\x06\xbaH\x03\xc8\x01\x01R\rdefaultRegion\x12(\n" +
	"\x10spaces_access_id\x18\x03 \x01(\tR\x0espacesAccessId\x12*\n" +
	"\x11spaces_secret_key\x18\x04 \x01(\tR\x0fspacesSecretKeyB\xa3\x02\n" +
	"%com.dev.planton.provider.digitaloceanB\rProviderProtoP\x01ZCgithub.com/plantonhq/planton/apis/dev/planton/provider/digitalocean\xa2\x02\x04DPPD\xaa\x02!Dev.Planton.Provider.Digitalocean\xca\x02!Dev\\Planton\\Provider\\Digitalocean\xe2\x02-Dev\\Planton\\Provider\\Digitalocean\\GPBMetadata\xea\x02$Dev::Planton::Provider::Digitaloceanb\x06proto3"

var (
	file_dev_planton_provider_digitalocean_provider_proto_rawDescOnce sync.Once
	file_dev_planton_provider_digitalocean_provider_proto_rawDescData []byte
)

func file_dev_planton_provider_digitalocean_provider_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_digitalocean_provider_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_digitalocean_provider_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_provider_proto_rawDesc), len(file_dev_planton_provider_digitalocean_provider_proto_rawDesc)))
	})
	return file_dev_planton_provider_digitalocean_provider_proto_rawDescData
}

var file_dev_planton_provider_digitalocean_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_digitalocean_provider_proto_goTypes = []any{
	(*DigitalOceanProviderConfig)(nil), // 0: dev.planton.provider.digitalocean.DigitalOceanProviderConfig
	(DigitalOceanRegion)(0),            // 1: dev.planton.provider.digitalocean.DigitalOceanRegion
}
var file_dev_planton_provider_digitalocean_provider_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.digitalocean.DigitalOceanProviderConfig.default_region:type_name -> dev.planton.provider.digitalocean.DigitalOceanRegion
...
func init() { file_dev_planton_provider_digitalocean_provider_proto_init() }
func file_dev_planton_provider_digitalocean_provider_proto_init() {
	if File_dev_planton_provider_digitalocean_provider_proto != nil {
		return
	}
	file_dev_planton_provider_digitalocean_region_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_provider_proto_rawDesc), len(file_dev_planton_provider_digitalocean_provider_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_digitalocean_provider_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_digitalocean_provider_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_digitalocean_provider_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_digitalocean_provider_proto = out.File
	file_dev_planton_provider_digitalocean_provider_proto_goTypes = nil
	file_dev_planton_provider_digitalocean_provider_proto_depIdxs = nil
}
