...
**Component Path:** `apis/dev/planton/provider/digitalocean/digitaloceanfirewall/v1/`  
**Enum Value:** 1206  
**ID Prefix:** dofw
...
- Folder exists: `apis/dev/planton/provider/digitalocean/digitaloceanfirewall/v1/`
...
```bash
cd apis/dev/planton/provider/digitalocean/digitaloceanfirewall/v1/
go test -v
```
...
```
?       github.com/plantonhq/planton/apis/dev/planton/provider/digitalocean/digitaloceanfirewall/v1 [no test files]
```
...
**Path to reference:** `apis/dev/planton/provider/digitalocean/digitaloceanfirewall/v1/`
...
6. Re-run audit to verify improvements: `@audit-planton-component DigitalOceanFirewall`
