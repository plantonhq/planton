...
// 	protoc        (unknown)
// source: dev/planton/provider/digitalocean/digitaloceanfirewall/v1/spec.proto
...
func (x *DigitalOceanFirewallSpec) Reset() {
	*x = DigitalOceanFirewallSpec{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_msgTypes[0]
...
func (*DigitalOceanFirewallSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *DigitalOceanFirewallInboundRule) Reset() {
	*x = DigitalOceanFirewallInboundRule{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanFirewallInboundRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *DigitalOceanFirewallOutboundRule) Reset() {
	*x = DigitalOceanFirewallOutboundRule{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanFirewallOutboundRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Ddev/planton/provider/digitalocean/digitaloceanfirewall/v1/spec.proto\x129dev.planton.provider.digitalocean.digitaloceanfirewall.v1\x1a\x1bbuf/validate/validate.proto\"\xf5\x02\n" +
	"\x18DigitalOceanFirewallSpec\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xff\x01R\x04name\x12\x7f\n" +
	"\rinbound_rules\x18\x02 \x03(\v2Z.dev.planton.provider.digitalocean.digitaloceanfirewall.v1.DigitalOceanFirewallInboundRuleR\finboundRules\x12\x82\x01\n" +
	"\x0eoutbound_rules\x18\x03 \x03(\v2[.dev.planton.provider.digitalocean.digitaloceanfirewall.v1.DigitalOceanFirewallOutboundRuleR\routboundRules\x12\x1f\n" +
...
var (
	file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDesc), len(file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_goTypes = []any{
	(*DigitalOceanFirewallSpec)(nil),         // 0: dev.planton.provider.digitalocean.digitaloceanfirewall.v1.DigitalOceanFirewallSpec
	(*DigitalOceanFirewallInboundRule)(nil),  // 1: dev.planton.provider.digitalocean.digitaloceanfirewall.v1.DigitalOceanFirewallInboundRule
	(*DigitalOceanFirewallOutboundRule)(nil), // 2: dev.planton.provider.digitalocean.digitaloceanfirewall.v1.DigitalOceanFirewallOutboundRule
}
var file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.digitalocean.digitaloceanfirewall.v1.DigitalOceanFirewallSpec.inbound_rules:type_name -> dev.planton.provider.digitalocean.digitaloceanfirewall.v1.DigitalOceanFirewallInboundRule
	2, // 1: dev.planton.provider.digitalocean.digitaloceanfirewall.v1.DigitalOceanFirewallSpec.outbound_rules:type_name -> dev.planton.provider.digitalocean.digitaloceanfirewall.v1.DigitalOceanFirewallOutboundRule
...
func init() { file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_init() }
func file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_init() {
	if File_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDesc), len(file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto = out.File
	file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_depIdxs = nil
}
