...
**Component Path:** `apis/dev/planton/provider/digitalocean/digitaloceandroplet/v1/`  
**Enum Value:** 1205  
**ID Prefix:** dodrop
...
- Folder exists: `apis/dev/planton/provider/digitalocean/digitaloceandroplet/v1/`
...
```bash
cd apis/dev/planton/provider/digitalocean/digitaloceandroplet/v1/
go test -v
```
