...
**Component Path:** `apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/`  
**Enum Value:** 1201  
**ID Prefix:** dobkt
...
1. **Create examples.md**
   ...
   - **File:** `apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/examples.md`
...
2. **Fix README.md content**
   ...
   - **File:** `apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/README.md`
...
3. **Create Pulumi README.md**
   ...
   - **File:** `apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/iac/pulumi/README.md`
...
1. **Terraform Module is Incomplete**
   ...
   - **Files:**
     - `apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/iac/tf/main.tf`
     - `apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/iac/tf/provider.tf`
     - `apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/iac/tf/locals.tf`
     - `apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/iac/tf/outputs.tf`
     - `apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/iac/tf/variables.tf`
...
2. **Missing Supporting Documentation**
   ...
   - **Files:**
     - `apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/iac/tf/README.md`
     - `apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/iac/pulumi/overview.md`
...
- Folder exists: `apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/`
...
```bash
cd apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1/
go test -v
```
...
**Path to reference:** `apis/dev/planton/provider/aws/awss3bucket/v1/`
