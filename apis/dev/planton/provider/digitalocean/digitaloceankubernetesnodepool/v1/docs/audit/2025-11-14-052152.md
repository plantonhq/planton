...
**Component Path:** `apis/dev/planton/provider/digitalocean/digitaloceankubernetesnodepool/v1/`  
**Enum Value:** 1209  
**ID Prefix:** doknp
...
- Folder exists: `apis/dev/planton/provider/digitalocean/digitaloceankubernetesnodepool/v1/`
...
- Overview of DigitalOcean Kubernetes Node Pool from Planton perspective
...
**Path to reference:** `apis/dev/planton/provider/gcp/gcpgkenodepool/v1/`
