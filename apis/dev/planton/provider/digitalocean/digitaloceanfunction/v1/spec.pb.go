...
// 	protoc        (unknown)
// source: dev/planton/provider/digitalocean/digitaloceanfunction/v1/spec.proto
...
func (DigitalOceanFunctionRuntime) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_enumTypes[0].Descriptor()
}

func (DigitalOceanFunctionRuntime) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_enumTypes[0]
}
...
func (DigitalOceanFunctionRuntime) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
type DigitalOceanFunctionSpec struct {
	...
	Runtime DigitalOceanFunctionRuntime `protobuf:"varint,3,opt,name=runtime,proto3,enum=dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionRuntime" json:"runtime,omitempty"`
...
func (x *DigitalOceanFunctionSpec) Reset() {
	*x = DigitalOceanFunctionSpec{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_msgTypes[0]
...
func (x *DigitalOceanFunctionGithubSource) Reset() {
	*x = DigitalOceanFunctionGithubSource{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanFunctionGithubSource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Ddev/planton/provider/digitalocean/digitaloceanfunction/v1/spec.proto\x129dev.planton.provider.digitalocean.digitaloceanfunction.v1\x1a\x1bbuf/validate/validate.proto\x1a.dev/planton/provider/digitalocean/region.proto\x1a(dev/planton/shared/options/options.proto\"\x99\t\n" +
	"\x18DigitalOceanFunctionSpec\x12.\n" +
	"\rfunction_name\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18@R\ffunctionName\x12U\n" +
	"\x06region\x18\x02 \x01(\x0e25.dev.planton.provider.digitalocean.DigitalOceanRegionB\x06\xbaH\x03\xc8\x01\x01R\x06region\x12x\n" +
	"\aruntime\x18\x03 \x01(\x0e2V.dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionRuntimeB\x06\xbaH\x03\xc8\x01\x01R\aruntime\x12\x80\x01\n" +
	"\rgithub_source\x18\x04 \x01(\v2[.dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionGithubSourceR\fgithubSource\x122\n" +
	...
	"\x15environment_variables\x18\b \x03(\v2m.dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionSpec.EnvironmentVariablesEntryR\x14environmentVariables\x12\xb5\x01\n" +
	"\x1csecret_environment_variables\x18\t \x03(\v2s.dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionSpec.SecretEnvironmentVariablesEntryR\x1asecretEnvironmentVariables\x12\x1e\n" +
	"\n" +
	"entrypoint\x18\n" +
	" \x01(\tR\n" +
	"entrypoint\x12#\n" +
	...
	"=com.dev.planton.provider.digitalocean.digitaloceanfunction.v1B\tSpecProtoP\x01Zrgithub.com/plantonhq/planton/apis/dev/planton/provider/digitalocean/digitaloceanfunction/v1;digitaloceanfunctionv1\xa2\x02\x05DPPDD\xaa\x029Dev.Planton.Provider.Digitalocean.Digitaloceanfunction.V1\xca\x029Dev\\Planton\\Provider\\Digitalocean\\Digitaloceanfunction\\V1\xe2\x02EDev\\Planton\\Provider\\Digitalocean\\Digitaloceanfunction\\V1\\GPBMetadata\xea\x02>Dev::Planton::Provider::Digitalocean::Digitaloceanfunction::V1b\x06proto3"

var (
	file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDesc), len(file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_goTypes = []any{
	(DigitalOceanFunctionRuntime)(0),         // 0: dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionRuntime
	(*DigitalOceanFunctionSpec)(nil),         // 1: dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionSpec
	(*DigitalOceanFunctionGithubSource)(nil), // 2: dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionGithubSource
	nil,                                      // 3: dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionSpec.EnvironmentVariablesEntry
	nil,                                      // 4: dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionSpec.SecretEnvironmentVariablesEntry
	(digitalocean.DigitalOceanRegion)(0),     // 5: dev.planton.provider.digitalocean.DigitalOceanRegion
}
var file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_depIdxs = []int32{
	5, // 0: dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionSpec.region:type_name -> dev.planton.provider.digitalocean.DigitalOceanRegion
	0, // 1: dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionSpec.runtime:type_name -> dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionRuntime
	2, // 2: dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionSpec.github_source:type_name -> dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionGithubSource
	3, // 3: dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionSpec.environment_variables:type_name -> dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionSpec.EnvironmentVariablesEntry
	4, // 4: dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionSpec.secret_environment_variables:type_name -> dev.planton.provider.digitalocean.digitaloceanfunction.v1.DigitalOceanFunctionSpec.SecretEnvironmentVariablesEntry
...
func init() { file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_init() }
func file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_init() {
	if File_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDesc), len(file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto = out.File
	file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_digitalocean_digitaloceanfunction_v1_spec_proto_depIdxs = nil
}
