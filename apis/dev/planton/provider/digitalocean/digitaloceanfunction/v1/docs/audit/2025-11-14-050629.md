...
**Component Path:** `apis/dev/planton/provider/digitalocean/digitaloceanfunction/v1/`  
**Enum Value:** 1207  
**ID Prefix:** dofn
...
1. **Create spec_test.go with validation tests**
   ...
   - **File:** `apis/dev/planton/provider/digitalocean/digitaloceanfunction/v1/spec_test.go`
...
2. **Create examples.md with common use cases**
   ...
   - **File:** `apis/dev/planton/provider/digitalocean/digitaloceanfunction/v1/examples.md`
...
- Folder exists: `apis/dev/planton/provider/digitalocean/digitaloceanfunction/v1/`
...
```bash
cd apis/dev/planton/provider/digitalocean/digitaloceanfunction/v1/
go test -v
```
...
**Path to reference:** `apis/dev/planton/provider/gcp/gcpcloudfunction/v1/`
...
5. **Re-run audit to verify improvements**:
   ```bash
   @audit-planton-component DigitalOceanFunction
   ```
