...
**Component Path:** `apis/dev/planton/provider/digitalocean/digitaloceankubernetescluster/v1/`  
**Enum Value:** 1208  
**ID Prefix:** dokc
...
- Folder exists: `apis/dev/planton/provider/digitalocean/digitaloceankubernetescluster/v1/`
...
```bash
cd apis/dev/planton/provider/digitalocean/digitaloceankubernetescluster/v1/
go test -v
```
...
- Documents Planton's opinionated API design philosophy
...
- `apis/dev/planton/provider/gcp/gcpgkecluster/v1/`
