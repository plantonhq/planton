...
**Component Path:** `apis/dev/planton/provider/digitalocean/digitaloceanvolume/v1/`  
**Enum Value:** 1211  
**ID Prefix:** dovol
...
- Folder exists: `apis/dev/planton/provider/digitalocean/digitaloceanvolume/v1/`
...
```bash
cd apis/dev/planton/provider/digitalocean/digitaloceanvolume/v1/
go test -v
```
...
4. **Fix README.md content**
   ...
   - **How:** Rewrite README to be specific to DigitalOcean Volume. Explain:
     ...
     - Why Planton provides native implementation
