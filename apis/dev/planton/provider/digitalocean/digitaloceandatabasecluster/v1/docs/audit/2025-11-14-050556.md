...
**Component Path:** `apis/dev/planton/provider/digitalocean/digitaloceandatabasecluster/v1/`  
**Enum Value:** 1203  
**ID Prefix:** dodb
...
- Folder exists: `apis/dev/planton/provider/digitalocean/digitaloceandatabasecluster/v1/`
...
```bash
cd apis/dev/planton/provider/digitalocean/digitaloceandatabasecluster/v1/
go test -v
```
...
- **Clear explanation of 80/20 scoping decisions** in Planton's API design
...
**Path to reference:** `apis/dev/planton/provider/digitalocean/digitaloceancontainerregistry/v1/`
