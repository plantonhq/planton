...
**Component Path:** `apis/dev/planton/provider/digitalocean/digitaloceancertificate/v1/`  
**Enum Value:** 1213  
**ID Prefix:** docert
...
- Folder exists: `apis/dev/planton/provider/digitalocean/digitaloceancertificate/v1/`
...
3. **Create user-facing README.md**
   ...
   - **How:** Write 50-100 line README with:
     - Overview from Planton perspective
...
7. **Add BUILD.bazel validation**
   ...
   - **How:** Run `bazel build //apis/dev/planton/provider/digitalocean/digitaloceancertificate/...` to verify
...
- `apis/dev/planton/provider/gcp/gcpcertmanagercert/v1/` (for certificate management patterns)
- `apis/dev/planton/provider/digitalocean/digitaloceandnszone/v1/` (for DigitalOcean provider patterns, if available)
...
5. Run `planton pulumi up` and `terraform apply` to verify both work
