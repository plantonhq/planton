...
```bash
export STACK_INPUT='{"target":{"apiVersion":"digital-ocean.planton.dev/v1","kind":"DigitalOceanDnsRecord","metadata":{"name":"www-record"},"spec":{"domain":"example.com","name":"www","type":"A","value":"192.0.2.1"}},"providerConfig":{"apiToken":"YOUR_TOKEN","defaultRegion":"nyc1"}}'
