...
**Component Path:** `apis/dev/planton/provider/digitalocean/digitaloceanloadbalancer/v1/`  
**Enum Value:** 1210  
**ID Prefix:** dolb
...
- Folder exists: `apis/dev/planton/provider/digitalocean/digitaloceanloadbalancer/v1/`
...
```bash
cd apis/dev/planton/provider/digitalocean/digitaloceanloadbalancer/v1/
go test -v
```
...
**Path to reference:** `apis/dev/planton/provider/digitalocean/digitaloceandroplet/v1/`
