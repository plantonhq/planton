...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetesclickhouse/v1/`  
**Enum Value:** 830  
**ID Prefix:** k8sclkhs  
**Category:** workload  
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetesclickhouse/v1/`
...
```bash
cd apis/dev/planton/provider/kubernetes/kubernetesclickhouse/v1/
go test -v
```
...
**Recommended as reference:** `apis/dev/planton/provider/kubernetes/kubernetesclickhouse/v1/`
...
The **KubernetesClickHouse** component is a **gold standard reference implementation** within the Planton ecosystem. It demonstrates:
