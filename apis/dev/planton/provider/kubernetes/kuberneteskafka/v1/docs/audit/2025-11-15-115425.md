...
- Folder exists at correct path: `apis/dev/planton/provider/kubernetes/kuberneteskafka/v1/`
...
```bash
cd apis/dev/planton/provider/kubernetes/kuberneteskafka/v1/
go test -v
```
...
**Path to reference:** `apis/dev/planton/provider/kubernetes/kuberneteselasticsearch/v1/`
