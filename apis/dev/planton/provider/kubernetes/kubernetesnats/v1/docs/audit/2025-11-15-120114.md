...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetesnats/v1/`  
**Enum Value:** 820  
**ID Prefix:** k8snats
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetesnats/v1/`
...
```bash
cd apis/dev/planton/provider/kubernetes/kubernetesnats/v1/
go test -v
```
