...
variable "spec" {
  description = "Spec for the security.istio.io/v1 \"AuthorizationPolicy\" custom resource, passed through verbatim to kubernetes_manifest. Typed 'any': the apiserver and Planton protovalidate are the schema authority."
  type        = any
}
