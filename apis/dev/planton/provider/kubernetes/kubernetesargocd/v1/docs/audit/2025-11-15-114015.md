...
**Provider:** kubernetes  
**Category:** workload  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetesargocd/v1/`  
**Enum Value:** 800  
**ID Prefix:** k8sargo  
...
- Folder exists at correct path: `apis/dev/planton/provider/kubernetes/kubernetesargocd/v1/`
...
This is one of the **best research documents** in the entire Planton codebase. It's opinionated, comprehensive, and explains the "why" behind design decisions. The only issue is that the code doesn't implement what the documentation describes.
...
Alternatively, use the **update-planton-component** rule with specific instructions to:
...
**Path to reference:** `apis/dev/planton/provider/kubernetes/kubernetestemporal/v1/`
...
5. **Re-run audit to verify improvements**:
   - Run `@audit-planton-component KubernetesArgocd` after changes
