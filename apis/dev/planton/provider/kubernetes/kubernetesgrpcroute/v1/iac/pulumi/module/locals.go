...
type Locals struct {
	KubernetesGrpcRoute *kubernetesgrpcroutev1.KubernetesGrpcRoute
	RouteName           string
	Namespace           string
	Labels              map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *kubernetesgrpcroutev1.KubernetesGrpcRouteStackInput) *Locals {
