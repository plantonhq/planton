...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetesredis/v1/`  
**Enum Value:** 816  
**ID Prefix:** k8sred  
**Category:** workload  
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetesredis/v1/`
...
- Focused on Planton perspective
