...
variable "spec" {
  description = "Spec for the networking.istio.io/v1 \"DestinationRule\" custom resource, passed through verbatim to kubernetes_manifest. Typed 'any': the apiserver and Planton protovalidate are the schema authority."
  type        = any
}
