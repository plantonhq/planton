...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetesprometheus/v1/`  
**Enum Value:** 815  
**ID Prefix:** k8sprom  
**Category:** workload  
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetesprometheus/v1/`
...
**Tool Version:** audit-planton-component.mdc v1.0
