...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetespostgres/v1/`  
**Enum Value:** 814  
**ID Prefix:** k8spg  
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetespostgres/v1/`
...
- `apis/dev/planton/provider/kubernetes/kuberneteselasticsearch/v1/`
- `apis/dev/planton/provider/kubernetes/kubernetesclickhouse/v1/`
