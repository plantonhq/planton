...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetescronjob/v1/`  
**Enum Value:** 801  
**ID Prefix:** k8scron  
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetescronjob/v1/`
...
```bash
cd apis/dev/planton/provider/kubernetes/kubernetescronjob/v1/
go test -v
```
...
- ✅ **Planton Integration**: Explains how Planton's abstraction solves native API problems
...
**Path to reference:** `apis/dev/planton/provider/kubernetes/kubernetescronjob/v1/`
