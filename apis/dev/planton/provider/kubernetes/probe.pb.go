...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/probe.proto
...
func (x *Probe) Reset() {
	*x = Probe{}
	mi := &file_dev_planton_provider_kubernetes_probe_proto_msgTypes[0]
...
func (*Probe) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_probe_proto_rawDescGZIP(), []int{0}
}
...
func (x *HTTPGetAction) Reset() {
	*x = HTTPGetAction{}
	mi := &file_dev_planton_provider_kubernetes_probe_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HTTPGetAction) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_probe_proto_rawDescGZIP(), []int{1}
}
...
func (x *HTTPHeader) Reset() {
	*x = HTTPHeader{}
	mi := &file_dev_planton_provider_kubernetes_probe_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HTTPHeader) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_probe_proto_rawDescGZIP(), []int{2}
}
...
func (x *GRPCAction) Reset() {
	*x = GRPCAction{}
	mi := &file_dev_planton_provider_kubernetes_probe_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GRPCAction) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_probe_proto_rawDescGZIP(), []int{3}
}
...
func (x *TCPSocketAction) Reset() {
	*x = TCPSocketAction{}
	mi := &file_dev_planton_provider_kubernetes_probe_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TCPSocketAction) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_probe_proto_rawDescGZIP(), []int{4}
}
...
func (x *ExecAction) Reset() {
	*x = ExecAction{}
	mi := &file_dev_planton_provider_kubernetes_probe_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExecAction) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_probe_proto_rawDescGZIP(), []int{5}
}
...
var File_dev_planton_provider_kubernetes_probe_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_probe_proto_rawDesc = "" +
	"\n" +
	"+dev/planton/provider/kubernetes/probe.proto\x12\x1fdev.planton.provider.kubernetes\x1a\x1bbuf/validate/validate.proto\"\x96\x04\n" +
	"\x05Probe\x122\n" +
	...
	"\bhttp_get\x18\x06 \x01(\v2..dev.planton.provider.kubernetes.HTTPGetActionH\x00R\ahttpGet\x12A\n" +
	"\x04grpc\x18\a \x01(\v2+.dev.planton.provider.kubernetes.GRPCActionH\x00R\x04grpc\x12Q\n" +
	"\n" +
	"tcp_socket\x18\b \x01(\v20.dev.planton.provider.kubernetes.TCPSocketActionH\x00R\ttcpSocket\x12A\n" +
	"\x04exec\x18\t \x01(\v2+.dev.planton.provider.kubernetes.ExecActionH\x00R\x04execB\t\n" +
	"\ahandler\"\xe9\x01\n" +
	...
	"\fhttp_headers\x18\x06 \x03(\v2+.dev.planton.provider.kubernetes.HTTPHeaderR\vhttpHeadersB\x06\n" +
	"\x04port\"6\n" +
	"\n" +
	"HTTPHeader\x12\x12\n" +
	...
	"#com.dev.planton.provider.kubernetesB\n" +
	"ProbeProtoP\x01ZAgithub.com/plantonhq/planton/apis/dev/planton/provider/kubernetes\xa2\x02\x04DPPK\xaa\x02\x1fDev.Planton.Provider.Kubernetes\xca\x02\x1fDev\\Planton\\Provider\\Kubernetes\xe2\x02+Dev\\Planton\\Provider\\Kubernetes\\GPBMetadata\xea\x02\"Dev::Planton::Provider::Kubernetesb\x06proto3"

var (
	file_dev_planton_provider_kubernetes_probe_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_probe_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_probe_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_probe_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_probe_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_probe_proto_rawDesc), len(file_dev_planton_provider_kubernetes_probe_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_probe_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_probe_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_dev_planton_provider_kubernetes_probe_proto_goTypes = []any{
	(*Probe)(nil),           // 0: dev.planton.provider.kubernetes.Probe
	(*HTTPGetAction)(nil),   // 1: dev.planton.provider.kubernetes.HTTPGetAction
	(*HTTPHeader)(nil),      // 2: dev.planton.provider.kubernetes.HTTPHeader
	(*GRPCAction)(nil),      // 3: dev.planton.provider.kubernetes.GRPCAction
	(*TCPSocketAction)(nil), // 4: dev.planton.provider.kubernetes.TCPSocketAction
	(*ExecAction)(nil),      // 5: dev.planton.provider.kubernetes.ExecAction
}
var file_dev_planton_provider_kubernetes_probe_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.kubernetes.Probe.http_get:type_name -> dev.planton.provider.kubernetes.HTTPGetAction
	3, // 1: dev.planton.provider.kubernetes.Probe.grpc:type_name -> dev.planton.provider.kubernetes.GRPCAction
	4, // 2: dev.planton.provider.kubernetes.Probe.tcp_socket:type_name -> dev.planton.provider.kubernetes.TCPSocketAction
	5, // 3: dev.planton.provider.kubernetes.Probe.exec:type_name -> dev.planton.provider.kubernetes.ExecAction
	2, // 4: dev.planton.provider.kubernetes.HTTPGetAction.http_headers:type_name -> dev.planton.provider.kubernetes.HTTPHeader
...
func init() { file_dev_planton_provider_kubernetes_probe_proto_init() }
func file_dev_planton_provider_kubernetes_probe_proto_init() {
	if File_dev_planton_provider_kubernetes_probe_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_probe_proto_msgTypes[0].OneofWrappers = []any{
		(*Probe_HttpGet)(nil),
		(*Probe_Grpc)(nil),
		(*Probe_TcpSocket)(nil),
		(*Probe_Exec)(nil),
	}
	file_dev_planton_provider_kubernetes_probe_proto_msgTypes[1].OneofWrappers = []any{
		(*HTTPGetAction_PortNumber)(nil),
		(*HTTPGetAction_PortName)(nil),
	}
	file_dev_planton_provider_kubernetes_probe_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_probe_proto_rawDesc), len(file_dev_planton_provider_kubernetes_probe_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_probe_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_probe_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_probe_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_probe_proto = out.File
	file_dev_planton_provider_kubernetes_probe_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_probe_proto_depIdxs = nil
}
