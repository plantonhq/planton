...
**Provider:** kubernetes  
**Category:** workload  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetesneo4j/v1/`  
**Enum Value:** 812  
**ID Prefix:** k8sneo  
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetesneo4j/v1/`
...
```bash
cd apis/dev/planton/provider/kubernetes/kubernetesneo4j/v1/
go test -v
```
...
- Contains overview from Planton perspective ✅
...
- **@update-planton-component** - Fill in Terraform gaps
...
3. Re-run audit to verify 100% completion:
   ```
   @audit-planton-component KubernetesNeo4j
   ```
