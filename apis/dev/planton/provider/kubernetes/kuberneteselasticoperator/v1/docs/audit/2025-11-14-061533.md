...
**Provider:** kubernetes  
**Category:** addon  
**Component Path:** `apis/dev/planton/provider/kubernetes/kuberneteselasticoperator/v1/`  
**Enum Value:** 822  
**ID Prefix:** elaopk8s
...
1. **Add spec_test.go with unit tests**
   ...
   - **File:** `apis/dev/planton/provider/kubernetes/kuberneteselasticoperator/v1/spec_test.go`
...
2. **Create user-facing README.md**
   ...
   - **File:** `apis/dev/planton/provider/kubernetes/kuberneteselasticoperator/v1/README.md`
...
3. **Add Terraform locals.tf and outputs.tf**
   ...
   - **File:** `apis/dev/planton/provider/kubernetes/kuberneteselasticoperator/v1/iac/tf/locals.tf`, `outputs.tf`
...
2. **Incomplete Terraform implementation**
   ...
   - **File:** `apis/dev/planton/provider/kubernetes/kuberneteselasticoperator/v1/iac/tf/main.tf`
...
3. **Missing user-facing documentation**
   ...
   - **File:** `apis/dev/planton/provider/kubernetes/kuberneteselasticoperator/v1/README.md`, `examples.md`
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kuberneteselasticoperator/v1/`
...
```bash
cd apis/dev/planton/provider/kubernetes/kuberneteselasticoperator/v1/
go test -v
```
...
- Contains comprehensive landscape analysis with clear sections:
  ...
  - "Planton's Approach: Helm with Clear Abstractions" explaining design decisions
...
4. **Create examples.md with usage examples**
   ...
   - **File:** `apis/dev/planton/provider/kubernetes/kuberneteselasticoperator/v1/examples.md`
...
7. **Create hack manifest for testing**
   ...
   - **File:** `apis/dev/planton/provider/kubernetes/kuberneteselasticoperator/v1/iac/hack/manifest.yaml`
...
**Path to reference:** `apis/dev/planton/provider/kubernetes/certmanager/v1/`
