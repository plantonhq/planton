...
- Folder exists: `apis/dev/planton/provider/kubernetes/kuberneteselasticsearch/v1/`
...
```bash
cd apis/dev/planton/provider/kubernetes/kuberneteselasticsearch/v1/
go test -v
```
...
- Well-structured overview from Planton perspective
