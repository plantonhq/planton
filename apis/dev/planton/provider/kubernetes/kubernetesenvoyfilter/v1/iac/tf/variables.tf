...
variable "spec" {
  description = "Spec for the networking.istio.io/v1alpha3 \"EnvoyFilter\" custom resource, passed through verbatim to kubernetes_manifest. Typed 'any': the apiserver and Planton protovalidate are the schema authority."
  type        = any
}
