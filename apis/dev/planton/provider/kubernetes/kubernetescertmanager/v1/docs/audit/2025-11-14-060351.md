...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetescertmanager/v1/`  
**Enum Value:** 821  
**ID Prefix:** cmk8s  
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetescertmanager/v1/`
...
```bash
cd apis/dev/planton/provider/kubernetes/kubernetescertmanager/v1/
go test -v
```
...
- For Terraform implementation: `apis/dev/planton/provider/kubernetes/externaldns/v1/iac/tf/`
- For test structure: `apis/dev/planton/provider/kubernetes/externaldns/v1/*_test.go`
- For examples: `apis/dev/planton/provider/kubernetes/externaldns/v1/examples.md`
