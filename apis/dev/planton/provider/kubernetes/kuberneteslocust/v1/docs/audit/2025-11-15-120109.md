...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kuberneteslocust/v1/`  
**Enum Value:** 809  
**ID Prefix:** k8sloc
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kuberneteslocust/v1/`
...
```bash
cd apis/dev/planton/provider/kubernetes/kuberneteslocust/v1/
go test -v
```
