...
variable "spec" {
  description = "Spec for the gateway.networking.k8s.io/v1 \"ReferenceGrant\" custom resource, passed through verbatim to kubernetes_manifest. Typed 'any': the apiserver and Planton protovalidate are the schema authority."
  type        = any
}
