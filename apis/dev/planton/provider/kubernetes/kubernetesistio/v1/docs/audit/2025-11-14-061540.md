...
2. **Create v1/README.md**
   ...
   - **Why:** User-facing documentation is completely missing (6.67% gap). Users need a Planton perspective overview.
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetesistio/v1/`
...
- Explains why Planton chose Helm over istioctl
...
- No user-facing overview from Planton perspective
...
3. **Create v1/README.md**
   ...
   - **How:** Write concise Planton perspective overview with one example
   - **Impact:** +6.67% → 85.32%
...
5. **Re-run audit to verify improvements:**
   ```bash
   @audit-planton-component KubernetesIstio
   ```
