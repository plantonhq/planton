...
**Provider:** kubernetes  
**Category:** workload  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetesmongodb/v1/`  
**Enum Value:** 811  
**ID Prefix:** k8smdb  
...
- Folder exists at correct path: `apis/dev/planton/provider/kubernetes/kubernetesmongodb/v1/`
...
```bash
cd apis/dev/planton/provider/kubernetes/kubernetesmongodb/v1/
go test -v
```
...
- **update-planton-component** rule with specific instructions to fix mongodb.tf
...
**Path to reference:** `apis/dev/planton/provider/kubernetes/kuberneteskafka/v1/`
