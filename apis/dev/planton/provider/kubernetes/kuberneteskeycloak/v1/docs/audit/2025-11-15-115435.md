...
- Folder exists: `apis/dev/planton/provider/kubernetes/kuberneteskeycloak/v1/`
...
```bash
cd apis/dev/planton/provider/kubernetes/kuberneteskeycloak/v1/
go test -v
```
...
- **80/20 Scoping Decisions:** Clear explanation of why Planton chose the Operator-emulating approach over Helm charts
