...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetessolroperator/v1/`  
**Enum Value:** 828  
**ID Prefix:** slropk8s
...
1. **Create spec_test.go with validation tests**
   ...
   - **How:** Run `@forge-planton-component` rule 003 (spec tests) or manually create tests for container resource validations.
   - **File:** `spec_test.go`
...
2. **Create user-facing README.md**
   ...
   - **How:** Run `@forge-planton-component` rule 007 (docs) or manually document usage, examples, and API reference.
   - **File:** `v1/README.md`
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetessolroperator/v1/`
...
- `@fix-planton-component` - To address specific gaps
- `@complete-planton-component` - To bring component to 100%
...
5. **Re-run audit to verify improvements**
   - `@audit-planton-component KubernetesSolrOperator`
