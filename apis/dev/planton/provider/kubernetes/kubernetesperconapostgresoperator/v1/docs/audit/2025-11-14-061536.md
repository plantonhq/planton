...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetesperconapostgresoperator/v1/`  
**Enum Value:** 832  
**ID Prefix:** percpgop
...
1. **Create spec_test.go**
   ...
   - **File:** `apis/dev/planton/provider/kubernetes/kubernetesperconapostgresoperator/v1/spec_test.go`
...
2. **Add Terraform outputs.tf**
   ...
   - **File:** `apis/dev/planton/provider/kubernetes/kubernetesperconapostgresoperator/v1/iac/tf/outputs.tf`

3. **Add Terraform locals.tf**
   - **Why:** Standard Terraform module structure - worth 0.89% of total score
   - **How:** Create file with local variables for namespace and chart configuration
   - **File:** `apis/dev/planton/provider/kubernetes/kubernetesperconapostgresoperator/v1/iac/tf/locals.tf`
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetesperconapostgresoperator/v1/`
...
1. **Add iac/pulumi/module/locals.go**
   ...
   - **File:** `apis/dev/planton/provider/kubernetes/kubernetesperconapostgresoperator/v1/iac/pulumi/module/locals.go`
...
2. **Add iac/pulumi/overview.md**
   - **File:** `apis/dev/planton/provider/kubernetes/kubernetesperconapostgresoperator/v1/iac/pulumi/overview.md`
...
1. **Expand main.tf size**
   - **File:** `apis/dev/planton/provider/kubernetes/kubernetesperconapostgresoperator/v1/iac/tf/main.tf`
...
**Path to reference:** `apis/dev/planton/provider/kubernetes/zalandopostgresoperator/v1/` or `apis/dev/planton/provider/kubernetes/strimzikafkaoperator/v1/`
