...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetesperconamongooperator/v1/`  
**Enum Value:** 833  
**ID Prefix:** percmdbop  
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetesperconamongooperator/v1/`
...
- While functional, this breaks Planton naming conventions
...
2. **Standardize Pulumi module file names**
   ...
   - **Files:** `v1/iac/pulumi/module/main.go`, `v1/iac/pulumi/module/locals.go`
   - **Why:** Ensures consistency across all Planton components
