...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetestemporal/v1/`  
**Enum Value:** 819  
**ID Prefix:** k8stprl
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetestemporal/v1/`
...
```bash
go test -v ./apis/dev/planton/provider/kubernetes/kubernetestemporal/v1/
```
