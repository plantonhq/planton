...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/volume_mount.proto
...
func (x *VolumeMount) Reset() {
	*x = VolumeMount{}
	mi := &file_dev_planton_provider_kubernetes_volume_mount_proto_msgTypes[0]
...
func (*VolumeMount) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_volume_mount_proto_rawDescGZIP(), []int{0}
}
...
func (x *ConfigMapVolumeSource) Reset() {
	*x = ConfigMapVolumeSource{}
	mi := &file_dev_planton_provider_kubernetes_volume_mount_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConfigMapVolumeSource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_volume_mount_proto_rawDescGZIP(), []int{1}
}
...
func (x *SecretVolumeSource) Reset() {
	*x = SecretVolumeSource{}
	mi := &file_dev_planton_provider_kubernetes_volume_mount_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SecretVolumeSource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_volume_mount_proto_rawDescGZIP(), []int{2}
}
...
func (x *HostPathVolumeSource) Reset() {
	*x = HostPathVolumeSource{}
	mi := &file_dev_planton_provider_kubernetes_volume_mount_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HostPathVolumeSource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_volume_mount_proto_rawDescGZIP(), []int{3}
}
...
func (x *EmptyDirVolumeSource) Reset() {
	*x = EmptyDirVolumeSource{}
	mi := &file_dev_planton_provider_kubernetes_volume_mount_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EmptyDirVolumeSource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_volume_mount_proto_rawDescGZIP(), []int{4}
}
...
func (x *PvcVolumeSource) Reset() {
	*x = PvcVolumeSource{}
	mi := &file_dev_planton_provider_kubernetes_volume_mount_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PvcVolumeSource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_volume_mount_proto_rawDescGZIP(), []int{5}
}
...
var File_dev_planton_provider_kubernetes_volume_mount_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_volume_mount_proto_rawDesc = "" +
	"\n" +
	"2dev/planton/provider/kubernetes/volume_mount.proto\x12\x1fdev.planton.provider.kubernetes\x1a\x1bbuf/validate/validate.proto\"\x98\x04\n" +
	...
	"\n" +
	"config_map\x18\x05 \x01(\v26.dev.planton.provider.kubernetes.ConfigMapVolumeSourceR\tconfigMap\x12K\n" +
	"\x06secret\x18\x06 \x01(\v23.dev.planton.provider.kubernetes.SecretVolumeSourceR\x06secret\x12R\n" +
	"\thost_path\x18\a \x01(\v25.dev.planton.provider.kubernetes.HostPathVolumeSourceR\bhostPath\x12R\n" +
	"\tempty_dir\x18\b \x01(\v25.dev.planton.provider.kubernetes.EmptyDirVolumeSourceR\bemptyDir\x12B\n" +
	"\x03pvc\x18\t \x01(\v20.dev.planton.provider.kubernetes.PvcVolumeSourceR\x03pvc\"|\n" +
	...
	"#com.dev.planton.provider.kubernetesB\x10VolumeMountProtoP\x01ZAgithub.com/plantonhq/planton/apis/dev/planton/provider/kubernetes\xa2\x02\x04DPPK\xaa\x02\x1fDev.Planton.Provider.Kubernetes\xca\x02\x1fDev\\Planton\\Provider\\Kubernetes\xe2\x02+Dev\\Planton\\Provider\\Kubernetes\\GPBMetadata\xea\x02\"Dev::Planton::Provider::Kubernetesb\x06proto3"

var (
	file_dev_planton_provider_kubernetes_volume_mount_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_volume_mount_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_volume_mount_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_volume_mount_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_volume_mount_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_volume_mount_proto_rawDesc), len(file_dev_planton_provider_kubernetes_volume_mount_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_volume_mount_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_volume_mount_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_dev_planton_provider_kubernetes_volume_mount_proto_goTypes = []any{
	(*VolumeMount)(nil),           // 0: dev.planton.provider.kubernetes.VolumeMount
	(*ConfigMapVolumeSource)(nil), // 1: dev.planton.provider.kubernetes.ConfigMapVolumeSource
	(*SecretVolumeSource)(nil),    // 2: dev.planton.provider.kubernetes.SecretVolumeSource
	(*HostPathVolumeSource)(nil),  // 3: dev.planton.provider.kubernetes.HostPathVolumeSource
	(*EmptyDirVolumeSource)(nil),  // 4: dev.planton.provider.kubernetes.EmptyDirVolumeSource
	(*PvcVolumeSource)(nil),       // 5: dev.planton.provider.kubernetes.PvcVolumeSource
}
var file_dev_planton_provider_kubernetes_volume_mount_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.kubernetes.VolumeMount.config_map:type_name -> dev.planton.provider.kubernetes.ConfigMapVolumeSource
	2, // 1: dev.planton.provider.kubernetes.VolumeMount.secret:type_name -> dev.planton.provider.kubernetes.SecretVolumeSource
	3, // 2: dev.planton.provider.kubernetes.VolumeMount.host_path:type_name -> dev.planton.provider.kubernetes.HostPathVolumeSource
	4, // 3: dev.planton.provider.kubernetes.VolumeMount.empty_dir:type_name -> dev.planton.provider.kubernetes.EmptyDirVolumeSource
	5, // 4: dev.planton.provider.kubernetes.VolumeMount.pvc:type_name -> dev.planton.provider.kubernetes.PvcVolumeSource
...
func init() { file_dev_planton_provider_kubernetes_volume_mount_proto_init() }
func file_dev_planton_provider_kubernetes_volume_mount_proto_init() {
	if File_dev_planton_provider_kubernetes_volume_mount_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_volume_mount_proto_rawDesc), len(file_dev_planton_provider_kubernetes_volume_mount_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_volume_mount_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_volume_mount_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_volume_mount_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_volume_mount_proto = out.File
	file_dev_planton_provider_kubernetes_volume_mount_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_volume_mount_proto_depIdxs = nil
}
