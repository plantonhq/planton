...
**Provider:** kubernetes  
**Component Path:** `apis/dev/planton/provider/kubernetes/kubernetesgrafana/v1/`  
**Enum Value:** 804  
**ID Prefix:** k8sgfn  
...
- Folder exists: `apis/dev/planton/provider/kubernetes/kubernetesgrafana/v1/`
...
**Path to reference:** `apis/dev/planton/provider/kubernetes/kubernetesredis/v1/`
