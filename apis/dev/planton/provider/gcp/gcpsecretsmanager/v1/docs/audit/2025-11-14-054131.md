...
**Provider:** gcp  
**Component Path:** `apis/dev/planton/provider/gcp/gcpsecretsmanager/v1/`  
**Enum Value:** 608  
**ID Prefix:** gcpsm
...
- Folder exists: `apis/dev/planton/provider/gcp/gcpsecretsmanager/v1/`
...
```bash
cd apis/dev/planton/provider/gcp/gcpsecretsmanager/v1/
go test -v
```
