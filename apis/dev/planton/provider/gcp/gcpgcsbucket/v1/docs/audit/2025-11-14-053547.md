...
- Folder exists: `apis/dev/planton/provider/gcp/gcpgcsbucket/v1/`
...
```bash
cd apis/dev/planton/provider/gcp/gcpgcsbucket/v1/
go test -v
```
...
**Path to reference:** `apis/dev/planton/provider/gcp/gcpcloudcdn/v1/`
