...
- Folder exists: `apis/dev/planton/provider/gcp/gcpdnszone/v1/`
...
```bash
cd apis/dev/planton/provider/gcp/gcpdnszone/v1/
go test -v
```
...
- Good user-facing documentation from Planton perspective
