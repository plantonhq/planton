...
const file_dev_planton_provider_gcp_gcpdnszone_v1_spec_proto_rawDesc = "" +
	"\n" +
	"1dev/planton/provider/gcp/gcpdnszone/v1/spec.proto\x12&dev.planton.provider.gcp.gcpdnszone.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1aGdev/planton/shared/networking/enums/dnsrecordtype/dns_record_type.proto\x1a(dev/planton/shared/options/options.proto\"\x8f\x02\n" +
	"\x0eGcpDnsZoneSpec\x12{\n" +
	"\n" +
	"project_id\x18\x01 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB(\xbaH\x03\xc8\x01\x01\x88\xd4a\xe1\x04\x92\xd4a\x19status.outputs.project_idR\tprojectId\x120\n" +
	"\x14iam_service_accounts\x18\x02 \x03(\tR\x12iamServiceAccounts\x12N\n" +
	"\arecords\x18\x03 \x03(\v24.dev.planton.provider.gcp.gcpdnszone.v1.GcpDnsRecordR\arecords\"\x9f\x03\n" +
	"\fGcpDnsRecord\x12i\n" +
...
var file_dev_planton_provider_gcp_gcpdnszone_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_gcp_gcpdnszone_v1_spec_proto_goTypes = []any{
	(*GcpDnsZoneSpec)(nil),           // 0: dev.planton.provider.gcp.gcpdnszone.v1.GcpDnsZoneSpec
	(*GcpDnsRecord)(nil),             // 1: dev.planton.provider.gcp.gcpdnszone.v1.GcpDnsRecord
...
var file_dev_planton_provider_gcp_gcpdnszone_v1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.gcp.gcpdnszone.v1.GcpDnsZoneSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.gcp.gcpdnszone.v1.GcpDnsZoneSpec.records:type_name -> dev.planton.provider.gcp.gcpdnszone.v1.GcpDnsRecord
	3, // 2: dev.planton.provider.gcp.gcpdnszone.v1.GcpDnsRecord.record_type:type_name -> dev.planton.shared.networking.enums.dnsrecordtype.DnsRecordType
...
func file_dev_planton_provider_gcp_gcpdnszone_v1_spec_proto_init() {
	...
	file_dev_planton_provider_gcp_gcpdnszone_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
