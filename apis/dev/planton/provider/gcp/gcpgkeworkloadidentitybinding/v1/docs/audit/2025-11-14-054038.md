...
- Folder exists: `apis/dev/planton/provider/gcp/gcpgkeworkloadidentitybinding/v1/`
...
```bash
cd apis/dev/planton/provider/gcp/gcpgkeworkloadidentitybinding/v1/
go test -v
```
...
**Path to reference:** `apis/dev/planton/provider/gcp/gcpserviceaccount/v1/`
