...
1. **Add User-Facing README.md**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpvpc/v1/README.md`
...
2. **Add examples.md File**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpvpc/v1/examples.md`
...
3. **Add Pulumi Supporting Documentation**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpvpc/v1/iac/pulumi/README.md`, `overview.md`
...
1. **Terraform Implementation is Empty**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpvpc/v1/iac/tf/main.tf`, `outputs.tf`, and add `locals.tf`
...
2. **Missing Pulumi Makefile**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpvpc/v1/iac/pulumi/Makefile`
...
3. **Missing Terraform README**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpvpc/v1/iac/tf/README.md`
...
```bash
cd apis/dev/planton/provider/gcp/gcpvpc/v1/
go test -v
```
