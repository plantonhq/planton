...
- Folder exists: `apis/dev/planton/provider/gcp/gcpserviceaccount/v1/`
...
```bash
cd apis/dev/planton/provider/gcp/gcpserviceaccount/v1/
go test -v
```
...
- Includes detailed "Planton's Approach" section explaining design philosophy
