...
This module is designed to be called by the Planton framework. Direct usage requires providing the `spec`, `metadata`, and `provider_config` variables matching the protobuf-defined schema.
