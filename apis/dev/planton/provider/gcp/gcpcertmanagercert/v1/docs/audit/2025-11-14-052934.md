...
- Folder exists: `apis/dev/planton/provider/gcp/gcpcertmanagercert/v1/`
...
```bash
cd apis/dev/planton/provider/gcp/gcpcertmanagercert/v1/
go test -v
```
...
5. **Planton's Approach** - Unified abstraction design
