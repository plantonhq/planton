...
1. **Create User-Facing README.md**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpgkecluster/v1/README.md`
...
2. **Create examples.md**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpgkecluster/v1/examples.md`
...
3. **Create iac/pulumi/README.md**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpgkecluster/v1/iac/pulumi/README.md`
...
1. **Empty Terraform main.tf file**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpgkecluster/v1/iac/tf/main.tf`
...
2. **Missing Terraform locals.tf**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpgkecluster/v1/iac/tf/locals.tf`
...
3. **Missing Research Documentation (docs/README.md)**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpgkecluster/v1/docs/README.md`
...
4. **Missing Terraform variables.tf content**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpgkecluster/v1/iac/tf/variables.tf`
...
- Folder exists at correct location: `apis/dev/planton/provider/gcp/gcpgkecluster/v1/`
...
```bash
cd apis/dev/planton/provider/gcp/gcpgkecluster/v1/
go test -v
```
...
- Validation rules verified:
  - api_version must be "gcp.planton.dev/v1"
...
7. **Create iac/pulumi/overview.md**
   - **File:** `apis/dev/planton/provider/gcp/gcpgkecluster/v1/iac/pulumi/overview.md`
...
8. **Create iac/tf/README.md**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpgkecluster/v1/iac/tf/README.md`
...
- `apis/dev/planton/provider/gcp/gcpcloudsql/v1/`
- `apis/dev/planton/provider/aws/awsekscluster/v1/`
...
5. **Re-run audit to verify improvements**:
   ```bash
   @audit-planton-component GcpGkeCluster
   ```
