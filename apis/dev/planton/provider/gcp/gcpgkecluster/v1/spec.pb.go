...
type GcpGkeClusterSpec struct {
	...
	ReleaseChannel *GkeReleaseChannel `protobuf:"varint,9,opt,name=release_channel,json=releaseChannel,proto3,enum=dev.planton.provider.gcp.gcpgkecluster.v1.GkeReleaseChannel,oneof" json:"release_channel,omitempty"`
...
const file_dev_planton_provider_gcp_gcpgkecluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"4dev/planton/provider/gcp/gcpgkecluster/v1/spec.proto\x12)dev.planton.provider.gcp.gcpgkecluster.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xc0\v\n" +
	"\x11GcpGkeClusterSpec\x12{\n" +
	"\n" +
	"project_id\x18\x01 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB(\xbaH\x03\xc8\x01\x01\x88\xd4a\xe1\x04\x92\xd4a\x19status.outputs.project_idR\tprojectId\x12\x8f\x01\n" +
	"\x11network_self_link\x18\x02 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB/\xbaH\x03\xc8\x01\x01\x88\xd4a\xe2\x04\x92\xd4a status.outputs.network_self_linkR\x0fnetworkSelfLink\x12C\n" +
	"\blocation\x18\x03 \x01(\tB'\xbaH$\xc8\x01\x01r\x1f2\x1d^[a-z]+-[a-z]+[0-9](-[a-z])?$R\blocation\x12\x98\x01\n" +
	"\x14subnetwork_self_link\x18\x04 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB2\xbaH\x03\xc8\x01\x01\x88\xd4a\xe3\x04\x92\xd4a#status.outputs.subnetwork_self_linkR\x12subnetworkSelfLink\x12\xb2\x01\n" +
	"\x1ccluster_secondary_range_name\x18\x05 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB=\xbaH\x03\xc8\x01\x01\x88\xd4a\xe3\x04\x92\xd4a.status.outputs.secondary_ranges.[*].range_nameR\x19clusterSecondaryRangeName\x12\xb4\x01\n" +
	"\x1dservices_secondary_range_name\x18\x06 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB=\xbaH\x03\xc8\x01\x01\x88\xd4a\xe3\x04\x92\xd4a.status.outputs.secondary_ranges.[*].range_nameR\x1aservicesSecondaryRangeName\x12W\n" +
	...
	"\x0frelease_channel\x18\t \x01(\x0e2<.dev.planton.provider.gcp.gcpgkecluster.v1.GkeReleaseChannelB\v\x8a\xa6\x1d\aREGULARH\x00R\x0ereleaseChannel\x88\x01\x01\x124\n" +
	...
	"\x0frouter_nat_name\x18\r \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x1c\xbaH\x03\xc8\x01\x01\x88\xd4a\xe4\x04\x92\xd4a\rmetadata.nameR\rrouterNatName\x12N\n" +
...
var file_dev_planton_provider_gcp_gcpgkecluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_dev_planton_provider_gcp_gcpgkecluster_v1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.gcp.gcpgkecluster.v1.GcpGkeClusterSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.provider.gcp.gcpgkecluster.v1.GcpGkeClusterSpec.network_self_link:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.provider.gcp.gcpgkecluster.v1.GcpGkeClusterSpec.subnetwork_self_link:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.provider.gcp.gcpgkecluster.v1.GcpGkeClusterSpec.cluster_secondary_range_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 4: dev.planton.provider.gcp.gcpgkecluster.v1.GcpGkeClusterSpec.services_secondary_range_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0, // 5: dev.planton.provider.gcp.gcpgkecluster.v1.GcpGkeClusterSpec.release_channel:type_name -> dev.planton.provider.gcp.gcpgkecluster.v1.GkeReleaseChannel
	2, // 6: dev.planton.provider.gcp.gcpgkecluster.v1.GcpGkeClusterSpec.router_nat_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
