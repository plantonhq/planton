...
**Provider:** gcp  
**Component Path:** `apis/dev/planton/provider/gcp/gcpgkenodepool/v1/`  
**Enum Value:** 613  
**ID Prefix:** gkenp
...
1. **Create User-Facing README.md**
   ...
   - **How:** Create a concise overview of GcpGkeNodePool from the Planton perspective (50-200 lines). Include purpose, key features, and a simple example.
   - **File:** `v1/README.md`
...
- Folder exists under correct provider hierarchy: `apis/dev/planton/provider/gcp/gcpgkenodepool/v1/`
...
```bash
cd apis/dev/planton/provider/gcp/gcpgkenodepool/v1/
go test -v
```
...
**Impact:** Users wanting to use the Pulumi module standalone (outside of the Planton CLI) have no documentation on how to do so.
...
2. **Create User-Facing README.md**
   ...
   - **How:** Create a 50-200 line overview from Planton perspective. Include:
