...
1. **Add iac/tf/examples.md with Terraform-specific examples**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpartifactregistryrepo/v1/iac/tf/examples.md`
...
2. **Create iac/tf/outputs.tf for Terraform outputs**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpartifactregistryrepo/v1/iac/tf/outputs.tf`
...
- Folder exists: `apis/dev/planton/provider/gcp/gcpartifactregistryrepo/v1/`
