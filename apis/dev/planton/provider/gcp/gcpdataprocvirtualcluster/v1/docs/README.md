...
In Planton, use the `GcpGkeWorkloadIdentityBinding` component to manage these bindings declaratively.
...
The Planton GcpDataprocVirtualCluster spec exposes ~25 fields across 6 message types. These cover:
