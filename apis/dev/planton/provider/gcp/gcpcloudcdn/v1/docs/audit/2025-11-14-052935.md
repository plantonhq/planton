...
**Provider:** gcp  
**Component Path:** `apis/dev/planton/provider/gcp/gcpcloudcdn/v1/`  
**Enum Value:** 601  
**ID Prefix:** gcpcdn
...
- Folder exists: `apis/dev/planton/provider/gcp/gcpcloudcdn/v1/`
...
```bash
cd apis/dev/planton/provider/gcp/gcpcloudcdn/v1/
go test -v
```
