...
- **Using Pulumi**:
  ```bash
  planton pulumi up --manifest gcp_project.yaml --stack org/project/my-gcp-stack
  ```

- **Using Terraform**:
  ```bash
  planton terraform apply --manifest gcp_project.yaml --stack org/project/my-gcp-stack
  ```
