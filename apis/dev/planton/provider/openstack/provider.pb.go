...
// 	protoc        (unknown)
// source: dev/planton/provider/openstack/provider.proto
...
func (x *OpenStackProviderConfig) Reset() {
	*x = OpenStackProviderConfig{}
	mi := &file_dev_planton_provider_openstack_provider_proto_msgTypes[0]
...
func (*OpenStackProviderConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_openstack_provider_proto_rawDescGZIP(), []int{0}
}
...
func (x *OpenStackPasswordCredentials) Reset() {
	*x = OpenStackPasswordCredentials{}
	mi := &file_dev_planton_provider_openstack_provider_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenStackPasswordCredentials) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_openstack_provider_proto_rawDescGZIP(), []int{1}
}
...
func (x *OpenStackApplicationCredentials) Reset() {
	*x = OpenStackApplicationCredentials{}
	mi := &file_dev_planton_provider_openstack_provider_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenStackApplicationCredentials) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_openstack_provider_proto_rawDescGZIP(), []int{2}
}
...
func (x *OpenStackTokenCredentials) Reset() {
	*x = OpenStackTokenCredentials{}
	mi := &file_dev_planton_provider_openstack_provider_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenStackTokenCredentials) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_openstack_provider_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_openstack_provider_proto protoreflect.FileDescriptor

const file_dev_planton_provider_openstack_provider_proto_rawDesc = "" +
	"\n" +
	"-dev/planton/provider/openstack/provider.proto\x12\x1edev.planton.provider.openstack\x1a\x1bbuf/validate/validate.proto\"\xd8\x05\n" +
	...
	"\bpassword\x18\n" +
	" \x01(\v2<.dev.planton.provider.openstack.OpenStackPasswordCredentialsH\x00R\bpassword\x12x\n" +
	"\x16application_credential\x18\v \x01(\v2?.dev.planton.provider.openstack.OpenStackApplicationCredentialsH\x00R\x15applicationCredential\x12Q\n" +
	"\x05token\x18\f \x01(\v29.dev.planton.provider.openstack.OpenStackTokenCredentialsH\x00R\x05token\x12\x1f\n" +
	...
	"\"com.dev.planton.provider.openstackB\rProviderProtoP\x01Z@github.com/plantonhq/planton/apis/dev/planton/provider/openstack\xa2\x02\x04DPPO\xaa\x02\x1eDev.Planton.Provider.Openstack\xca\x02\x1eDev\\Planton\\Provider\\Openstack\xe2\x02*Dev\\Planton\\Provider\\Openstack\\GPBMetadata\xea\x02!Dev::Planton::Provider::Openstackb\x06proto3"

var (
	file_dev_planton_provider_openstack_provider_proto_rawDescOnce sync.Once
	file_dev_planton_provider_openstack_provider_proto_rawDescData []byte
)

func file_dev_planton_provider_openstack_provider_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_openstack_provider_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_openstack_provider_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_openstack_provider_proto_rawDesc), len(file_dev_planton_provider_openstack_provider_proto_rawDesc)))
	})
	return file_dev_planton_provider_openstack_provider_proto_rawDescData
}

var file_dev_planton_provider_openstack_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_openstack_provider_proto_goTypes = []any{
	(*OpenStackProviderConfig)(nil),         // 0: dev.planton.provider.openstack.OpenStackProviderConfig
	(*OpenStackPasswordCredentials)(nil),    // 1: dev.planton.provider.openstack.OpenStackPasswordCredentials
	(*OpenStackApplicationCredentials)(nil), // 2: dev.planton.provider.openstack.OpenStackApplicationCredentials
	(*OpenStackTokenCredentials)(nil),       // 3: dev.planton.provider.openstack.OpenStackTokenCredentials
}
var file_dev_planton_provider_openstack_provider_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.openstack.OpenStackProviderConfig.password:type_name -> dev.planton.provider.openstack.OpenStackPasswordCredentials
	2, // 1: dev.planton.provider.openstack.OpenStackProviderConfig.application_credential:type_name -> dev.planton.provider.openstack.OpenStackApplicationCredentials
	3, // 2: dev.planton.provider.openstack.OpenStackProviderConfig.token:type_name -> dev.planton.provider.openstack.OpenStackTokenCredentials
...
func init() { file_dev_planton_provider_openstack_provider_proto_init() }
func file_dev_planton_provider_openstack_provider_proto_init() {
	if File_dev_planton_provider_openstack_provider_proto != nil {
		return
	}
	file_dev_planton_provider_openstack_provider_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_openstack_provider_proto_rawDesc), len(file_dev_planton_provider_openstack_provider_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_openstack_provider_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_openstack_provider_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_openstack_provider_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_openstack_provider_proto = out.File
	file_dev_planton_provider_openstack_provider_proto_goTypes = nil
	file_dev_planton_provider_openstack_provider_proto_depIdxs = nil
}
