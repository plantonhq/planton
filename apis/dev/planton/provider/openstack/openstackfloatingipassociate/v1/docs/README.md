...
This is one of the simplest Terraform resources -- only 4 attributes, all included in the Planton spec. No 80/20 filtering was needed.
...
This is the first FK in Planton that targets a non-UUID output. All previous FKs target resource IDs (UUIDs).
