...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awseksnodegroup/v1/`  
**Enum Value:** 217  
**ID Prefix:** eksng
...
- Folder exists: `apis/dev/planton/provider/aws/awseksnodegroup/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awseksnodegroup/v1/
go test -v
```
...
- Explains 80/20 scoping decisions ("What Planton Provides")
...
- Describes deployment with Planton CLI
