...
type AwsEksNodeGroupSpec struct {
	...
	CapacityType AwsEksNodeGroupCapacityType `protobuf:"varint,7,opt,name=capacity_type,json=capacityType,proto3,enum=dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupCapacityType" json:"capacity_type,omitempty"`
...
const file_dev_planton_provider_aws_awseksnodegroup_v1_spec_proto_rawDesc = "" +
	"\n" +
	"6dev/planton/provider/aws/awseksnodegroup/v1/spec.proto\x12+dev.planton.provider.aws.awseksnodegroup.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xd0\a\n" +
	"\x13AwsEksNodeGroupSpec\x12\x1f\n" +
	"\x06region\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06region\x12s\n" +
	"\fcluster_name\x18\x02 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x1c\xbaH\x03\xc8\x01\x01\x88\xd4a\xcf\x01\x92\xd4a\rmetadata.nameR\vclusterName\x12~\n" +
	...
	"\n" +
	"subnet_ids\x18\x04 \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB,\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x02\x88\xd4a\x9c\x02\x92\xd4a\x18status.outputs.subnet_idR\tsubnetIds\x12+\n" +
	"\rinstance_type\x18\x05 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\finstanceType\x12k\n" +
	"\ascaling\x18\x06 \x01(\v2I.dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupScalingConfigB\x06\xbaH\x03\xc8\x01\x01R\ascaling\x12|\n" +
	"\rcapacity_type\x18\a \x01(\x0e2H.dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupCapacityTypeB\r\x92\xa6\x1d\ton_demandR\fcapacityType\x12)\n" +
	"\fdisk_size_gb\x18\b \x01(\x05B\a\x92\xa6\x1d\x03100R\n" +
	"diskSizeGb\x12*\n" +
	"\fssh_key_name\x18\t \x01(\tB\b\xbaH\x05r\x03\x18\xff\x01R\n" +
	"sshKeyName\x12x\n" +
	"\x06labels\x18\n" +
	" \x03(\v2L.dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.LabelsEntryB\x12\xbaH\x0f\x9a\x01\f\"\x04r\x02\x18?*\x04r\x02\x18?R\x06labels\x1a9\n" +
...
var file_dev_planton_provider_aws_awseksnodegroup_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awseksnodegroup_v1_spec_proto_goTypes = []any{
	...
	(*AwsEksNodeGroupScalingConfig)(nil), // 2: dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupScalingConfig
	nil,                                  // 3: dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.LabelsEntry
...
var file_dev_planton_provider_aws_awseksnodegroup_v1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.cluster_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 1: dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.node_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 2: dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.scaling:type_name -> dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupScalingConfig
	...
	3, // 5: dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.labels:type_name -> dev.planton.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.LabelsEntry
