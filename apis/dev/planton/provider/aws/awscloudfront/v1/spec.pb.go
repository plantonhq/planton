...
func (AwsCloudFrontSpec_PriceClass) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_aws_awscloudfront_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AwsCloudFrontSpec_PriceClass) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_aws_awscloudfront_v1_spec_proto_enumTypes[0]
}
...
func (AwsCloudFrontSpec_PriceClass) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscloudfront_v1_spec_proto_rawDescGZIP(), []int{0, 0}
}
...
type AwsCloudFrontSpec struct {
	...
	PriceClass     AwsCloudFrontSpec_PriceClass `protobuf:"varint,5,opt,name=price_class,json=priceClass,proto3,enum=dev.planton.provider.aws.awscloudfront.v1.AwsCloudFrontSpec_PriceClass" json:"price_class,omitempty"`
...
const file_dev_planton_provider_aws_awscloudfront_v1_spec_proto_rawDesc = "" +
	"\n" +
	"4dev/planton/provider/aws/awscloudfront/v1/spec.proto\x12)dev.planton.provider.aws.awscloudfront.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xf1\b\n" +
	...
	"\x0fcertificate_arn\x18\x04 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xc9\x01\x92\xd4a\x17status.outputs.cert_arnR\x0ecertificateArn\x12r\n" +
	"\vprice_class\x18\x05 \x01(\x0e2G.dev.planton.provider.aws.awscloudfront.v1.AwsCloudFrontSpec.PriceClassB\b\xbaH\x05\x82\x01\x02\x10\x01R\n" +
	"priceClass\x12g\n" +
	"\aorigins\x18\x06 \x03(\v2C.dev.planton.provider.aws.awscloudfront.v1.AwsCloudFrontSpec.OriginB\b\xbaH\x05\x92\x01\x02\b\x01R\aorigins\x12K\n" +
...
var file_dev_planton_provider_aws_awscloudfront_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_aws_awscloudfront_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_aws_awscloudfront_v1_spec_proto_goTypes = []any{
	(AwsCloudFrontSpec_PriceClass)(0), // 0: dev.planton.provider.aws.awscloudfront.v1.AwsCloudFrontSpec.PriceClass
	(*AwsCloudFrontSpec)(nil),         // 1: dev.planton.provider.aws.awscloudfront.v1.AwsCloudFrontSpec
	(*AwsCloudFrontSpec_Origin)(nil),  // 2: dev.planton.provider.aws.awscloudfront.v1.AwsCloudFrontSpec.Origin
...
var file_dev_planton_provider_aws_awscloudfront_v1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awscloudfront.v1.AwsCloudFrontSpec.certificate_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0, // 1: dev.planton.provider.aws.awscloudfront.v1.AwsCloudFrontSpec.price_class:type_name -> dev.planton.provider.aws.awscloudfront.v1.AwsCloudFrontSpec.PriceClass
	2, // 2: dev.planton.provider.aws.awscloudfront.v1.AwsCloudFrontSpec.origins:type_name -> dev.planton.provider.aws.awscloudfront.v1.AwsCloudFrontSpec.Origin
...
func file_dev_planton_provider_aws_awscloudfront_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_dev_planton_provider_aws_awscloudfront_v1_spec_proto_enumTypes,
