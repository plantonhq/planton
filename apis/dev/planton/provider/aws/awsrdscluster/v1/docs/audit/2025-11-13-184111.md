...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awsrdscluster/v1/`  
**Enum Value:** 210  
**ID Prefix:** rdsclu
...
- Folder exists: `apis/dev/planton/provider/aws/awsrdscluster/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awsrdscluster/v1/
go test -v
```
