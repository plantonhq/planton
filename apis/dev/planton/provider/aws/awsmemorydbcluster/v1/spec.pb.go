...
const file_dev_planton_provider_aws_awsmemorydbcluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"9dev/planton/provider/aws/awsmemorydbcluster/v1/spec.proto\x12.dev.planton.provider.aws.awsmemorydbcluster.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xc0\x13\n" +
	...
	"\n" +
	"subnet_ids\x18\n" +
	" \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB!\x88\xd4a\x9c\x02\x92\xd4a\x18status.outputs.subnet_idR\tsubnetIds\x12\x8b\x01\n" +
	"\x12security_group_ids\x18\v \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB)\x88\xd4a\xd7\x01\x92\xd4a status.outputs.security_group_idR\x10securityGroupIds\x12.\n" +
	"\vtls_enabled\x18\f \x01(\bB\b\x8a\xa6\x1d\x04trueH\x04R\n" +
	"tlsEnabled\x88\x01\x01\x12q\n" +
	"\n" +
	"kms_key_id\x18\r \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x1f\x88\xd4a\xdb\x01\x92\xd4a\x16status.outputs.key_arnR\bkmsKeyId\x12\xb4\x01\n" +
	...
	"\n" +
	"parameters\x18\x15 \x03(\v2K.dev.planton.provider.aws.awsmemorydbcluster.v1.AwsMemorydbClusterParameterR\n" +
	"parameters\x12y\n" +
	"\rsns_topic_arn\x18\x16 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB!\x88\xd4a\xe2\x01\x92\xd4a\x18status.outputs.topic_arnR\vsnsTopicArn\x12J\n" +
...
var file_dev_planton_provider_aws_awsmemorydbcluster_v1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.aws.awsmemorydbcluster.v1.AwsMemorydbClusterSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.provider.aws.awsmemorydbcluster.v1.AwsMemorydbClusterSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.provider.aws.awsmemorydbcluster.v1.AwsMemorydbClusterSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 3: dev.planton.provider.aws.awsmemorydbcluster.v1.AwsMemorydbClusterSpec.parameters:type_name -> dev.planton.provider.aws.awsmemorydbcluster.v1.AwsMemorydbClusterParameter
	2, // 4: dev.planton.provider.aws.awsmemorydbcluster.v1.AwsMemorydbClusterSpec.sns_topic_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
