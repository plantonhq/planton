...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awss3bucket/v1/`  
**Enum Value:** 213  
**ID Prefix:** s3bkt
...
- Folder exists: `apis/dev/planton/provider/aws/awss3bucket/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awss3bucket/v1/
go test -v
```
...
PASS
ok  	github.com/plantonhq/planton/apis/dev/planton/provider/aws/awss3bucket/v1	0.372s
```
...
File is substantial, providing clear user-facing documentation from Planton perspective.
...
- `apis/dev/planton/provider/aws/awsalb/v1/`
- `apis/dev/planton/provider/aws/awscertmanagercert/v1/`
- `apis/dev/planton/provider/aws/awsdynamodb/v1/`
