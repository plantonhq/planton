...
func (Architecture) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_aws_awslambda_v1_spec_proto_enumTypes[0].Descriptor()
}

func (Architecture) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_aws_awslambda_v1_spec_proto_enumTypes[0]
}
...
func (CodeSourceType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_aws_awslambda_v1_spec_proto_enumTypes[1].Descriptor()
}

func (CodeSourceType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_aws_awslambda_v1_spec_proto_enumTypes[1]
}
...
type AwsLambdaSpec struct {
	...
	Architecture Architecture `protobuf:"varint,13,opt,name=architecture,proto3,enum=dev.planton.provider.aws.awslambda.v1.Architecture" json:"architecture,omitempty"`
	...
	CodeSourceType CodeSourceType `protobuf:"varint,16,opt,name=code_source_type,json=codeSourceType,proto3,enum=dev.planton.provider.aws.awslambda.v1.CodeSourceType" json:"code_source_type,omitempty"`
...
const file_dev_planton_provider_aws_awslambda_v1_spec_proto_rawDesc = "" +
	"\n" +
	"0dev/planton/provider/aws/awslambda/v1/spec.proto\x12%dev.planton.provider.aws.awslambda.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xca\x12\n" +
	...
	"\venvironment\x18\n" +
	" \x03(\v2E.dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec.EnvironmentEntryR\venvironment\x12o\n" +
	"\asubnets\x18\v \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB!\x88\xd4a\x9c\x02\x92\xd4a\x18status.outputs.subnet_idR\asubnets\x12\x86\x01\n" +
	"\x0fsecurity_groups\x18\f \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB)\x88\xd4a\xd7\x01\x92\xd4a status.outputs.security_group_idR\x0esecurityGroups\x12a\n" +
	"\farchitecture\x18\r \x01(\x0e23.dev.planton.provider.aws.awslambda.v1.ArchitectureB\b\xbaH\x05\x82\x01\x02\x10\x01R\farchitecture\x12Q\n" +
	"\n" +
	"layer_arns\x18\x0e \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefR\tlayerArns\x12s\n" +
	"\vkms_key_arn\x18\x0f \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x1f\x88\xd4a\xdb\x01\x92\xd4a\x16status.outputs.key_arnR\tkmsKeyArn\x12i\n" +
	"\x10code_source_type\x18\x10 \x01(\x0e25.dev.planton.provider.aws.awslambda.v1.CodeSourceTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x0ecodeSourceType\x12=\n" +
	"\x02s3\x18\x11 \x01(\v2-.dev.planton.provider.aws.awslambda.v1.S3CodeR\x02s3\x12\x1b\n" +
...
var file_dev_planton_provider_aws_awslambda_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_dev_planton_provider_aws_awslambda_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awslambda_v1_spec_proto_goTypes = []any{
	(Architecture)(0),           // 0: dev.planton.provider.aws.awslambda.v1.Architecture
	(CodeSourceType)(0),         // 1: dev.planton.provider.aws.awslambda.v1.CodeSourceType
	(*AwsLambdaSpec)(nil),       // 2: dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec
	(*S3Code)(nil),              // 3: dev.planton.provider.aws.awslambda.v1.S3Code
	nil,                         // 4: dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec.EnvironmentEntry
...
var file_dev_planton_provider_aws_awslambda_v1_spec_proto_depIdxs = []int32{
	5, // 0: dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec.role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 1: dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec.environment:type_name -> dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec.EnvironmentEntry
	5, // 2: dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec.subnets:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 3: dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec.security_groups:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0, // 4: dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec.architecture:type_name -> dev.planton.provider.aws.awslambda.v1.Architecture
	5, // 5: dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec.layer_arns:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 6: dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec.kms_key_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 7: dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec.code_source_type:type_name -> dev.planton.provider.aws.awslambda.v1.CodeSourceType
	3, // 8: dev.planton.provider.aws.awslambda.v1.AwsLambdaSpec.s3:type_name -> dev.planton.provider.aws.awslambda.v1.S3Code
...
func file_dev_planton_provider_aws_awslambda_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_dev_planton_provider_aws_awslambda_v1_spec_proto_enumTypes,
