...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awslambda/v1/`  
**Enum Value:** 209  
**ID Prefix:** lambda
...
- Folder exists: `apis/dev/planton/provider/aws/awslambda/v1/`
- Folder name matches lowercase enum name (AwsLambda → awslambda)
- `v1/` subfolder exists
- Follows standard Planton directory structure
...
```bash
cd apis/dev/planton/provider/aws/awslambda/v1/
go test -v
```
