...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awsdynamodb/v1/`  
**Enum Value:** 203  
**ID Prefix:** awsdyn
...
- Folder exists: `apis/dev/planton/provider/aws/awsdynamodb/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awsdynamodb/v1/
go test -v
```
...
- Explains 80/20 scoping decisions and what Planton supports
...
- Explains how it works with Planton
...
**Path to reference:** Other AWS components at `apis/dev/planton/provider/aws/` can serve as templates for the overview.md structure.
