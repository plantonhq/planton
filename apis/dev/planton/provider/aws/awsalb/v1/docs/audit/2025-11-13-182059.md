...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awsalb/v1/`  
**Enum Value:** 200  
**ID Prefix:** awsalb
...
- Folder exists: `apis/dev/planton/provider/aws/awsalb/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awsalb/v1/
go test -v
```
...
The **AwsAlb** component represents a **gold standard** implementation within Planton. With a perfect 100% completion score, it demonstrates:
...
This component serves as the **reference implementation** for how AWS provider components should be built in Planton.
