...
const file_dev_planton_provider_aws_awsathenaworkgroup_v1_spec_proto_rawDesc = "" +
	"\n" +
	"9dev/planton/provider/aws/awsathenaworkgroup/v1/spec.proto\x12.dev.planton.provider.aws.awsathenaworkgroup.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xe9\f\n" +
	"\x16AwsAthenaWorkgroupSpec\x12\x1f\n" +
	"\x06region\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06region\x12\x81\x01\n" +
	"\x14result_configuration\x18\x02 \x01(\v2N.dev.planton.provider.aws.awsathenaworkgroup.v1.AwsAthenaWorkgroupResultConfigR\x13resultConfiguration\x12B\n" +
	...
	" \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xd0\x01\x92\xd4a\x17status.outputs.role_arnR\rexecutionRole:\x80\x06\xbaH\xfc\x05\x1a\xcb\x01\n" +
...
var file_dev_planton_provider_aws_awsathenaworkgroup_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_dev_planton_provider_aws_awsathenaworkgroup_v1_spec_proto_depIdxs = []int32{
	...
	2, // 1: dev.planton.provider.aws.awsathenaworkgroup.v1.AwsAthenaWorkgroupSpec.execution_role:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.provider.aws.awsathenaworkgroup.v1.AwsAthenaWorkgroupResultConfig.kms_key_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
