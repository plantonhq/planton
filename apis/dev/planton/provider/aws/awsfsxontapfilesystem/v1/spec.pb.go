...
const file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<dev/planton/provider/aws/awsfsxontapfilesystem/v1/spec.proto\x121dev.planton.provider.aws.awsfsxontapfilesystem.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xc8\x1b\n" +
	...
	"\n" +
	"subnet_ids\x18\a \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB)\xbaH\x05\x92\x01\x02\b\x01\x88\xd4a\x9c\x02\x92\xd4a\x18status.outputs.subnet_idR\tsubnetIds\x12\x85\x01\n" +
	"\x13preferred_subnet_id\x18\b \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB!\x88\xd4a\x9c\x02\x92\xd4a\x18status.outputs.subnet_idR\x11preferredSubnetId\x12\x8b\x01\n" +
	"\x12security_group_ids\x18\t \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB)\x88\xd4a\xd7\x01\x92\xd4a status.outputs.security_group_idR\x10securityGroupIds\x129\n" +
	"\x19endpoint_ip_address_range\x18\n" +
	" \x01(\tR\x16endpointIpAddressRange\x12Z\n" +
	"\x0froute_table_ids\x18\v \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefR\rrouteTableIds\x12q\n" +
	"\n" +
	"kms_key_id\x18\f \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x1f\x88\xd4a\xdb\x01\x92\xd4a\x16status.outputs.key_arnR\bkmsKeyId\x122\n" +
	"\x12fsx_admin_password\x18\r \x01(\tB\x04\xa0\xa6\x1d\x01R\x10fsxAdminPassword\x12\x95\x01\n" +
	"\x17disk_iops_configuration\x18\x0e \x01(\v2].dev.planton.provider.aws.awsfsxontapfilesystem.v1.AwsFsxOntapFileSystemDiskIopsConfigurationR\x15diskIopsConfiguration\x12Z\n" +
