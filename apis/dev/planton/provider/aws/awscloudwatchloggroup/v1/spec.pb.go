...
const file_dev_planton_provider_aws_awscloudwatchloggroup_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<dev/planton/provider/aws/awscloudwatchloggroup/v1/spec.proto\x121dev.planton.provider.aws.awscloudwatchloggroup.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xcc\b\n" +
...
var file_dev_planton_provider_aws_awscloudwatchloggroup_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_dev_planton_provider_aws_awscloudwatchloggroup_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.aws.awscloudwatchloggroup.v1.AwsCloudwatchLogGroupSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
