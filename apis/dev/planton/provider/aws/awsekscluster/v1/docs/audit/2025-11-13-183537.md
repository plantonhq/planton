...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awsekscluster/v1/`  
**Enum Value:** 207  
**ID Prefix:** eks
...
- Folder exists: `apis/dev/planton/provider/aws/awsekscluster/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awsekscluster/v1/
go test -v
```
...
**Path to reference:** `apis/dev/planton/provider/aws/awsrdsinstance/v1/`
