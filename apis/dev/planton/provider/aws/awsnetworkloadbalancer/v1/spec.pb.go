...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsnetworkloadbalancer/v1/spec.proto
...
func (x *AwsNetworkLoadBalancerSpec) Reset() {
	*x = AwsNetworkLoadBalancerSpec{}
	mi := &file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_msgTypes[0]
...
func (*AwsNetworkLoadBalancerSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsNetworkLoadBalancerSubnetMapping) Reset() {
	*x = AwsNetworkLoadBalancerSubnetMapping{}
	mi := &file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsNetworkLoadBalancerSubnetMapping) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsNetworkLoadBalancerListener) Reset() {
	*x = AwsNetworkLoadBalancerListener{}
	mi := &file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsNetworkLoadBalancerListener) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsNetworkLoadBalancerTlsConfig) Reset() {
	*x = AwsNetworkLoadBalancerTlsConfig{}
	mi := &file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsNetworkLoadBalancerTlsConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsNetworkLoadBalancerTargetGroup) Reset() {
	*x = AwsNetworkLoadBalancerTargetGroup{}
	mi := &file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsNetworkLoadBalancerTargetGroup) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsNetworkLoadBalancerHealthCheck) Reset() {
	*x = AwsNetworkLoadBalancerHealthCheck{}
	mi := &file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsNetworkLoadBalancerHealthCheck) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsNetworkLoadBalancerDns) Reset() {
	*x = AwsNetworkLoadBalancerDns{}
	mi := &file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsNetworkLoadBalancerDns) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDesc = "" +
	"\n" +
	"=dev/planton/provider/aws/awsnetworkloadbalancer/v1/spec.proto\x122dev.planton.provider.aws.awsnetworkloadbalancer.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xee\n" +
	"\n" +
	"\x1aAwsNetworkLoadBalancerSpec\x12\x1f\n" +
	"\x06region\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06region\x12\x8d\x01\n" +
	"\x0fsubnet_mappings\x18\x02 \x03(\v2W.dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerSubnetMappingB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01R\x0esubnetMappings\x12\x86\x01\n" +
	...
	"\tlisteners\x18\t \x03(\v2R.dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerListenerB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01R\tlisteners\x12_\n" +
	"\x03dns\x18\n" +
	" \x01(\v2M.dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerDnsR\x03dns:\x99\x04\xbaH\x95\x04\x1a\x9c\x01\n" +
	...
	"\x03tls\x18\x04 \x01(\v2S.dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerTlsConfigR\x03tls\x127\n" +
	...
	"\ftarget_group\x18\a \x01(\v2U.dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerTargetGroupB\x06\xbaH\x03\xc8\x01\x01R\vtargetGroup:\xdc\a\xbaH\xd8\a\x1a}\n" +
	...
	"targetType\x12x\n" +
	"\fhealth_check\x18\x04 \x01(\v2U.dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerHealthCheckR\vhealthCheck\x12I\n" +
	...
	"6com.dev.planton.provider.aws.awsnetworkloadbalancer.v1B\tSpecProtoP\x01Zmgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsnetworkloadbalancer/v1;awsnetworkloadbalancerv1\xa2\x02\x05DPPAA\xaa\x022Dev.Planton.Provider.Aws.Awsnetworkloadbalancer.V1\xca\x022Dev\\Planton\\Provider\\Aws\\Awsnetworkloadbalancer\\V1\xe2\x02>Dev\\Planton\\Provider\\Aws\\Awsnetworkloadbalancer\\V1\\GPBMetadata\xea\x027Dev::Planton::Provider::Aws::Awsnetworkloadbalancer::V1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_goTypes = []any{
	(*AwsNetworkLoadBalancerSpec)(nil),          // 0: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerSpec
	(*AwsNetworkLoadBalancerSubnetMapping)(nil), // 1: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerSubnetMapping
	(*AwsNetworkLoadBalancerListener)(nil),      // 2: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerListener
	(*AwsNetworkLoadBalancerTlsConfig)(nil),     // 3: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerTlsConfig
	(*AwsNetworkLoadBalancerTargetGroup)(nil),   // 4: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerTargetGroup
	(*AwsNetworkLoadBalancerHealthCheck)(nil),   // 5: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerHealthCheck
	(*AwsNetworkLoadBalancerDns)(nil),           // 6: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerDns
	(*v1.StringValueOrRef)(nil),                 // 7: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_depIdxs = []int32{
	1,  // 0: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerSpec.subnet_mappings:type_name -> dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerSubnetMapping
	7,  // 1: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerSpec.security_groups:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2,  // 2: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerSpec.listeners:type_name -> dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerListener
	6,  // 3: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerSpec.dns:type_name -> dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerDns
	7,  // 4: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerSubnetMapping.subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 5: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerSubnetMapping.allocation_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3,  // 6: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerListener.tls:type_name -> dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerTlsConfig
	4,  // 7: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerListener.target_group:type_name -> dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerTargetGroup
	7,  // 8: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerTlsConfig.certificate_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 9: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerTargetGroup.health_check:type_name -> dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerHealthCheck
	7,  // 10: dev.planton.provider.aws.awsnetworkloadbalancer.v1.AwsNetworkLoadBalancerDns.route53_zone_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_init() }
func file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsnetworkloadbalancer_v1_spec_proto_depIdxs = nil
}
