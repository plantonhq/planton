...
The **AwsNetworkLoadBalancer** resource provides a standardized way to provision and manage AWS Network Load Balancers (NLBs) through Planton. NLBs operate at Layer 4 (TCP/UDP/TLS), offering ultra-low latency, static IP addresses per Availability Zone, and the ability to handle millions of connections per second.
...
When you define an AwsNetworkLoadBalancer resource, Planton:
