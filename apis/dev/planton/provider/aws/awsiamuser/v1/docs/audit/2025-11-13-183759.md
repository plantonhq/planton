...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awsiamuser/v1/`  
**Enum Value:** 218  
**ID Prefix:** awsuser
...
1. **Create README.md at v1 level**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsiamuser/v1/README.md`
...
2. **Create examples.md at v1 level**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsiamuser/v1/examples.md`
...
3. **Create iac/pulumi/overview.md**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsiamuser/v1/iac/pulumi/overview.md`
   - **Impact:** +3.34% score
...
1. **Missing User-Facing Documentation**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsiamuser/v1/README.md` and `examples.md`
...
- Folder exists: `apis/dev/planton/provider/aws/awsiamuser/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awsiamuser/v1/
go test -v
```
...
- Validation rules verified for:
  - ApiVersion constant: `aws.planton.dev/v1`
...
- `README.md` does NOT exist at `apis/dev/planton/provider/aws/awsiamuser/v1/README.md`
...
- `examples.md` does NOT exist at `apis/dev/planton/provider/aws/awsiamuser/v1/examples.md`
...
1. **Create v1-level README.md**
   ...
   - **Reference:** See `apis/dev/planton/provider/aws/awsrdsinstance/v1/README.md` for structure
   - **Impact:** +6.67% score
...
4. **Enhance iac/tf/main.tf**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsiamuser/v1/iac/tf/main.tf`
...
5. **Create iac/hack/manifest.yaml**
   - **File:** `apis/dev/planton/provider/aws/awsiamuser/v1/iac/hack/manifest.yaml`
...
6. **Expand iac/pulumi/examples.md**
   - **File:** `apis/dev/planton/provider/aws/awsiamuser/v1/iac/pulumi/examples.md`
...
**Path to reference:** `apis/dev/planton/provider/aws/awsiamrole/v1/`
...
These three files would bring the score to **94.67%**, making this a model component within the Planton framework.
