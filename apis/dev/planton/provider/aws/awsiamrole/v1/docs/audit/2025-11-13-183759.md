...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awsiamrole/v1/`  
**Enum Value:** 208  
**ID Prefix:** air
...
1. **Create v1/README.md**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsiamrole/v1/README.md`
   - **Impact:** +6.67%
...
2. **Create v1/examples.md**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsiamrole/v1/examples.md`
   - **Impact:** +6.66%
...
3. **Create iac/hack/manifest.yaml**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsiamrole/v1/iac/hack/manifest.yaml`
   - **Impact:** +1.67%
...
- Folder exists: `apis/dev/planton/provider/aws/awsiamrole/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awsiamrole/v1/
go test -v
```
...
- ✅ Explains Planton's architectural decisions ("Planton's Approach: Terraform and Pulumi for Maximum Flexibility")
...
4. **Create iac/pulumi/overview.md**
   - **File:** `apis/dev/planton/provider/aws/awsiamrole/v1/iac/pulumi/overview.md`
   - **Why:** Provides architectural overview of Pulumi implementation
   - **How:** Document:
     - Pulumi stack structure
     - Module organization
     - Input/output flow
     - Integration with Planton framework
...
5. **Expand test coverage**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsiamrole/v1/spec_test.go`
...
**Path to reference:** `apis/dev/planton/provider/aws/awslambda/v1/`
...
- [x] Folder exists: `apis/dev/planton/provider/aws/awsiamrole/`
