...
const file_dev_planton_provider_aws_awsecrrepo_v1_spec_proto_rawDesc = "" +
	"\n" +
	"1dev/planton/provider/aws/awsecrrepo/v1/spec.proto\x12&dev.planton.provider.aws.awsecrrepo.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xd2\x04\n" +
	...
	"\n" +
	"kms_key_id\x18\x05 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x1f\x88\xd4a\xdb\x01\x92\xd4a\x16status.outputs.key_arnR\bkmsKeyId\x12!\n" +
	...
	"\x10lifecycle_policy\x18\b \x01(\v2A.dev.planton.provider.aws.awsecrrepo.v1.AwsEcrRepoLifecyclePolicyH\x02R\x0flifecyclePolicy\x88\x01\x01B\x12\n" +
...
var file_dev_planton_provider_aws_awsecrrepo_v1_spec_proto_goTypes = []any{
	...
	(*AwsEcrRepoLifecyclePolicy)(nil), // 1: dev.planton.provider.aws.awsecrrepo.v1.AwsEcrRepoLifecyclePolicy
...
var file_dev_planton_provider_aws_awsecrrepo_v1_spec_proto_depIdxs = []int32{
	...
	1, // 1: dev.planton.provider.aws.awsecrrepo.v1.AwsEcrRepoSpec.lifecycle_policy:type_name -> dev.planton.provider.aws.awsecrrepo.v1.AwsEcrRepoLifecyclePolicy
...
func file_dev_planton_provider_aws_awsecrrepo_v1_spec_proto_init() {
	...
	file_dev_planton_provider_aws_awsecrrepo_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
