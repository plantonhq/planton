...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awsrdsinstance/v1/`  
**Enum Value:** 211  
**ID Prefix:** rdsins
...
1. **Add Pulumi overview.md**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsrdsinstance/v1/iac/pulumi/overview.md`
...
2. **Add or rename main.tf in Terraform module**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsrdsinstance/v1/iac/tf/main.tf`
...
- Folder exists: `apis/dev/planton/provider/aws/awsrdsinstance/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awsrdsinstance/v1/
go test -v
```
...
- **Deployment Methods Comparison:** Detailed comparison of:
  ...
  - CloudFormation
  - AWS CDK
  - Explanation of Planton's dual-track approach
...
**Path to reference:** `apis/dev/planton/provider/aws/awsrdscluster/v1/`
...
✅ **Best Practices:** Follows Planton coding guidelines
