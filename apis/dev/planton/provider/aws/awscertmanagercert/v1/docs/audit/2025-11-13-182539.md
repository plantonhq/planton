...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awscertmanagercert/v1/`  
**Enum Value:** 201  
**ID Prefix:** acmcert
...
- Folder exists: `apis/dev/planton/provider/aws/awscertmanagercert/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awscertmanagercert/v1/
go test -v
```
...
- Documents usage with Planton CLI
...
This component was successfully created using the Planton forge rules and serves as an excellent reference implementation for other components.

---

## Comparison to Complete Components

**Component Status:** This is one of the most complete components in the Planton repository.
...
This component can serve as a reference implementation for other components in the Planton ecosystem.
