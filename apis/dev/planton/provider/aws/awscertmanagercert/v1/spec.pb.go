...
const file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDesc = "" +
	"\n" +
	"9dev/planton/provider/aws/awscertmanagercert/v1/spec.proto\x12.dev.planton.provider.aws.awscertmanagercert.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xa0\x04\n" +
	...
	"\x16route53_hosted_zone_id\x18\x04 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB%\xbaH\x03\xc8\x01\x01\x88\xd4a\xd4\x01\x92\xd4a\x16status.outputs.zone_idR\x13route53HostedZoneId\x12J\n" +
...
var file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertSpec.route53_hosted_zone_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
