...
func (AwsEc2InstanceConnectionMethod) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AwsEc2InstanceConnectionMethod) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_enumTypes[0]
}
...
type AwsEc2InstanceSpec struct {
	...
	// The default kind expects an AwsVpc resource, using its first private subnet ID.
	...
	RootVolumeSizeGb *int32 `protobuf:"varint,10,opt,name=root_volume_size_gb,json=rootVolumeSizeGb,proto3,oneof" json:"root_volume_size_gb,omitempty"`
	...
	DisableApiTermination bool `protobuf:"varint,14,opt,name=disable_api_termination,json=disableApiTermination,proto3" json:"disable_api_termination,omitempty"`
...
const file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDesc = "" +
	"\n" +
	"5dev/planton/provider/aws/awsec2instance/v1/spec.proto\x12*dev.planton.provider.aws.awsec2instance.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x83\r\n" +
	...
	"\x04tags\x18\v \x03(\v2H.dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.TagsEntryR\x04tags\x12&\n" +
	"\tuser_data\x18\f \x01(\tB\t\xbaH\x06r\x04(\x80\x80\x02R\buserData\x12#\n" +
	"\rebs_optimized\x18\r \x01(\bR\febsOptimized\x126\n" +
	"\x17disable_api_termination\x18\x0e \x01(\bR\x15disableApiTermination\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
...
var file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_goTypes = []any{
	(AwsEc2InstanceConnectionMethod)(0), // 0: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceConnectionMethod
	(*AwsEc2InstanceSpec)(nil),          // 1: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec
	nil,                                 // 2: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.TagsEntry
...
var file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0, // 2: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.connection_method:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceConnectionMethod
	3, // 3: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.iam_instance_profile_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 4: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.tags:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.TagsEntry
...
func file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_enumTypes,
