...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awsec2instance/v1/`  
**Enum Value:** 220  
**ID Prefix:** ec2inst
...
1. **Create `iac/pulumi/overview.md`**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsec2instance/v1/iac/pulumi/overview.md`
...
2. **Expand `iac/tf/main.tf`**
   ...
   - **File:** `apis/dev/planton/provider/aws/awsec2instance/v1/iac/tf/main.tf`
...
- Folder exists: `apis/dev/planton/provider/aws/awsec2instance/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awsec2instance/v1/
go test -v
```
...
PASS
ok      github.com/plantonhq/planton/apis/dev/planton/provider/aws/awsec2instance/v1    0.384s
```
...
3. **Enhance Test Coverage (Optional)**
   - **File:** `apis/dev/planton/provider/aws/awsec2instance/v1/spec_test.go`
