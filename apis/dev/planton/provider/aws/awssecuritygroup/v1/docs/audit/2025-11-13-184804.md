...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awssecuritygroup/v1/`  
**Enum Value:** 215  
**ID Prefix:** awssg
...
- Folder exists: `apis/dev/planton/provider/aws/awssecuritygroup/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awssecuritygroup/v1/
go test -v
```
...
- **Planton's Approach:** Design philosophy and comparison to raw IaC
...
**Path to reference:** `apis/dev/planton/provider/aws/awsvpc/v1/`
