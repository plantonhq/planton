...
const file_dev_planton_provider_aws_awssnstopic_v1_spec_proto_rawDesc = "" +
	"\n" +
	"2dev/planton/provider/aws/awssnstopic/v1/spec.proto\x12'dev.planton.provider.aws.awssnstopic.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xe6\n" +
	"\n" +
	...
	"\rsubscriptions\x18\v \x03(\v2@.dev.planton.provider.aws.awssnstopic.v1.AwsSnsTopicSubscriptionR\rsubscriptions:\xf2\x05\xbaH\xee\x05\x1a\xbb\x01\n" +
	...
	"\bendpoint\x18\x03 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x06\xbaH\x03\xc8\x01\x01R\bendpoint\x12<\n" +
	...
	"\x0eredrive_config\x18\a \x01(\v2H.dev.planton.provider.aws.awssnstopic.v1.AwsSnsSubscriptionRedriveConfigR\rredriveConfig\x12\x88\x01\n" +
	"\x15subscription_role_arn\x18\b \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xd0\x01\x92\xd4a\x17status.outputs.role_arnR\x13subscriptionRoleArn:\x83\x06\xbaH\xff\x05\x1a\xe0\x01\n" +
	...
	"\x16dead_letter_target_arn\x18\x01 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB'\xbaH\x03\xc8\x01\x01\x88\xd4a\xe1\x01\x92\xd4a\x18status.outputs.queue_arnR\x13deadLetterTargetArnB\xd4\x02\n" +
...
var file_dev_planton_provider_aws_awssnstopic_v1_spec_proto_goTypes = []any{
	...
	(*AwsSnsTopicSubscription)(nil),         // 1: dev.planton.provider.aws.awssnstopic.v1.AwsSnsTopicSubscription
	(*AwsSnsSubscriptionRedriveConfig)(nil), // 2: dev.planton.provider.aws.awssnstopic.v1.AwsSnsSubscriptionRedriveConfig
...
var file_dev_planton_provider_aws_awssnstopic_v1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awssnstopic.v1.AwsSnsTopicSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 1: dev.planton.provider.aws.awssnstopic.v1.AwsSnsTopicSpec.policy:type_name -> google.protobuf.Struct
	1, // 2: dev.planton.provider.aws.awssnstopic.v1.AwsSnsTopicSpec.subscriptions:type_name -> dev.planton.provider.aws.awssnstopic.v1.AwsSnsTopicSubscription
	3, // 3: dev.planton.provider.aws.awssnstopic.v1.AwsSnsTopicSubscription.endpoint:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 4: dev.planton.provider.aws.awssnstopic.v1.AwsSnsTopicSubscription.filter_policy:type_name -> google.protobuf.Struct
	2, // 5: dev.planton.provider.aws.awssnstopic.v1.AwsSnsTopicSubscription.redrive_config:type_name -> dev.planton.provider.aws.awssnstopic.v1.AwsSnsSubscriptionRedriveConfig
	3, // 6: dev.planton.provider.aws.awssnstopic.v1.AwsSnsTopicSubscription.subscription_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 7: dev.planton.provider.aws.awssnstopic.v1.AwsSnsSubscriptionRedriveConfig.dead_letter_target_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
