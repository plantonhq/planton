...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awsclientvpn/v1/`  
**Enum Value:** 221  
**ID Prefix:** awsvpn
...
- Folder exists under correct provider hierarchy: `apis/dev/planton/provider/aws/awsclientvpn/`
...
**Other components should reference:** `apis/dev/planton/provider/aws/awsclientvpn/v1/`
