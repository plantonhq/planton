...
func (x *AwsTransitGatewayVpcAttachment) Reset() {
	*x = AwsTransitGatewayVpcAttachment{}
	mi := &file_dev_planton_provider_aws_awstransitgateway_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsTransitGatewayVpcAttachment) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awstransitgateway_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
const file_dev_planton_provider_aws_awstransitgateway_v1_spec_proto_rawDesc = "" +
	"\n" +
	"8dev/planton/provider/aws/awstransitgateway/v1/spec.proto\x12-dev.planton.provider.aws.awstransitgateway.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xdd\t\n" +
	...
	"\x0fvpc_attachments\x18\f \x03(\v2M.dev.planton.provider.aws.awstransitgateway.v1.AwsTransitGatewayVpcAttachmentB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01R\x0evpcAttachments:\xc8\x03\xbaH\xc4\x03\x1a\x91\x01\n" +
	...
	"\x06vpc_id\x18\x02 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB$\xbaH\x03\xc8\x01\x01\x88\xd4a\xd8\x01\x92\xd4a\x15status.outputs.vpc_idR\x05vpcId\x12\x7f\n" +
	"\n" +
	"subnet_ids\x18\x03 \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB,\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01\x88\xd4a\x9c\x02\x92\xd4a\x18status.outputs.subnet_idR\tsubnetIds\x12)\n" +
...
var file_dev_planton_provider_aws_awstransitgateway_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_aws_awstransitgateway_v1_spec_proto_goTypes = []any{
	...
	(*AwsTransitGatewayVpcAttachment)(nil), // 1: dev.planton.provider.aws.awstransitgateway.v1.AwsTransitGatewayVpcAttachment
...
var file_dev_planton_provider_aws_awstransitgateway_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.aws.awstransitgateway.v1.AwsTransitGatewaySpec.vpc_attachments:type_name -> dev.planton.provider.aws.awstransitgateway.v1.AwsTransitGatewayVpcAttachment
	2, // 1: dev.planton.provider.aws.awstransitgateway.v1.AwsTransitGatewayVpcAttachment.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.provider.aws.awstransitgateway.v1.AwsTransitGatewayVpcAttachment.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
