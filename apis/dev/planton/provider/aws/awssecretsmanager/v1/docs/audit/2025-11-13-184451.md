...
**Provider:** aws  
**Component Path:** `apis/dev/planton/provider/aws/awssecretsmanager/v1/`  
**Enum Value:** 214  
**ID Prefix:** awssm
...
- Folder exists: `apis/dev/planton/provider/aws/awssecretsmanager/v1/`
...
```bash
cd apis/dev/planton/provider/aws/awssecretsmanager/v1/
go test -v
```
...
- Explains 80/20 scoping decisions explicitly in "The Planton Choice" section
...
**Path to reference:** `apis/dev/planton/provider/gcp/gcpsecretsmanager/v1/`
