...
// 	protoc        (unknown)
// source: dev/planton/provider/confluent/confluentkafka/v1/spec.proto
...
func (x *ConfluentKafkaSpec) Reset() {
	*x = ConfluentKafkaSpec{}
	mi := &file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_msgTypes[0]
...
func (*ConfluentKafkaSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *ConfluentKafkaDedicatedConfig) Reset() {
	*x = ConfluentKafkaDedicatedConfig{}
	mi := &file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConfluentKafkaDedicatedConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *ConfluentKafkaNetworkConfig) Reset() {
	*x = ConfluentKafkaNetworkConfig{}
	mi := &file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConfluentKafkaNetworkConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_confluent_confluentkafka_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDesc = "" +
	"\n" +
	";dev/planton/provider/confluent/confluentkafka/v1/spec.proto\x120dev.planton.provider.confluent.confluentkafka.v1\x1a\x1bbuf/validate/validate.proto\"\xd8\x04\n" +
	...
	"\x10dedicated_config\x18\x06 \x01(\v2O.dev.planton.provider.confluent.confluentkafka.v1.ConfluentKafkaDedicatedConfigR\x0fdedicatedConfig\x12t\n" +
	"\x0enetwork_config\x18\a \x01(\v2M.dev.planton.provider.confluent.confluentkafka.v1.ConfluentKafkaNetworkConfigR\rnetworkConfig\x12!\n" +
	...
	"4com.dev.planton.provider.confluent.confluentkafka.v1B\tSpecProtoP\x01Zcgithub.com/plantonhq/planton/apis/dev/planton/provider/confluent/confluentkafka/v1;confluentkafkav1\xa2\x02\x05DPPCC\xaa\x020Dev.Planton.Provider.Confluent.Confluentkafka.V1\xca\x020Dev\\Planton\\Provider\\Confluent\\Confluentkafka\\V1\xe2\x02<Dev\\Planton\\Provider\\Confluent\\Confluentkafka\\V1\\GPBMetadata\xea\x025Dev::Planton::Provider::Confluent::Confluentkafka::V1b\x06proto3"

var (
	file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDesc), len(file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_goTypes = []any{
	(*ConfluentKafkaSpec)(nil),            // 0: dev.planton.provider.confluent.confluentkafka.v1.ConfluentKafkaSpec
	(*ConfluentKafkaDedicatedConfig)(nil), // 1: dev.planton.provider.confluent.confluentkafka.v1.ConfluentKafkaDedicatedConfig
	(*ConfluentKafkaNetworkConfig)(nil),   // 2: dev.planton.provider.confluent.confluentkafka.v1.ConfluentKafkaNetworkConfig
}
var file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.confluent.confluentkafka.v1.ConfluentKafkaSpec.dedicated_config:type_name -> dev.planton.provider.confluent.confluentkafka.v1.ConfluentKafkaDedicatedConfig
	2, // 1: dev.planton.provider.confluent.confluentkafka.v1.ConfluentKafkaSpec.network_config:type_name -> dev.planton.provider.confluent.confluentkafka.v1.ConfluentKafkaNetworkConfig
...
func init() { file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_init() }
func file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_init() {
	if File_dev_planton_provider_confluent_confluentkafka_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDesc), len(file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_confluent_confluentkafka_v1_spec_proto = out.File
	file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_confluent_confluentkafka_v1_spec_proto_depIdxs = nil
}
