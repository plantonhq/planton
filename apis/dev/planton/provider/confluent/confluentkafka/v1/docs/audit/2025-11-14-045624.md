...
**Provider:** confluent  
**Component Path:** `apis/dev/planton/provider/confluent/confluentkafka/v1/`  
**Enum Value:** 50  
**ID Prefix:** conkaf
...
1. **Add content to examples.md**
   ...
   - **File:** `apis/dev/planton/provider/confluent/confluentkafka/v1/examples.md`
...
2. **Create Terraform README.md**
   ...
   - **File:** `apis/dev/planton/provider/confluent/confluentkafka/v1/iac/tf/README.md`
...
3. **Add manifest.yaml helper file**
   ...
   - **File:** `apis/dev/planton/provider/confluent/confluentkafka/v1/iac/hack/manifest.yaml`
...
1. **Terraform Implementation is Incomplete**
   ...
   - **File:** `apis/dev/planton/provider/confluent/confluentkafka/v1/iac/tf/`
...
2. **No Terraform examples.md**
   ...
   - **File:** `apis/dev/planton/provider/confluent/confluentkafka/v1/iac/tf/examples.md`
...
- Folder exists: `apis/dev/planton/provider/confluent/confluentkafka/v1/`
...
```bash
cd apis/dev/planton/provider/confluent/confluentkafka/v1/
go test -v
```
...
**Path to reference:** `apis/dev/planton/provider/atlas/mongodbatlas/v1/`
