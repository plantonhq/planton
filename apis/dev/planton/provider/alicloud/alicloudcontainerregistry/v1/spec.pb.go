...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudcontainerregistry/v1/spec.proto
...
func (x *AliCloudContainerRegistrySpec) Reset() {
	*x = AliCloudContainerRegistrySpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_msgTypes[0]
...
func (*AliCloudContainerRegistrySpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudContainerRegistryNamespace) Reset() {
	*x = AliCloudContainerRegistryNamespace{}
	mi := &file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudContainerRegistryNamespace) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Edev/planton/provider/alicloud/alicloudcontainerregistry/v1/spec.proto\x12:dev.planton.provider.alicloud.alicloudcontainerregistry.v1\x1a\x1bbuf/validate/validate.proto\x1a(dev/planton/shared/options/options.proto\"\xdb\x05\n" +
	...
	"\n" +
	"namespaces\x18\b \x03(\v2^.dev.planton.provider.alicloud.alicloudcontainerregistry.v1.AliCloudContainerRegistryNamespaceR\n" +
	"namespacesB\x0f\n" +
	...
	">com.dev.planton.provider.alicloud.alicloudcontainerregistry.v1B\tSpecProtoP\x01Zxgithub.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudcontainerregistry/v1;alicloudcontainerregistryv1\xa2\x02\x05DPPAA\xaa\x02:Dev.Planton.Provider.Alicloud.Alicloudcontainerregistry.V1\xca\x02:Dev\\Planton\\Provider\\Alicloud\\Alicloudcontainerregistry\\V1\xe2\x02FDev\\Planton\\Provider\\Alicloud\\Alicloudcontainerregistry\\V1\\GPBMetadata\xea\x02?Dev::Planton::Provider::Alicloud::Alicloudcontainerregistry::V1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_goTypes = []any{
	(*AliCloudContainerRegistrySpec)(nil),      // 0: dev.planton.provider.alicloud.alicloudcontainerregistry.v1.AliCloudContainerRegistrySpec
	(*AliCloudContainerRegistryNamespace)(nil), // 1: dev.planton.provider.alicloud.alicloudcontainerregistry.v1.AliCloudContainerRegistryNamespace
}
var file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.alicloud.alicloudcontainerregistry.v1.AliCloudContainerRegistrySpec.namespaces:type_name -> dev.planton.provider.alicloud.alicloudcontainerregistry.v1.AliCloudContainerRegistryNamespace
...
func init() { file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudcontainerregistry_v1_spec_proto_depIdxs = nil
}
