...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudcdndomain/v1/spec.proto
...
func (x *AliCloudCdnDomainSpec) Reset() {
	*x = AliCloudCdnDomainSpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_msgTypes[0]
...
func (*AliCloudCdnDomainSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudCdnDomainSource) Reset() {
	*x = AliCloudCdnDomainSource{}
	mi := &file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudCdnDomainSource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudCdnDomainCertificateConfig) Reset() {
	*x = AliCloudCdnDomainCertificateConfig{}
	mi := &file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudCdnDomainCertificateConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDesc = "" +
	"\n" +
	"=dev/planton/provider/alicloud/alicloudcdndomain/v1/spec.proto\x122dev.planton.provider.alicloud.alicloudcdndomain.v1\x1a\x1bbuf/validate/validate.proto\x1a(dev/planton/shared/options/options.proto\"\xf2\x06\n" +
	...
	"\asources\x18\x05 \x03(\v2K.dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainSourceB\b\xbaH\x05\x92\x01\x02\b\x01R\asources\x12\x85\x01\n" +
	"\x12certificate_config\x18\x06 \x01(\v2V.dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainCertificateConfigR\x11certificateConfig\x12\x1b\n" +
	"\tcheck_url\x18\a \x01(\tR\bcheckUrl\x12*\n" +
	"\x11resource_group_id\x18\b \x01(\tR\x0fresourceGroupId\x12g\n" +
	"\x04tags\x18\t \x03(\v2S.dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
...
var (
	file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_goTypes = []any{
	(*AliCloudCdnDomainSpec)(nil),              // 0: dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainSpec
	(*AliCloudCdnDomainSource)(nil),            // 1: dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainSource
	(*AliCloudCdnDomainCertificateConfig)(nil), // 2: dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainCertificateConfig
	nil, // 3: dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainSpec.TagsEntry
}
var file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainSpec.sources:type_name -> dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainSource
	2, // 1: dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainSpec.certificate_config:type_name -> dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainCertificateConfig
	3, // 2: dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainSpec.tags:type_name -> dev.planton.provider.alicloud.alicloudcdndomain.v1.AliCloudCdnDomainSpec.TagsEntry
...
func init() { file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudcdndomain_v1_spec_proto_depIdxs = nil
}
