...
**Provider:** atlas  
**Component Path:** `apis/org/openmcf/provider/atlas/atlasmongodb/v1/`  
**Enum Value:** 51  
**ID Prefix:** mdbatl
...
- Folder exists under correct provider hierarchy: `apis/org/openmcf/provider/atlas/atlasmongodb/`
