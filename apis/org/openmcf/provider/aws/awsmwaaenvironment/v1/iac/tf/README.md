...
Terraform module for provisioning AWS MWAA (Managed Workflows for Apache Airflow) environments using the OpenMCF `AwsMwaaEnvironmentSpec`.
...
cd apis/org/openmcf/provider/aws/awsmwaaenvironment/v1/iac/tf
