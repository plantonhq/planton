...
This Pulumi module provisions an Amazon FSx for Windows File Server file system using the OpenMCF CLI. Use the hack manifest at `../hack/manifest.yaml` as a quick starting point.
