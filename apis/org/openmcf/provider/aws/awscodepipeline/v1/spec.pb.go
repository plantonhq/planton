...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awscodepipeline/v1/spec.proto
...
func (x *AwsCodePipelineSpec) Reset() {
	*x = AwsCodePipelineSpec{}
	mi := &file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes[0]
...
func (x *AwsCodePipelineArtifactStore) Reset() {
	*x = AwsCodePipelineArtifactStore{}
	mi := &file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineArtifactStore) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsCodePipelineStage) Reset() {
	*x = AwsCodePipelineStage{}
	mi := &file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineStage) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsCodePipelineAction) Reset() {
	*x = AwsCodePipelineAction{}
	mi := &file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineAction) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsCodePipelineTrigger) Reset() {
	*x = AwsCodePipelineTrigger{}
	mi := &file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineTrigger) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsCodePipelineGitConfiguration) Reset() {
	*x = AwsCodePipelineGitConfiguration{}
	mi := &file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineGitConfiguration) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsCodePipelineGitPush) Reset() {
	*x = AwsCodePipelineGitPush{}
	mi := &file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineGitPush) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsCodePipelineGitPullRequest) Reset() {
	*x = AwsCodePipelineGitPullRequest{}
	mi := &file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineGitPullRequest) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *AwsCodePipelineGitFilter) Reset() {
	*x = AwsCodePipelineGitFilter{}
	mi := &file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineGitFilter) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *AwsCodePipelineVariable) Reset() {
	*x = AwsCodePipelineVariable{}
	mi := &file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineVariable) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescGZIP(), []int{9}
}
...
var File_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDesc = "" +
	...
	"\aactions\x18\x02 \x03(\v2B.org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineActionB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01R\aactions\"\xcf\x06\n" +
	...
	"\rconfiguration\x18\x06 \x03(\v2U.org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineAction.ConfigurationEntryR\rconfiguration\x12'\n" +
	...
	"\brole_arn\x18\v \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xd0\x01\x92\xd4a\x17status.outputs.role_arnR\aroleArn\x12*\n" +
	...
	"\x11git_configuration\x18\x02 \x01(\v2L.org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitConfigurationB\x06\xbaH\x03\xc8\x01\x01R\x10gitConfiguration\"\xb9\x02\n" +
	...
	"\x04push\x18\x02 \x03(\v2C.org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitPushB\b\xbaH\x05\x92\x01\x02\x10\x03R\x04push\x12w\n" +
	"\fpull_request\x18\x03 \x03(\v2J.org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitPullRequestB\b\xbaH\x05\x92\x01\x02\x10\x03R\vpullRequest\"\xbc\x02\n" +
	"\x16AwsCodePipelineGitPush\x12a\n" +
	"\bbranches\x18\x01 \x01(\v2E.org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitFilterR\bbranches\x12d\n" +
	"\n" +
	"file_paths\x18\x02 \x01(\v2E.org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitFilterR\tfilePaths\x12Y\n" +
	"\x04tags\x18\x03 \x01(\v2E.org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitFilterR\x04tags\"\x80\x02\n" +
	"\x1dAwsCodePipelineGitPullRequest\x12a\n" +
	"\bbranches\x18\x01 \x01(\v2E.org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitFilterR\bbranches\x12d\n" +
	"\n" +
	"file_paths\x18\x02 \x01(\v2E.org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitFilterR\tfilePaths\x12\x16\n" +
	...
	"/com.org.openmcf.provider.aws.awscodepipeline.v1B\tSpecProtoP\x01Z_github.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awscodepipeline/v1;awscodepipelinev1\xa2\x02\x05OOPAA\xaa\x02+Org.Openmcf.Provider.Aws.Awscodepipeline.V1\xca\x02+Org\\Openmcf\\Provider\\Aws\\Awscodepipeline\\V1\xe2\x027Org\\Openmcf\\Provider\\Aws\\Awscodepipeline\\V1\\GPBMetadata\xea\x020Org::Openmcf::Provider::Aws::Awscodepipeline::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_goTypes = []any{
	(*AwsCodePipelineSpec)(nil),             // 0: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineSpec
	(*AwsCodePipelineArtifactStore)(nil),    // 1: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineArtifactStore
	(*AwsCodePipelineStage)(nil),            // 2: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineStage
	(*AwsCodePipelineAction)(nil),           // 3: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineAction
	(*AwsCodePipelineTrigger)(nil),          // 4: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineTrigger
	(*AwsCodePipelineGitConfiguration)(nil), // 5: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitConfiguration
	(*AwsCodePipelineGitPush)(nil),          // 6: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitPush
	(*AwsCodePipelineGitPullRequest)(nil),   // 7: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitPullRequest
	(*AwsCodePipelineGitFilter)(nil),        // 8: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitFilter
	(*AwsCodePipelineVariable)(nil),         // 9: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineVariable
	nil,                                     // 10: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineAction.ConfigurationEntry
	(*v1.StringValueOrRef)(nil),             // 11: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_depIdxs = []int32{
	11, // 0: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineSpec.role_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineSpec.artifact_stores:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineArtifactStore
	2,  // 2: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineSpec.stages:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineStage
	4,  // 3: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineSpec.triggers:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineTrigger
	9,  // 4: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineSpec.variables:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineVariable
	11, // 5: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineArtifactStore.location:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	11, // 6: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineArtifactStore.encryption_key_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3,  // 7: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineStage.actions:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineAction
	10, // 8: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineAction.configuration:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineAction.ConfigurationEntry
	11, // 9: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineAction.role_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	5,  // 10: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineTrigger.git_configuration:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitConfiguration
	6,  // 11: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitConfiguration.push:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitPush
	7,  // 12: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitConfiguration.pull_request:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitPullRequest
	8,  // 13: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitPush.branches:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitFilter
	8,  // 14: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitPush.file_paths:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitFilter
	8,  // 15: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitPush.tags:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitFilter
	8,  // 16: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitPullRequest.branches:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitFilter
	8,  // 17: org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitPullRequest.file_paths:type_name -> org.openmcf.provider.aws.awscodepipeline.v1.AwsCodePipelineGitFilter
...
func init() { file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awscodepipeline_v1_spec_proto_depIdxs = nil
}
