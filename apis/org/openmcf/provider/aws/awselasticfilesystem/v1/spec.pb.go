...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awselasticfilesystem/v1/spec.proto
...
func (x *AwsElasticFileSystemSpec) Reset() {
	*x = AwsElasticFileSystemSpec{}
	mi := &file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_msgTypes[0]
...
func (x *AwsElasticFileSystemAccessPoint) Reset() {
	*x = AwsElasticFileSystemAccessPoint{}
	mi := &file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsElasticFileSystemAccessPoint) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsElasticFileSystemAccessPointPosixUser) Reset() {
	*x = AwsElasticFileSystemAccessPointPosixUser{}
	mi := &file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsElasticFileSystemAccessPointPosixUser) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsElasticFileSystemAccessPointRootDirectory) Reset() {
	*x = AwsElasticFileSystemAccessPointRootDirectory{}
	mi := &file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsElasticFileSystemAccessPointRootDirectory) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsElasticFileSystemAccessPointCreationInfo) Reset() {
	*x = AwsElasticFileSystemAccessPointCreationInfo{}
	mi := &file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsElasticFileSystemAccessPointCreationInfo) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDesc = "" +
	...
	"\n" +
	"posix_user\x18\x02 \x01(\v2Z.org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPointPosixUserR\tposixUser\x12\x85\x01\n" +
	"\x0eroot_directory\x18\x03 \x01(\v2^.org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPointRootDirectoryR\rrootDirectory\"\x85\x01\n" +
	...
	"\rcreation_info\x18\x02 \x01(\v2].org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPointCreationInfoR\fcreationInfo\"\xb0\x01\n" +
	...
	"4com.org.openmcf.provider.aws.awselasticfilesystem.v1B\tSpecProtoP\x01Zigithub.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awselasticfilesystem/v1;awselasticfilesystemv1\xa2\x02\x05OOPAA\xaa\x020Org.Openmcf.Provider.Aws.Awselasticfilesystem.V1\xca\x020Org\\Openmcf\\Provider\\Aws\\Awselasticfilesystem\\V1\xe2\x02<Org\\Openmcf\\Provider\\Aws\\Awselasticfilesystem\\V1\\GPBMetadata\xea\x025Org::Openmcf::Provider::Aws::Awselasticfilesystem::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_goTypes = []any{
	(*AwsElasticFileSystemSpec)(nil),                     // 0: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemSpec
	(*AwsElasticFileSystemAccessPoint)(nil),              // 1: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPoint
	(*AwsElasticFileSystemAccessPointPosixUser)(nil),     // 2: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPointPosixUser
	(*AwsElasticFileSystemAccessPointRootDirectory)(nil), // 3: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPointRootDirectory
	(*AwsElasticFileSystemAccessPointCreationInfo)(nil),  // 4: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPointCreationInfo
	(*v1.StringValueOrRef)(nil),                          // 5: org.openmcf.shared.foreignkey.v1.StringValueOrRef
	(*structpb.Struct)(nil),                              // 6: google.protobuf.Struct
}
var file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_depIdxs = []int32{
	5, // 0: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemSpec.kms_key_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	5, // 1: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemSpec.subnet_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	5, // 2: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemSpec.security_group_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 3: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemSpec.access_points:type_name -> org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPoint
	6, // 4: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemSpec.policy:type_name -> google.protobuf.Struct
	2, // 5: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPoint.posix_user:type_name -> org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPointPosixUser
	3, // 6: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPoint.root_directory:type_name -> org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPointRootDirectory
	4, // 7: org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPointRootDirectory.creation_info:type_name -> org.openmcf.provider.aws.awselasticfilesystem.v1.AwsElasticFileSystemAccessPointCreationInfo
...
func init() { file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awselasticfilesystem_v1_spec_proto_depIdxs = nil
}
