...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awssagemakerdomain/v1/spec.proto
...
func (x *AwsSagemakerDomainSpec) Reset() {
	*x = AwsSagemakerDomainSpec{}
	mi := &file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[0]
...
func (x *AwsSagemakerDomainDefaultUserSettings) Reset() {
	*x = AwsSagemakerDomainDefaultUserSettings{}
	mi := &file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSagemakerDomainDefaultUserSettings) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsSagemakerDomainJupyterLabAppSettings) Reset() {
	*x = AwsSagemakerDomainJupyterLabAppSettings{}
	mi := &file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSagemakerDomainJupyterLabAppSettings) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsSagemakerDomainKernelGatewayAppSettings) Reset() {
	*x = AwsSagemakerDomainKernelGatewayAppSettings{}
	mi := &file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSagemakerDomainKernelGatewayAppSettings) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsSagemakerDomainResourceSpec) Reset() {
	*x = AwsSagemakerDomainResourceSpec{}
	mi := &file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSagemakerDomainResourceSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsSagemakerDomainCustomImage) Reset() {
	*x = AwsSagemakerDomainCustomImage{}
	mi := &file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSagemakerDomainCustomImage) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsSagemakerDomainCodeRepository) Reset() {
	*x = AwsSagemakerDomainCodeRepository{}
	mi := &file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSagemakerDomainCodeRepository) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsSagemakerDomainIdleSettings) Reset() {
	*x = AwsSagemakerDomainIdleSettings{}
	mi := &file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSagemakerDomainIdleSettings) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *AwsSagemakerDomainSharingSettings) Reset() {
	*x = AwsSagemakerDomainSharingSettings{}
	mi := &file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSagemakerDomainSharingSettings) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *AwsSagemakerDomainSpaceStorageSettings) Reset() {
	*x = AwsSagemakerDomainSpaceStorageSettings{}
	mi := &file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSagemakerDomainSpaceStorageSettings) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *AwsSagemakerDomainDockerSettings) Reset() {
	*x = AwsSagemakerDomainDockerSettings{}
	mi := &file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSagemakerDomainDockerSettings) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescGZIP(), []int{10}
}
...
var File_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDesc = "" +
	...
	"\x12execution_role_arn\x18\x01 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB&\xbaH\x03\xc8\x01\x01\x88\xd4a\xd0\x01\x92\xd4a\x17status.outputs.role_arnR\x10executionRoleArn\x12\x93\x01\n" +
	"\x12security_group_ids\x18\x02 \x03(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB1\xbaH\x05\x92\x01\x02\x10\x05\x88\xd4a\xd7\x01\x92\xd4a status.outputs.security_group_idR\x10securityGroupIds\x12.\n" +
	...
	"\x18jupyter_lab_app_settings\x18\x05 \x01(\v2W.org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainJupyterLabAppSettingsR\x15jupyterLabAppSettings\x12\x99\x01\n" +
	"\x1bkernel_gateway_app_settings\x18\x06 \x01(\v2Z.org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainKernelGatewayAppSettingsR\x18kernelGatewayAppSettings\x12|\n" +
	"\x10sharing_settings\x18\a \x01(\v2Q.org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSharingSettingsR\x0fsharingSettings\x12\x8c\x01\n" +
	"\x16space_storage_settings\x18\b \x01(\v2V.org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSpaceStorageSettingsR\x14spaceStorageSettings:\xa6\x01\xbaH\xa2\x01\x1a\x9f\x01\n" +
	...
	"\x15default_resource_spec\x18\x01 \x01(\v2N.org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainResourceSpecR\x13defaultResourceSpec\x122\n" +
	"\x15lifecycle_config_arns\x18\x02 \x03(\tR\x13lifecycleConfigArns\x12}\n" +
	"\rcustom_images\x18\x03 \x03(\v2M.org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainCustomImageB\t\xbaH\x06\x92\x01\x03\x10\xc8\x01R\fcustomImages\x12\x87\x01\n" +
	"\x11code_repositories\x18\x04 \x03(\v2P.org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainCodeRepositoryB\b\xbaH\x05\x92\x01\x02\x10\n" +
	"R\x10codeRepositories\x12s\n" +
	"\ridle_settings\x18\x05 \x01(\v2N.org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainIdleSettingsR\fidleSettings\"\xe4\x02\n" +
	"*AwsSagemakerDomainKernelGatewayAppSettings\x12\x82\x01\n" +
	"\x15default_resource_spec\x18\x01 \x01(\v2N.org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainResourceSpecR\x13defaultResourceSpec\x122\n" +
	"\x15lifecycle_config_arns\x18\x02 \x03(\tR\x13lifecycleConfigArns\x12}\n" +
	"\rcustom_images\x18\x03 \x03(\v2M.org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainCustomImageB\t\xbaH\x06\x92\x01\x03\x10\xc8\x01R\fcustomImages\"\xa9\x02\n" +
	...
	"\rs3_kms_key_id\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\x1f\x88\xd4a\xdb\x01\x92\xd4a\x16status.outputs.key_arnR\n" +
	"s3KmsKeyId\x12$\n" +
	...
	"2com.org.openmcf.provider.aws.awssagemakerdomain.v1B\tSpecProtoP\x01Zegithub.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awssagemakerdomain/v1;awssagemakerdomainv1\xa2\x02\x05OOPAA\xaa\x02.Org.Openmcf.Provider.Aws.Awssagemakerdomain.V1\xca\x02.Org\\Openmcf\\Provider\\Aws\\Awssagemakerdomain\\V1\xe2\x02:Org\\Openmcf\\Provider\\Aws\\Awssagemakerdomain\\V1\\GPBMetadata\xea\x023Org::Openmcf::Provider::Aws::Awssagemakerdomain::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_goTypes = []any{
	(*AwsSagemakerDomainSpec)(nil),                     // 0: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSpec
	(*AwsSagemakerDomainDefaultUserSettings)(nil),      // 1: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainDefaultUserSettings
	(*AwsSagemakerDomainJupyterLabAppSettings)(nil),    // 2: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainJupyterLabAppSettings
	(*AwsSagemakerDomainKernelGatewayAppSettings)(nil), // 3: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainKernelGatewayAppSettings
	(*AwsSagemakerDomainResourceSpec)(nil),             // 4: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainResourceSpec
	(*AwsSagemakerDomainCustomImage)(nil),              // 5: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainCustomImage
	(*AwsSagemakerDomainCodeRepository)(nil),           // 6: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainCodeRepository
	(*AwsSagemakerDomainIdleSettings)(nil),             // 7: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainIdleSettings
	(*AwsSagemakerDomainSharingSettings)(nil),          // 8: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSharingSettings
	(*AwsSagemakerDomainSpaceStorageSettings)(nil),     // 9: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSpaceStorageSettings
	(*AwsSagemakerDomainDockerSettings)(nil),           // 10: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainDockerSettings
	(*v1.StringValueOrRef)(nil),                        // 11: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_depIdxs = []int32{
	11, // 0: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSpec.vpc_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	11, // 1: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSpec.subnet_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	11, // 2: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSpec.kms_key_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1,  // 3: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSpec.default_user_settings:type_name -> org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainDefaultUserSettings
	11, // 4: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSpec.domain_security_group_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	10, // 5: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSpec.docker_settings:type_name -> org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainDockerSettings
	11, // 6: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainDefaultUserSettings.execution_role_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	11, // 7: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainDefaultUserSettings.security_group_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2,  // 8: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainDefaultUserSettings.jupyter_lab_app_settings:type_name -> org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainJupyterLabAppSettings
	3,  // 9: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainDefaultUserSettings.kernel_gateway_app_settings:type_name -> org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainKernelGatewayAppSettings
	8,  // 10: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainDefaultUserSettings.sharing_settings:type_name -> org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSharingSettings
	9,  // 11: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainDefaultUserSettings.space_storage_settings:type_name -> org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSpaceStorageSettings
	4,  // 12: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainJupyterLabAppSettings.default_resource_spec:type_name -> org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainResourceSpec
	5,  // 13: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainJupyterLabAppSettings.custom_images:type_name -> org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainCustomImage
	6,  // 14: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainJupyterLabAppSettings.code_repositories:type_name -> org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainCodeRepository
	7,  // 15: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainJupyterLabAppSettings.idle_settings:type_name -> org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainIdleSettings
	4,  // 16: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainKernelGatewayAppSettings.default_resource_spec:type_name -> org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainResourceSpec
	5,  // 17: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainKernelGatewayAppSettings.custom_images:type_name -> org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainCustomImage
	11, // 18: org.openmcf.provider.aws.awssagemakerdomain.v1.AwsSagemakerDomainSharingSettings.s3_kms_key_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes[8].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awssagemakerdomain_v1_spec_proto_depIdxs = nil
}
