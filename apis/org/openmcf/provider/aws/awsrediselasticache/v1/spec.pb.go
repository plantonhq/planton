...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awsrediselasticache/v1/spec.proto
...
func (x *AwsRedisElasticacheSpec) Reset() {
	*x = AwsRedisElasticacheSpec{}
	mi := &file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_msgTypes[0]
...
func (x *AwsRedisElasticacheParameter) Reset() {
	*x = AwsRedisElasticacheParameter{}
	mi := &file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRedisElasticacheParameter) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsRedisElasticacheLogDeliveryConfig) Reset() {
	*x = AwsRedisElasticacheLogDeliveryConfig{}
	mi := &file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRedisElasticacheLogDeliveryConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDesc = "" +
	"\n" +
	":org/openmcf/provider/aws/awsrediselasticache/v1/spec.proto\x12/org.openmcf.provider.aws.awsrediselasticache.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xa9\"\n" +
	...
	"\n" +
	"subnet_ids\x18\f \x03(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB!\x88\xd4a\x9c\x02\x92\xd4a\x18status.outputs.subnet_idR\tsubnetIds\x12\x8b\x01\n" +
	...
	"\vdestination\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\x06\xbaH\x03\xc8\x01\x01R\vdestination\x12%\n" +
	"\n" +
	...
	"3com.org.openmcf.provider.aws.awsrediselasticache.v1B\tSpecProtoP\x01Zggithub.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awsrediselasticache/v1;awsrediselasticachev1\xa2\x02\x05OOPAA\xaa\x02/Org.Openmcf.Provider.Aws.Awsrediselasticache.V1\xca\x02/Org\\Openmcf\\Provider\\Aws\\Awsrediselasticache\\V1\xe2\x02;Org\\Openmcf\\Provider\\Aws\\Awsrediselasticache\\V1\\GPBMetadata\xea\x024Org::Openmcf::Provider::Aws::Awsrediselasticache::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_goTypes = []any{
	(*AwsRedisElasticacheSpec)(nil),              // 0: org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheSpec
	(*AwsRedisElasticacheParameter)(nil),         // 1: org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheParameter
	(*AwsRedisElasticacheLogDeliveryConfig)(nil), // 2: org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheLogDeliveryConfig
	(*v1.StringValueOrRef)(nil),                  // 3: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_depIdxs = []int32{
	3, // 0: org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheSpec.subnet_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 1: org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheSpec.security_group_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 2: org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheSpec.kms_key_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 3: org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheSpec.auth_token:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 4: org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheSpec.parameters:type_name -> org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheParameter
	2, // 5: org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheSpec.log_delivery_configurations:type_name -> org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheLogDeliveryConfig
	3, // 6: org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheSpec.notification_topic_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 7: org.openmcf.provider.aws.awsrediselasticache.v1.AwsRedisElasticacheLogDeliveryConfig.destination:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awsrediselasticache_v1_spec_proto_depIdxs = nil
}
