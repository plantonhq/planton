...
type AwsFsxOpenzfsFileSystemSpec struct {
	...
	ThroughputCapacity int32 `protobuf:"varint,3,opt,name=throughput_capacity,json=throughputCapacity,proto3" json:"throughput_capacity,omitempty"`
	...
	//
	// Ignored for SINGLE_AZ deployments.
	EndpointIpAddressRange string `protobuf:"bytes,7,opt,name=endpoint_ip_address_range,json=endpointIpAddressRange,proto3" json:"endpoint_ip_address_range,omitempty"`
	...
	//
	// Ignored for SINGLE_AZ deployments.
	RouteTableIds []*v1.StringValueOrRef `protobuf:"bytes,8,rep,name=route_table_ids,json=routeTableIds,proto3" json:"route_table_ids,omitempty"`
	...
	DiskIopsConfiguration *AwsFsxOpenzfsFileSystemDiskIopsConfiguration `protobuf:"bytes,10,opt,name=disk_iops_configuration,json=diskIopsConfiguration,proto3" json:"disk_iops_configuration,omitempty"`
	...
	RootVolumeConfiguration *AwsFsxOpenzfsFileSystemRootVolumeConfiguration `protobuf:"bytes,11,opt,name=root_volume_configuration,json=rootVolumeConfiguration,proto3" json:"root_volume_configuration,omitempty"`
	// Number of days to retain automatic backups. Range: 0-90. Set to 0 to
	// disable automatic backups.
	//
	// Default: 0 (no automatic backups)
	AutomaticBackupRetentionDays *int32 `protobuf:"varint,12,opt,name=automatic_backup_retention_days,json=automaticBackupRetentionDays,proto3,oneof" json:"automatic_backup_retention_days,omitempty"`
	...
	DailyAutomaticBackupStartTime string `protobuf:"bytes,13,opt,name=daily_automatic_backup_start_time,json=dailyAutomaticBackupStartTime,proto3" json:"daily_automatic_backup_start_time,omitempty"`
	// Copy tags from the file system to backups.
	CopyTagsToBackups bool `protobuf:"varint,14,opt,name=copy_tags_to_backups,json=copyTagsToBackups,proto3" json:"copy_tags_to_backups,omitempty"`
	...
	CopyTagsToVolumes bool `protobuf:"varint,15,opt,name=copy_tags_to_volumes,json=copyTagsToVolumes,proto3" json:"copy_tags_to_volumes,omitempty"`
...
const file_org_openmcf_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_rawDesc = "" +
	"\n" +
	">org/openmcf/provider/aws/awsfsxopenzfsfilesystem/v1/spec.proto\x123org.openmcf.provider.aws.awsfsxopenzfsfilesystem.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xfd\x12\n" +
	"\x1bAwsFsxOpenzfsFileSystemSpec\x12=\n" +
	"\x0fdeployment_type\x18\x01 \x01(\tB\x0f\x8a\xa6\x1d\vSINGLE_AZ_2H\x00R\x0edeploymentType\x88\x01\x01\x129\n" +
	"\x14storage_capacity_gib\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(@R\x12storageCapacityGib\x128\n" +
	"\x13throughput_capacity\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\x12throughputCapacity\x12\x89\x01\n" +
	"\n" +
	...
	"\x12security_group_ids\x18\x05 \x03(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB)\x88\xd4a\xd7\x01\x92\xd4a status.outputs.security_group_idR\x10securityGroupIds\x12\x92\x01\n" +
	"\x13preferred_subnet_id\x18\x06 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB.\x88\xd4a\xd8\x01\x92\xd4a%status.outputs.private_subnets.[0].idR\x11preferredSubnetId\x129\n" +
	"\x19endpoint_ip_address_range\x18\a \x01(\tR\x16endpointIpAddressRange\x12Z\n" +
	"\x0froute_table_ids\x18\b \x03(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefR\rrouteTableIds\x12q\n" +
	"\n" +
	"kms_key_id\x18\t \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\x1f\x88\xd4a\xdb\x01\x92\xd4a\x16status.outputs.key_arnR\bkmsKeyId\x12\x99\x01\n" +
	"\x17disk_iops_configuration\x18\n" +
	" \x01(\v2a.org.openmcf.provider.aws.awsfsxopenzfsfilesystem.v1.AwsFsxOpenzfsFileSystemDiskIopsConfigurationR\x15diskIopsConfiguration\x12\x9f\x01\n" +
	"\x19root_volume_configuration\x18\v \x01(\v2c.org.openmcf.provider.aws.awsfsxopenzfsfilesystem.v1.AwsFsxOpenzfsFileSystemRootVolumeConfigurationR\x17rootVolumeConfiguration\x12Q\n" +
	"\x1fautomatic_backup_retention_days\x18\f \x01(\x05B\x05\x8a\xa6\x1d\x010H\x01R\x1cautomaticBackupRetentionDays\x88\x01\x01\x12H\n" +
	"!daily_automatic_backup_start_time\x18\r \x01(\tR\x1ddailyAutomaticBackupStartTime\x12/\n" +
	"\x14copy_tags_to_backups\x18\x0e \x01(\bR\x11copyTagsToBackups\x12/\n" +
	"\x14copy_tags_to_volumes\x18\x0f \x01(\bR\x11copyTagsToVolumes\x129\n" +
	"\x11skip_final_backup\x18\x10 \x01(\bB\b\x8a\xa6\x1d\x04trueH\x02R\x0fskipFinalBackup\x88\x01\x01\x12A\n" +
	"\x1dweekly_maintenance_start_time\x18\x11 \x01(\tR\x1aweeklyMaintenanceStartTime:\xe7\x05\xbaH\xe3\x05\x1a\xc2\x01\n" +
