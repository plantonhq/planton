...
This resource is orchestrated by the OpenMCF CLI as part of a stack-update. The CLI validates your manifest, generates stack inputs, and invokes the IaC backend:
