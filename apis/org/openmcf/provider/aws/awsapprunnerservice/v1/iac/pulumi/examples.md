# Examples for AwsAppRunnerService Pulumi Module
...
Pulumi deploy:
```bash
openmcf pulumi update --manifest ./apprunner.yaml --stack my-org/project/dev --module-dir apis/org/openmcf/provider/aws/awsapprunnerservice/v1/iac/pulumi
```
