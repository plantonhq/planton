...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awsapprunnerservice/v1/spec.proto
...
func (x *AwsAppRunnerServiceSpec) Reset() {
	*x = AwsAppRunnerServiceSpec{}
	mi := &file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_msgTypes[0]
...
func (x *AwsAppRunnerServiceImageSource) Reset() {
	*x = AwsAppRunnerServiceImageSource{}
	mi := &file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAppRunnerServiceImageSource) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsAppRunnerServiceCodeSource) Reset() {
	*x = AwsAppRunnerServiceCodeSource{}
	mi := &file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAppRunnerServiceCodeSource) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsAppRunnerServiceHealthCheck) Reset() {
	*x = AwsAppRunnerServiceHealthCheck{}
	mi := &file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAppRunnerServiceHealthCheck) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsAppRunnerServiceAutoScaling) Reset() {
	*x = AwsAppRunnerServiceAutoScaling{}
	mi := &file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAppRunnerServiceAutoScaling) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDesc = "" +
	...
	"\x0faccess_role_arn\x18\x03 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xd0\x01\x92\xd4a\x17status.outputs.role_arnR\raccessRoleArn:\xae\x02\xbaH\xaa\x02\x1a\x87\x01\n" +
	...
	"\x0econnection_arn\x18\x04 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\x06\xbaH\x03\xc8\x01\x01R\rconnectionArn\x12:\n" +
	...
	"3com.org.openmcf.provider.aws.awsapprunnerservice.v1B\tSpecProtoP\x01Zggithub.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awsapprunnerservice/v1;awsapprunnerservicev1\xa2\x02\x05OOPAA\xaa\x02/Org.Openmcf.Provider.Aws.Awsapprunnerservice.V1\xca\x02/Org\\Openmcf\\Provider\\Aws\\Awsapprunnerservice\\V1\xe2\x02;Org\\Openmcf\\Provider\\Aws\\Awsapprunnerservice\\V1\\GPBMetadata\xea\x024Org::Openmcf::Provider::Aws::Awsapprunnerservice::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_goTypes = []any{
	(*AwsAppRunnerServiceSpec)(nil),        // 0: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec
	(*AwsAppRunnerServiceImageSource)(nil), // 1: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceImageSource
	(*AwsAppRunnerServiceCodeSource)(nil),  // 2: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceCodeSource
	(*AwsAppRunnerServiceHealthCheck)(nil), // 3: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceHealthCheck
	(*AwsAppRunnerServiceAutoScaling)(nil), // 4: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceAutoScaling
	nil,                                    // 5: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.EnvironmentVariablesEntry
	nil,                                    // 6: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.EnvironmentSecretsEntry
	(*v1.StringValueOrRef)(nil),            // 7: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_depIdxs = []int32{
	1,  // 0: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.image_source:type_name -> org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceImageSource
	2,  // 1: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.code_source:type_name -> org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceCodeSource
	5,  // 2: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.environment_variables:type_name -> org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.EnvironmentVariablesEntry
	6,  // 3: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.environment_secrets:type_name -> org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.EnvironmentSecretsEntry
	7,  // 4: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.instance_role_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3,  // 5: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.health_check:type_name -> org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceHealthCheck
	4,  // 6: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.auto_scaling:type_name -> org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceAutoScaling
	7,  // 7: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.vpc_connector_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	7,  // 8: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.subnet_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	7,  // 9: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.security_group_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	7,  // 10: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.kms_key_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	7,  // 11: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceSpec.observability_configuration_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	7,  // 12: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceImageSource.access_role_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	7,  // 13: org.openmcf.provider.aws.awsapprunnerservice.v1.AwsAppRunnerServiceCodeSource.connection_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awsapprunnerservice_v1_spec_proto_depIdxs = nil
}
