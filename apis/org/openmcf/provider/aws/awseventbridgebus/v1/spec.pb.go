...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awseventbridgebus/v1/spec.proto
...
func (x *AwsEventBridgeBusSpec) Reset() {
	*x = AwsEventBridgeBusSpec{}
	mi := &file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_msgTypes[0]
...
func (x *AwsEventBridgeBusDeadLetterConfig) Reset() {
	*x = AwsEventBridgeBusDeadLetterConfig{}
	mi := &file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEventBridgeBusDeadLetterConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsEventBridgeBusLogConfig) Reset() {
	*x = AwsEventBridgeBusLogConfig{}
	mi := &file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEventBridgeBusLogConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDesc = "" +
	...
	"1com.org.openmcf.provider.aws.awseventbridgebus.v1B\tSpecProtoP\x01Zcgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awseventbridgebus/v1;awseventbridgebusv1\xa2\x02\x05OOPAA\xaa\x02-Org.Openmcf.Provider.Aws.Awseventbridgebus.V1\xca\x02-Org\\Openmcf\\Provider\\Aws\\Awseventbridgebus\\V1\xe2\x029Org\\Openmcf\\Provider\\Aws\\Awseventbridgebus\\V1\\GPBMetadata\xea\x022Org::Openmcf::Provider::Aws::Awseventbridgebus::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_goTypes = []any{
	(*AwsEventBridgeBusSpec)(nil),             // 0: org.openmcf.provider.aws.awseventbridgebus.v1.AwsEventBridgeBusSpec
	(*AwsEventBridgeBusDeadLetterConfig)(nil), // 1: org.openmcf.provider.aws.awseventbridgebus.v1.AwsEventBridgeBusDeadLetterConfig
	(*AwsEventBridgeBusLogConfig)(nil),        // 2: org.openmcf.provider.aws.awseventbridgebus.v1.AwsEventBridgeBusLogConfig
	(*v1.StringValueOrRef)(nil),               // 3: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_depIdxs = []int32{
	3, // 0: org.openmcf.provider.aws.awseventbridgebus.v1.AwsEventBridgeBusSpec.kms_key_identifier:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 1: org.openmcf.provider.aws.awseventbridgebus.v1.AwsEventBridgeBusSpec.dead_letter_config:type_name -> org.openmcf.provider.aws.awseventbridgebus.v1.AwsEventBridgeBusDeadLetterConfig
	2, // 2: org.openmcf.provider.aws.awseventbridgebus.v1.AwsEventBridgeBusSpec.log_config:type_name -> org.openmcf.provider.aws.awseventbridgebus.v1.AwsEventBridgeBusLogConfig
	3, // 3: org.openmcf.provider.aws.awseventbridgebus.v1.AwsEventBridgeBusDeadLetterConfig.arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awseventbridgebus_v1_spec_proto_depIdxs = nil
}
