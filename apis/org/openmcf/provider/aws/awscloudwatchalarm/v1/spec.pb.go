...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awscloudwatchalarm/v1/spec.proto
...
func (x *AwsCloudwatchAlarmSpec) Reset() {
	*x = AwsCloudwatchAlarmSpec{}
	mi := &file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_msgTypes[0]
...
func (x *AwsCloudwatchAlarmMetricQuery) Reset() {
	*x = AwsCloudwatchAlarmMetricQuery{}
	mi := &file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchAlarmMetricQuery) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsCloudwatchAlarmMetricQueryMetric) Reset() {
	*x = AwsCloudwatchAlarmMetricQueryMetric{}
	mi := &file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchAlarmMetricQueryMetric) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDesc = "" +
	...
	"expression\x12k\n" +
	"\x06metric\x18\x03 \x01(\v2S.org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmMetricQueryMetricR\x06metric\x12\x14\n" +
	...
	"\n" +
	"dimensions\x18\x05 \x03(\v2c.org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmMetricQueryMetric.DimensionsEntryR\n" +
	"dimensions\x12\x12\n" +
	"\x04unit\x18\x06 \x01(\tR\x04unit\x1a=\n" +
	"\x0fDimensionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x85\x03\n" +
	"2com.org.openmcf.provider.aws.awscloudwatchalarm.v1B\tSpecProtoP\x01Zegithub.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awscloudwatchalarm/v1;awscloudwatchalarmv1\xa2\x02\x05OOPAA\xaa\x02.Org.Openmcf.Provider.Aws.Awscloudwatchalarm.V1\xca\x02.Org\\Openmcf\\Provider\\Aws\\Awscloudwatchalarm\\V1\xe2\x02:Org\\Openmcf\\Provider\\Aws\\Awscloudwatchalarm\\V1\\GPBMetadata\xea\x023Org::Openmcf::Provider::Aws::Awscloudwatchalarm::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_goTypes = []any{
	(*AwsCloudwatchAlarmSpec)(nil),              // 0: org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmSpec
	(*AwsCloudwatchAlarmMetricQuery)(nil),       // 1: org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmMetricQuery
	(*AwsCloudwatchAlarmMetricQueryMetric)(nil), // 2: org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmMetricQueryMetric
	nil,                         // 3: org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmSpec.DimensionsEntry
	nil,                         // 4: org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmMetricQueryMetric.DimensionsEntry
	(*v1.StringValueOrRef)(nil), // 5: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_depIdxs = []int32{
	3, // 0: org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmSpec.dimensions:type_name -> org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmSpec.DimensionsEntry
	1, // 1: org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmSpec.metric_queries:type_name -> org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmMetricQuery
	5, // 2: org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmSpec.alarm_actions:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	5, // 3: org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmSpec.ok_actions:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	5, // 4: org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmSpec.insufficient_data_actions:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 5: org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmMetricQuery.metric:type_name -> org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmMetricQueryMetric
	4, // 6: org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmMetricQueryMetric.dimensions:type_name -> org.openmcf.provider.aws.awscloudwatchalarm.v1.AwsCloudwatchAlarmMetricQueryMetric.DimensionsEntry
...
func init() { file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awscloudwatchalarm_v1_spec_proto_depIdxs = nil
}
