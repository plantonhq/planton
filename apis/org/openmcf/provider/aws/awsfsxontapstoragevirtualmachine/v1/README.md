...
An OpenMCF component that provisions an **Amazon FSx for NetApp ONTAP Storage Virtual Machine (SVM)** — a logical data server within an FSx ONTAP file system providing multi-protocol data access (NFS, SMB, iSCSI).
