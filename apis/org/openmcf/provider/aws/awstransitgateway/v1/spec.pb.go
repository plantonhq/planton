...
const file_org_openmcf_provider_aws_awstransitgateway_v1_spec_proto_rawDesc = "" +
	...
	"\x1bamazon_side_asn_valid_range\x12`amazon_side_asn must be in range 64512-65534 (16-bit) or 4200000000-4294967294 (32-bit) when set\x1a\xab\x01this.amazon_side_asn == 0 || (this.amazon_side_asn >= 64512 && this.amazon_side_asn <= 65534) || (this.amazon_side_asn >= 4200000000 && this.amazon_side_asn <= 4294967294)\"\x8c\x06\n" +
	...
	"\x06vpc_id\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB$\xbaH\x03\xc8\x01\x01\x88\xd4a\xd8\x01\x92\xd4a\x15status.outputs.vpc_idR\x05vpcId\x12\x7f\n" +
	"\n" +
	"subnet_ids\x18\x03 \x03(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB,\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01\x88\xd4a\x9c\x02\x92\xd4a\x18status.outputs.subnet_idR\tsubnetIds\x12)\n" +
