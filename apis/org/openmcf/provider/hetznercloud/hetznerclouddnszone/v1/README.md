...
This component has no upstream dependencies. It does not reference other OpenMCF components as required inputs. However, record values can optionally reference outputs from other components via `StringValueOrRef.valueFrom`.
