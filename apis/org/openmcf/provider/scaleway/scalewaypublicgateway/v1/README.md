...
- **One attachment per resource**: This OpenMCF resource manages one Private Network attachment. For multi-network gateways, additional `GatewayNetwork` resources can be managed separately.
