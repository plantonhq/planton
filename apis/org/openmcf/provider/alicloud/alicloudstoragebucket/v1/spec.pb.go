...
// 	protoc        (unknown)
// source: org/openmcf/provider/alicloud/alicloudstoragebucket/v1/spec.proto
...
var File_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_rawDesc = "" +
	...
	":com.org.openmcf.provider.alicloud.alicloudstoragebucket.v1B\tSpecProtoP\x01Zpgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/alicloud/alicloudstoragebucket/v1;alicloudstoragebucketv1\xa2\x02\x05OOPAA\xaa\x026Org.Openmcf.Provider.Alicloud.Alicloudstoragebucket.V1\xca\x026Org\\Openmcf\\Provider\\Alicloud\\Alicloudstoragebucket\\V1\xe2\x02BOrg\\Openmcf\\Provider\\Alicloud\\Alicloudstoragebucket\\V1\\GPBMetadata\xea\x02;Org::Openmcf::Provider::Alicloud::Alicloudstoragebucket::V1b\x06proto3"

var (
	file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_rawDescData
}
...
func init() { file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_init() }
func file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_init() {
	if File_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto = out.File
	file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_alicloud_alicloudstoragebucket_v1_spec_proto_depIdxs = nil
}
