# AlicloudNlbLoadBalancer Pulumi Module

This Pulumi module provisions an Alibaba Cloud Network Load Balancer (NLB) with server groups and listeners.

## Usage

This module is invoked by the OpenMCF Pulumi runner. It reads a `AlicloudNlbLoadBalancerStackInput` from the Pulumi stack config and creates all resources.
