...
// 	protoc        (unknown)
// source: org/openmcf/provider/alicloud/alicloudapplicationloadbalancer/v1/stack_outputs.proto
...
var File_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_rawDesc = "" +
	...
	"Dcom.org.openmcf.provider.alicloud.alicloudapplicationloadbalancer.v1B\x11StackOutputsProtoP\x01Z\x84\x01github.com/plantonhq/openmcf/apis/org/openmcf/provider/alicloud/alicloudapplicationloadbalancer/v1;alicloudapplicationloadbalancerv1\xa2\x02\x05OOPAA\xaa\x02@Org.Openmcf.Provider.Alicloud.Alicloudapplicationloadbalancer.V1\xca\x02@Org\\Openmcf\\Provider\\Alicloud\\Alicloudapplicationloadbalancer\\V1\xe2\x02LOrg\\Openmcf\\Provider\\Alicloud\\Alicloudapplicationloadbalancer\\V1\\GPBMetadata\xea\x02EOrg::Openmcf::Provider::Alicloud::Alicloudapplicationloadbalancer::V1b\x06proto3"

var (
	file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_rawDescData
}
...
func init() {
	file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_init()
}
func file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_init() {
	if File_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto = out.File
	file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_goTypes = nil
	file_org_openmcf_provider_alicloud_alicloudapplicationloadbalancer_v1_stack_outputs_proto_depIdxs = nil
}
