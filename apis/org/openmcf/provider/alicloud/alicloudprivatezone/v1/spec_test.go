...
func TestAlicloudPrivateZoneSpec(t *testing.T) {
	gomega.RegisterFailHandler(ginkgo.Fail)
	ginkgo.RunSpecs(t, "AlicloudPrivateZoneSpec Validation Tests")
}

var _ = ginkgo.Describe("AlicloudPrivateZoneSpec Validation Tests", func() {

	ginkgo.Describe("valid input", func() {

		ginkgo.It("should pass with minimal required fields", func() {
			input := &AlicloudPrivateZone{
				ApiVersion: "alicloud.openmcf.org/v1",
				Kind:       "AlicloudPrivateZone",
				Metadata: &shared.CloudResourceMetadata{
					Name: "test-zone",
				},
				Spec: &AlicloudPrivateZoneSpec{
					Region:   "cn-hangzhou",
					ZoneName: "internal.example.com",
					VpcAttachments: []*AlicloudPrivateZoneVpcAttachment{
						{
		...
		ginkgo.It("should pass with all optional fields populated", func() {
			input := &AlicloudPrivateZone{
				...
				Spec: &AlicloudPrivateZoneSpec{
					...
					Records: []*AlicloudPrivateZoneRecord{
						{
							Rr:    "master",
							Type:  "A",
							Value: "10.0.1.100",
