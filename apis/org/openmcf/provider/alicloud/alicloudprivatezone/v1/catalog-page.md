...
When you deploy an AlicloudPrivateZone resource, OpenMCF provisions:
...
metadata:
  ...
  labels:
    ...
    pulumi.openmcf.org/stack.name: dev.AlicloudPrivateZone.my-private-zone
spec:
  region: cn-hangzhou
...
metadata:
  ...
  labels:
    ...
    pulumi.openmcf.org/organization: my-org
    pulumi.openmcf.org/project: my-project
    pulumi.openmcf.org/stack.name: prod.AlicloudPrivateZone.svc-zone
spec:
  region: cn-hangzhou
...
metadata:
  ...
  labels:
    ...
    pulumi.openmcf.org/organization: my-org
    pulumi.openmcf.org/project: my-project
    pulumi.openmcf.org/stack.name: prod.AlicloudPrivateZone.db-zone
spec:
  region: cn-hangzhou
  zoneName: db.corp
...
- [AlicloudDnsDomain](/docs/catalog/alicloud/aliclouddnsdomain) -- manages public DNS domains in Alidns (separate from private zones)
