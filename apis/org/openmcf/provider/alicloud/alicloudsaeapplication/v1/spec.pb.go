...
// 	protoc        (unknown)
// source: org/openmcf/provider/alicloud/alicloudsaeapplication/v1/spec.proto
...
var File_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_rawDesc = "" +
	...
	"\x06vpc_id\x18\b \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\x1e\x88\xd4a\xcc\x17\x92\xd4a\x15status.outputs.vpc_idR\x05vpcId\x12u\n" +
	"\n" +
	"vswitch_id\x18\t \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\"\x88\xd4a\xcd\x17\x92\xd4a\x19status.outputs.vswitch_idR\tvswitchId\x12\x89\x01\n" +
	"\x11security_group_id\x18\n" +
	" \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB)\x88\xd4a\xce\x17\x92\xd4a status.outputs.security_group_idR\x0fsecurityGroupId\x12!\n" +
	...
	";com.org.openmcf.provider.alicloud.alicloudsaeapplication.v1B\tSpecProtoP\x01Zrgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/alicloud/alicloudsaeapplication/v1;alicloudsaeapplicationv1\xa2\x02\x05OOPAA\xaa\x027Org.Openmcf.Provider.Alicloud.Alicloudsaeapplication.V1\xca\x027Org\\Openmcf\\Provider\\Alicloud\\Alicloudsaeapplication\\V1\xe2\x02COrg\\Openmcf\\Provider\\Alicloud\\Alicloudsaeapplication\\V1\\GPBMetadata\xea\x02<Org::Openmcf::Provider::Alicloud::Alicloudsaeapplication::V1b\x06proto3"

var (
	file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_rawDescData
}
...
func init() { file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_init() }
func file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_init() {
	if File_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_msgTypes[6].OneofWrappers = []any{}
	file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto = out.File
	file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_alicloud_alicloudsaeapplication_v1_spec_proto_depIdxs = nil
}
