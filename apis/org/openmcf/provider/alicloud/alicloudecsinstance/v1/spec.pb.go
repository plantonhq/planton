...
// 	protoc        (unknown)
// source: org/openmcf/provider/alicloud/alicloudecsinstance/v1/spec.proto
...
var File_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_rawDesc = "" +
	...
	"\n" +
	"vswitch_id\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB(\xbaH\x03\xc8\x01\x01\x88\xd4a\xcd\x17\x92\xd4a\x19status.outputs.vswitch_idR\tvswitchId\x12\x93\x01\n" +
	"\x12security_group_ids\x18\x03 \x03(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB1\xbaH\x05\x92\x01\x02\b\x01\x88\xd4a\xce\x17\x92\xd4a status.outputs.security_group_idR\x10securityGroupIds\x12\x83\x01\n" +
	...
	"8com.org.openmcf.provider.alicloud.alicloudecsinstance.v1B\tSpecProtoP\x01Zlgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/alicloud/alicloudecsinstance/v1;alicloudecsinstancev1\xa2\x02\x05OOPAA\xaa\x024Org.Openmcf.Provider.Alicloud.Alicloudecsinstance.V1\xca\x024Org\\Openmcf\\Provider\\Alicloud\\Alicloudecsinstance\\V1\xe2\x02@Org\\Openmcf\\Provider\\Alicloud\\Alicloudecsinstance\\V1\\GPBMetadata\xea\x029Org::Openmcf::Provider::Alicloud::Alicloudecsinstance::V1b\x06proto3"

var (
	file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_rawDescData
}
...
func init() { file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_init() }
func file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_init() {
	if File_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto = out.File
	file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_alicloud_alicloudecsinstance_v1_spec_proto_depIdxs = nil
}
