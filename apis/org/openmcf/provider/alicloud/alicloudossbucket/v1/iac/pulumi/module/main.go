...
func Resources(ctx *pulumi.Context, stackInput *alicloudossbucketv1.AlicloudOssBucketStackInput) error {
	locals := initializeLocals(ctx, stackInput)
	spec := locals.AlicloudOssBucket.Spec
...
func buildCorsRules(rules []*alicloudossbucketv1.AlicloudOssBucketCorsRule) oss.BucketCorsRuleArray {
...
func buildLifecycleRules(rules []*alicloudossbucketv1.AlicloudOssBucketLifecycleRule) oss.BucketLifecycleRuleArray {
