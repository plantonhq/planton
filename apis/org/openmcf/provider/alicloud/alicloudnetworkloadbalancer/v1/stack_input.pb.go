...
// 	protoc        (unknown)
// source: org/openmcf/provider/alicloud/alicloudnetworkloadbalancer/v1/stack_input.proto
...
var File_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto protoreflect.FileDescriptor
...
var (
	file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_rawDescData []byte
)

func file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_rawDesc), len(file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_rawDesc)))
	})
	return file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_rawDescData
}
...
func init() {
	file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_init()
}
func file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_init() {
	if File_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto != nil {
		return
	}
	file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_api_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_rawDesc), len(file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto = out.File
	file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_goTypes = nil
	file_org_openmcf_provider_alicloud_alicloudnetworkloadbalancer_v1_stack_input_proto_depIdxs = nil
}
