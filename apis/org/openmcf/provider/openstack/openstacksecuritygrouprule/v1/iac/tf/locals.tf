...
locals {
  ...
  security_group_id = var.spec.security_group_id.value

  # Extract remote_group_id from StringValueOrRef (optional field)
  remote_group_id = (
    var.spec.remote_group_id != null
    ? var.spec.remote_group_id.value
    : ""
  )
  ...
  base_labels = {
    ...
    "resource_kind" = "openstack_security_group_rule"
  }
