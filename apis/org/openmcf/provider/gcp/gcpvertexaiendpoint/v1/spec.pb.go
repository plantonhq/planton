...
// 	protoc        (unknown)
// source: org/openmcf/provider/gcp/gcpvertexaiendpoint/v1/spec.proto
...
func (x *GcpVertexAiEndpointPrivateServiceConnectConfig) Reset() {
	*x = GcpVertexAiEndpointPrivateServiceConnectConfig{}
	mi := &file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_msgTypes[0]
...
func (*GcpVertexAiEndpointPrivateServiceConnectConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpVertexAiEndpointSpec) Reset() {
	*x = GcpVertexAiEndpointSpec{}
	mi := &file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpVertexAiEndpointSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDesc = "" +
	"\n" +
	":org/openmcf/provider/gcp/gcpvertexaiendpoint/v1/spec.proto\x12/org.openmcf.provider.gcp.gcpvertexaiendpoint.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\"]\n" +
	...
	"\anetwork\x18\x05 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB)\x88\xd4a\xe2\x04\x92\xd4a status.outputs.network_self_linkR\anetwork\x12t\n" +
	"\fkms_key_name\x18\x06 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\x1e\x88\xd4a\xb3\x05\x92\xd4a\x15status.outputs.key_idR\n" +
	"kmsKeyName\x12<\n" +
	"\x1adedicated_endpoint_enabled\x18\a \x01(\bR\x18dedicatedEndpointEnabled\x12\xa4\x01\n" +
	"\x1eprivate_service_connect_config\x18\b \x01(\v2_.org.openmcf.provider.gcp.gcpvertexaiendpoint.v1.GcpVertexAiEndpointPrivateServiceConnectConfigR\x1bprivateServiceConnectConfig\x12\xb3\x01\n" +
	...
	"3com.org.openmcf.provider.gcp.gcpvertexaiendpoint.v1B\tSpecProtoP\x01Zggithub.com/plantonhq/openmcf/apis/org/openmcf/provider/gcp/gcpvertexaiendpoint/v1;gcpvertexaiendpointv1\xa2\x02\x05OOPGG\xaa\x02/Org.Openmcf.Provider.Gcp.Gcpvertexaiendpoint.V1\xca\x02/Org\\Openmcf\\Provider\\Gcp\\Gcpvertexaiendpoint\\V1\xe2\x02;Org\\Openmcf\\Provider\\Gcp\\Gcpvertexaiendpoint\\V1\\GPBMetadata\xea\x024Org::Openmcf::Provider::Gcp::Gcpvertexaiendpoint::V1b\x06proto3"

var (
	file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_goTypes = []any{
	(*GcpVertexAiEndpointPrivateServiceConnectConfig)(nil), // 0: org.openmcf.provider.gcp.gcpvertexaiendpoint.v1.GcpVertexAiEndpointPrivateServiceConnectConfig
	(*GcpVertexAiEndpointSpec)(nil),                        // 1: org.openmcf.provider.gcp.gcpvertexaiendpoint.v1.GcpVertexAiEndpointSpec
	(*v1.StringValueOrRef)(nil),                            // 2: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_depIdxs = []int32{
	2, // 0: org.openmcf.provider.gcp.gcpvertexaiendpoint.v1.GcpVertexAiEndpointSpec.project_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 1: org.openmcf.provider.gcp.gcpvertexaiendpoint.v1.GcpVertexAiEndpointSpec.network:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 2: org.openmcf.provider.gcp.gcpvertexaiendpoint.v1.GcpVertexAiEndpointSpec.kms_key_name:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	0, // 3: org.openmcf.provider.gcp.gcpvertexaiendpoint.v1.GcpVertexAiEndpointSpec.private_service_connect_config:type_name -> org.openmcf.provider.gcp.gcpvertexaiendpoint.v1.GcpVertexAiEndpointPrivateServiceConnectConfig
...
func init() { file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_init() }
func file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_init() {
	if File_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto = out.File
	file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_gcp_gcpvertexaiendpoint_v1_spec_proto_depIdxs = nil
}
