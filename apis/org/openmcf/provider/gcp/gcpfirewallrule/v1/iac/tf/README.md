...
This Terraform module provisions a GCP compute firewall rule. It is the Terraform-side implementation of the OpenMCF `GcpFirewallRule` resource kind and has feature parity with the Pulumi module.

## Usage

```bash
cd apis/org/openmcf/provider/gcp/gcpfirewallrule/v1/iac/tf
terraform init
