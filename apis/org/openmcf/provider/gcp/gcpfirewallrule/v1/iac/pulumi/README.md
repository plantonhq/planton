...
This directory contains the Pulumi implementation for deploying GCP compute firewall rules using OpenMCF's `GcpFirewallRule` API. The module is written in Go and leverages the Pulumi GCP provider to create `google_compute_firewall` resources.
