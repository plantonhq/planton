...
This document captures research and design decisions for the GcpCloudArmorPolicy OpenMCF component. It provides background on Google Cloud Armor, the 80/20 scoping rationale, and deliberate exclusions.
