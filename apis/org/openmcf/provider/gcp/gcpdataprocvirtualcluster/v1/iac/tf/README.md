...
This module is designed to be called by the OpenMCF framework. Direct usage requires providing the `spec` and `metadata` variables matching the protobuf-defined schema.
