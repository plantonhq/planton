...
Terraform implementation for the GcpSpannerDatabase OpenMCF component.
...
- Terraform's `deletion_protection` is set to `false` by default to allow OpenMCF to manage the lifecycle. Use `enable_drop_protection` for GCP API-level protection.
