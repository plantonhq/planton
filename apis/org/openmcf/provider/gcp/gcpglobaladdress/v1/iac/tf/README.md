...
This Terraform module provisions a GCP global address (`google_compute_global_address`). It is the Terraform-side implementation of the OpenMCF `GcpGlobalAddress` resource kind and has feature parity with the Pulumi module.
...
```bash
cd apis/org/openmcf/provider/gcp/gcpglobaladdress/v1/iac/tf
terraform init
