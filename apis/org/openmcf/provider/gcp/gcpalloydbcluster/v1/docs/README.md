...
A cluster without a primary instance cannot serve queries. This is why the OpenMCF component bundles cluster and primary instance together. Read pool instances are separate resources with independent scaling lifecycles and are not included in this component.
