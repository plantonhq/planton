...
| OpenMCF (GcpSpannerInstance) | Multi-cloud consistency, infra-chart composability | Newer ecosystem |

### OpenMCF's Value Add

OpenMCF's GcpSpannerInstance component provides:
...
3. **Consistent metadata** -- Framework labels, KRM envelope, and output contracts that match every other OpenMCF component
