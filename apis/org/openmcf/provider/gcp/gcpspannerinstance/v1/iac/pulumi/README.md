...
go build ./apis/org/openmcf/provider/gcp/gcpspannerinstance/v1/...

# Test
go test -v ./apis/org/openmcf/provider/gcp/gcpspannerinstance/v1/

# Debug with local manifest
cd apis/org/openmcf/provider/gcp/gcpspannerinstance/v1/iac/pulumi
./debug.sh
```
