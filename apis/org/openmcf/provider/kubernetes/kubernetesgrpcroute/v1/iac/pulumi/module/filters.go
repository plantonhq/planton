...
// This file maps the single OpenMCF KubernetesGrpcRouteFilter message onto the
...
// OpenMCF model (the same pattern HTTPRoute and Gateway use). The GRPC filter set
