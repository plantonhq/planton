...
import (
	...
	istionetworkingv1alpha3 "github.com/plantonhq/openmcf/pkg/kubernetes/kubernetestypes/istio/kubernetes/networking/v1alpha3"
...
// (istionetworkingv1alpha3.NewEnvoyFilter), consistent with every other OpenMCF Istio
...
// buildConfigPatchArgs maps one OpenMCF config patch to the typed SDK args. apply_to, match,
