...
// crd2pulumi SDK (istionetworkingv1.NewDestinationRule), consistent with every other OpenMCF
...
// buildSubsets maps the OpenMCF subsets to the typed SDK subset args. Each subset's traffic
