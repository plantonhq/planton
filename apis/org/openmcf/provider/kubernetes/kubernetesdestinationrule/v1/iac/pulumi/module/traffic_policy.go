...
// This file maps the OpenMCF DestinationRule traffic-policy proto subtree onto the typed
// crd2pulumi SDK args.
//
...
import (
	dr "github.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kubernetesdestinationrule/v1"
	istio "github.com/plantonhq/openmcf/pkg/kubernetes/kubernetestypes/istio/kubernetes/networking/v1"
