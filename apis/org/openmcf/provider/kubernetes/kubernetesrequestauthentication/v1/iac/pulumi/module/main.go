...
// consistent with every other OpenMCF Istio component. The typed approach catches
...
// buildJwtRuleArgs maps one OpenMCF JWT rule to the typed SDK args. Optional scalar
