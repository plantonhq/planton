...
import (
	...
	istiosecurityv1 "github.com/plantonhq/openmcf/pkg/kubernetes/kubernetestypes/istio/kubernetes/security/v1"
...
// every other OpenMCF Istio component. The typed approach catches field-name and
...
// buildRuleArgs maps one OpenMCF rule to the typed SDK args, attaching the from/to/
...
// buildSourceArgs maps an OpenMCF source to the typed SDK args. Each identity list
...
// buildOperationArgs maps an OpenMCF operation to the typed SDK args. Each match
