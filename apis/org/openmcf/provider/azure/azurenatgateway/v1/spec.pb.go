...
const file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDesc = "" +
	"\n" +
	"8org/openmcf/provider/azure/azurenatgateway/v1/spec.proto\x12-org.openmcf.provider.azure.azurenatgateway.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\"\x9b\x05\n" +
	"\x13AzureNatGatewaySpec\x12x\n" +
	"\tsubnet_id\x18\x01 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB'\xbaH\x03\xc8\x01\x01\x88\xd4a\x9b\x03\x92\xd4a\x18status.outputs.subnet_idR\bsubnetId\x12@\n" +
