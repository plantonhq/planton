...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azuresubnet/v1/spec.proto
...
func (x *AzureSubnetSpec) Reset() {
	*x = AzureSubnetSpec{}
	mi := &file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_msgTypes[0]
...
func (*AzureSubnetSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureSubnetDelegation) Reset() {
	*x = AzureSubnetDelegation{}
	mi := &file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureSubnetDelegation) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_azure_azuresubnet_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDesc = "" +
	"\n" +
	"4org/openmcf/provider/azure/azuresubnet/v1/spec.proto\x12)org.openmcf.provider.azure.azuresubnet.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xa9\b\n" +
	"\x0fAzureSubnetSpec\x12\x8c\x01\n" +
	"\x0eresource_group\x18\x01 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB1\xbaH\x03\xc8\x01\x01\x88\xd4a\x90\x03\x92\xd4a\"status.outputs.resource_group_nameR\rresourceGroup\x12r\n" +
	"\avnet_id\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB%\xbaH\x03\xc8\x01\x01\x88\xd4a\x96\x03\x92\xd4a\x16status.outputs.vnet_idR\x06vnetId\x12 \n" +
	...
	"\n" +
	"delegation\x18\x06 \x01(\v2@.org.openmcf.provider.azure.azuresubnet.v1.AzureSubnetDelegationR\n" +
	...
	"-com.org.openmcf.provider.azure.azuresubnet.v1B\tSpecProtoP\x01ZYgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azuresubnet/v1;azuresubnetv1\xa2\x02\x05OOPAA\xaa\x02)Org.Openmcf.Provider.Azure.Azuresubnet.V1\xca\x02)Org\\Openmcf\\Provider\\Azure\\Azuresubnet\\V1\xe2\x025Org\\Openmcf\\Provider\\Azure\\Azuresubnet\\V1\\GPBMetadata\xea\x02.Org::Openmcf::Provider::Azure::Azuresubnet::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_goTypes = []any{
	(*AzureSubnetSpec)(nil),       // 0: org.openmcf.provider.azure.azuresubnet.v1.AzureSubnetSpec
	(*AzureSubnetDelegation)(nil), // 1: org.openmcf.provider.azure.azuresubnet.v1.AzureSubnetDelegation
	(*v1.StringValueOrRef)(nil),   // 2: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_depIdxs = []int32{
	2, // 0: org.openmcf.provider.azure.azuresubnet.v1.AzureSubnetSpec.resource_group:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 1: org.openmcf.provider.azure.azuresubnet.v1.AzureSubnetSpec.vnet_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 2: org.openmcf.provider.azure.azuresubnet.v1.AzureSubnetSpec.delegation:type_name -> org.openmcf.provider.azure.azuresubnet.v1.AzureSubnetDelegation
...
func init() { file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_init() }
func file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_init() {
	if File_org_openmcf_provider_azure_azuresubnet_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azuresubnet_v1_spec_proto = out.File
	file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_azure_azuresubnet_v1_spec_proto_depIdxs = nil
}
