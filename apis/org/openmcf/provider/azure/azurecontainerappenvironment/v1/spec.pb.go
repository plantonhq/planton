...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azurecontainerappenvironment/v1/spec.proto
...
func (x *AzureContainerAppEnvironmentSpec) Reset() {
	*x = AzureContainerAppEnvironmentSpec{}
	mi := &file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_msgTypes[0]
...
func (*AzureContainerAppEnvironmentSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureContainerAppWorkloadProfile) Reset() {
	*x = AzureContainerAppWorkloadProfile{}
	mi := &file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppWorkloadProfile) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Eorg/openmcf/provider/azure/azurecontainerappenvironment/v1/spec.proto\x12:org.openmcf.provider.azure.azurecontainerappenvironment.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xad\b\n" +
	" AzureContainerAppEnvironmentSpec\x12\"\n" +
	"\x06region\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x06region\x12\x8c\x01\n" +
	"\x0eresource_group\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB1\xbaH\x03\xc8\x01\x01\x88\xd4a\x90\x03\x92\xd4a\"status.outputs.resource_group_nameR\rresourceGroup\x12\xc3\x01\n" +
	...
	"\x18infrastructure_subnet_id\x18\x04 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB!\x88\xd4a\x9b\x03\x92\xd4a\x18status.outputs.subnet_idR\x16infrastructureSubnetId\x12\x95\x01\n" +
	"\x1alog_analytics_workspace_id\x18\x05 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB$\x88\xd4a\xc2\x03\x92\xd4a\x1bstatus.outputs.workspace_idR\x17logAnalyticsWorkspaceId\x12S\n" +
	...
	"\x11workload_profiles\x18\b \x03(\v2\\.org.openmcf.provider.azure.azurecontainerappenvironment.v1.AzureContainerAppWorkloadProfileR\x10workloadProfilesB!\n" +
	...
	">com.org.openmcf.provider.azure.azurecontainerappenvironment.v1B\tSpecProtoP\x01Z{github.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azurecontainerappenvironment/v1;azurecontainerappenvironmentv1\xa2\x02\x05OOPAA\xaa\x02:Org.Openmcf.Provider.Azure.Azurecontainerappenvironment.V1\xca\x02:Org\\Openmcf\\Provider\\Azure\\Azurecontainerappenvironment\\V1\xe2\x02FOrg\\Openmcf\\Provider\\Azure\\Azurecontainerappenvironment\\V1\\GPBMetadata\xea\x02?Org::Openmcf::Provider::Azure::Azurecontainerappenvironment::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_goTypes = []any{
	(*AzureContainerAppEnvironmentSpec)(nil), // 0: org.openmcf.provider.azure.azurecontainerappenvironment.v1.AzureContainerAppEnvironmentSpec
	(*AzureContainerAppWorkloadProfile)(nil), // 1: org.openmcf.provider.azure.azurecontainerappenvironment.v1.AzureContainerAppWorkloadProfile
	(*v1.StringValueOrRef)(nil),              // 2: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_depIdxs = []int32{
	2, // 0: org.openmcf.provider.azure.azurecontainerappenvironment.v1.AzureContainerAppEnvironmentSpec.resource_group:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 1: org.openmcf.provider.azure.azurecontainerappenvironment.v1.AzureContainerAppEnvironmentSpec.infrastructure_subnet_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 2: org.openmcf.provider.azure.azurecontainerappenvironment.v1.AzureContainerAppEnvironmentSpec.log_analytics_workspace_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 3: org.openmcf.provider.azure.azurecontainerappenvironment.v1.AzureContainerAppEnvironmentSpec.workload_profiles:type_name -> org.openmcf.provider.azure.azurecontainerappenvironment.v1.AzureContainerAppWorkloadProfile
...
func init() { file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_init() }
func file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_init() {
	if File_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto = out.File
	file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_azure_azurecontainerappenvironment_v1_spec_proto_depIdxs = nil
}
