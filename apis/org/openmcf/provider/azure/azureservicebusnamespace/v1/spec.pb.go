...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azureservicebusnamespace/v1/spec.proto
...
func (x *AzureServiceBusNamespaceSpec) Reset() {
	*x = AzureServiceBusNamespaceSpec{}
	mi := &file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_msgTypes[0]
...
func (*AzureServiceBusNamespaceSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureServiceBusQueue) Reset() {
	*x = AzureServiceBusQueue{}
	mi := &file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureServiceBusQueue) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AzureServiceBusTopic) Reset() {
	*x = AzureServiceBusTopic{}
	mi := &file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureServiceBusTopic) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Aorg/openmcf/provider/azure/azureservicebusnamespace/v1/spec.proto\x126org.openmcf.provider.azure.azureservicebusnamespace.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xcf\n" +
	"\n" +
	...
	"\x06queues\x18\n" +
	" \x03(\v2L.org.openmcf.provider.azure.azureservicebusnamespace.v1.AzureServiceBusQueueR\x06queues\x12d\n" +
	"\x06topics\x18\v \x03(\v2L.org.openmcf.provider.azure.azureservicebusnamespace.v1.AzureServiceBusTopicR\x06topicsB\x06\n" +
	"\x04_skuB\v\n" +
	"\t_capacityB\x1f\n" +
	...
	":com.org.openmcf.provider.azure.azureservicebusnamespace.v1B\tSpecProtoP\x01Zsgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azureservicebusnamespace/v1;azureservicebusnamespacev1\xa2\x02\x05OOPAA\xaa\x026Org.Openmcf.Provider.Azure.Azureservicebusnamespace.V1\xca\x026Org\\Openmcf\\Provider\\Azure\\Azureservicebusnamespace\\V1\xe2\x02BOrg\\Openmcf\\Provider\\Azure\\Azureservicebusnamespace\\V1\\GPBMetadata\xea\x02;Org::Openmcf::Provider::Azure::Azureservicebusnamespace::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_goTypes = []any{
	(*AzureServiceBusNamespaceSpec)(nil), // 0: org.openmcf.provider.azure.azureservicebusnamespace.v1.AzureServiceBusNamespaceSpec
	(*AzureServiceBusQueue)(nil),         // 1: org.openmcf.provider.azure.azureservicebusnamespace.v1.AzureServiceBusQueue
	(*AzureServiceBusTopic)(nil),         // 2: org.openmcf.provider.azure.azureservicebusnamespace.v1.AzureServiceBusTopic
	(*v1.StringValueOrRef)(nil),          // 3: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_depIdxs = []int32{
	3, // 0: org.openmcf.provider.azure.azureservicebusnamespace.v1.AzureServiceBusNamespaceSpec.resource_group:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 1: org.openmcf.provider.azure.azureservicebusnamespace.v1.AzureServiceBusNamespaceSpec.queues:type_name -> org.openmcf.provider.azure.azureservicebusnamespace.v1.AzureServiceBusQueue
	2, // 2: org.openmcf.provider.azure.azureservicebusnamespace.v1.AzureServiceBusNamespaceSpec.topics:type_name -> org.openmcf.provider.azure.azureservicebusnamespace.v1.AzureServiceBusTopic
...
func init() { file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_init() }
func file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_init() {
	if File_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto = out.File
	file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_azure_azureservicebusnamespace_v1_spec_proto_depIdxs = nil
}
