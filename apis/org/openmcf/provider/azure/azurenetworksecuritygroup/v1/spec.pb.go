...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azurenetworksecuritygroup/v1/spec.proto
...
func (x *AzureNetworkSecurityGroupSpec) Reset() {
	*x = AzureNetworkSecurityGroupSpec{}
	mi := &file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_msgTypes[0]
...
func (*AzureNetworkSecurityGroupSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureSecurityRule) Reset() {
	*x = AzureSecurityRule{}
	mi := &file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureSecurityRule) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Borg/openmcf/provider/azure/azurenetworksecuritygroup/v1/spec.proto\x127org.openmcf.provider.azure.azurenetworksecuritygroup.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xe7\x02\n" +
	...
	"\x0esecurity_rules\x18\x04 \x03(\v2J.org.openmcf.provider.azure.azurenetworksecuritygroup.v1.AzureSecurityRuleR\rsecurityRules\"\xdb\a\n" +
	...
	";com.org.openmcf.provider.azure.azurenetworksecuritygroup.v1B\tSpecProtoP\x01Zugithub.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azurenetworksecuritygroup/v1;azurenetworksecuritygroupv1\xa2\x02\x05OOPAA\xaa\x027Org.Openmcf.Provider.Azure.Azurenetworksecuritygroup.V1\xca\x027Org\\Openmcf\\Provider\\Azure\\Azurenetworksecuritygroup\\V1\xe2\x02COrg\\Openmcf\\Provider\\Azure\\Azurenetworksecuritygroup\\V1\\GPBMetadata\xea\x02<Org::Openmcf::Provider::Azure::Azurenetworksecuritygroup::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_goTypes = []any{
	(*AzureNetworkSecurityGroupSpec)(nil), // 0: org.openmcf.provider.azure.azurenetworksecuritygroup.v1.AzureNetworkSecurityGroupSpec
	(*AzureSecurityRule)(nil),             // 1: org.openmcf.provider.azure.azurenetworksecuritygroup.v1.AzureSecurityRule
	(*v1.StringValueOrRef)(nil),           // 2: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_depIdxs = []int32{
	2, // 0: org.openmcf.provider.azure.azurenetworksecuritygroup.v1.AzureNetworkSecurityGroupSpec.resource_group:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 1: org.openmcf.provider.azure.azurenetworksecuritygroup.v1.AzureNetworkSecurityGroupSpec.security_rules:type_name -> org.openmcf.provider.azure.azurenetworksecuritygroup.v1.AzureSecurityRule
...
func init() { file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_init() }
func file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_init() {
	if File_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto = out.File
	file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_azure_azurenetworksecuritygroup_v1_spec_proto_depIdxs = nil
}
