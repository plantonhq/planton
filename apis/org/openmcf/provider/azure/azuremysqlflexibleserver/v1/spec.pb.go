...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azuremysqlflexibleserver/v1/spec.proto
...
func (x *AzureMysqlFlexibleServerSpec) Reset() {
	*x = AzureMysqlFlexibleServerSpec{}
	mi := &file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_msgTypes[0]
...
func (*AzureMysqlFlexibleServerSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureMysqlHighAvailability) Reset() {
	*x = AzureMysqlHighAvailability{}
	mi := &file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureMysqlHighAvailability) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AzureMysqlDatabase) Reset() {
	*x = AzureMysqlDatabase{}
	mi := &file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureMysqlDatabase) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AzureMysqlFirewallRule) Reset() {
	*x = AzureMysqlFirewallRule{}
	mi := &file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureMysqlFirewallRule) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDesc = "" +
	...
	"\x11high_availability\x18\r \x01(\v2R.org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlHighAvailabilityR\x10highAvailability\x12G\n" +
	...
	"\tdatabases\x18\x10 \x03(\v2J.org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlDatabaseR\tdatabases\x12u\n" +
	"\x0efirewall_rules\x18\x11 \x03(\v2N.org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlFirewallRuleR\rfirewallRulesB\n" +
	"\n" +
	"\b_versionB\x14\n" +
	...
	":com.org.openmcf.provider.azure.azuremysqlflexibleserver.v1B\tSpecProtoP\x01Zsgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azuremysqlflexibleserver/v1;azuremysqlflexibleserverv1\xa2\x02\x05OOPAA\xaa\x026Org.Openmcf.Provider.Azure.Azuremysqlflexibleserver.V1\xca\x026Org\\Openmcf\\Provider\\Azure\\Azuremysqlflexibleserver\\V1\xe2\x02BOrg\\Openmcf\\Provider\\Azure\\Azuremysqlflexibleserver\\V1\\GPBMetadata\xea\x02;Org::Openmcf::Provider::Azure::Azuremysqlflexibleserver::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_goTypes = []any{
	(*AzureMysqlFlexibleServerSpec)(nil), // 0: org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlFlexibleServerSpec
	(*AzureMysqlHighAvailability)(nil),   // 1: org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlHighAvailability
	(*AzureMysqlDatabase)(nil),           // 2: org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlDatabase
	(*AzureMysqlFirewallRule)(nil),       // 3: org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlFirewallRule
	(*v1.StringValueOrRef)(nil),          // 4: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_depIdxs = []int32{
	4, // 0: org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlFlexibleServerSpec.resource_group:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	4, // 1: org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlFlexibleServerSpec.administrator_password:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	4, // 2: org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlFlexibleServerSpec.delegated_subnet_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	4, // 3: org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlFlexibleServerSpec.private_dns_zone_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 4: org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlFlexibleServerSpec.high_availability:type_name -> org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlHighAvailability
	2, // 5: org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlFlexibleServerSpec.databases:type_name -> org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlDatabase
	3, // 6: org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlFlexibleServerSpec.firewall_rules:type_name -> org.openmcf.provider.azure.azuremysqlflexibleserver.v1.AzureMysqlFirewallRule
...
func init() { file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_init() }
func file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_init() {
	if File_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto = out.File
	file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_azure_azuremysqlflexibleserver_v1_spec_proto_depIdxs = nil
}
