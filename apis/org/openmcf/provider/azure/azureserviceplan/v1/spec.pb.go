...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azureserviceplan/v1/spec.proto
...
func (x *AzureServicePlanSpec) Reset() {
	*x = AzureServicePlanSpec{}
	mi := &file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_msgTypes[0]
...
func (*AzureServicePlanSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_rawDesc = "" +
	"\n" +
	"9org/openmcf/provider/azure/azureserviceplan/v1/spec.proto\x12.org.openmcf.provider.azure.azureserviceplan.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xab\a\n" +
	"\x14AzureServicePlanSpec\x12\"\n" +
	"\x06region\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x06region\x12\x8c\x01\n" +
	"\x0eresource_group\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB1\xbaH\x03\xc8\x01\x01\x88\xd4a\x90\x03\x92\xd4a\"status.outputs.resource_group_nameR\rresourceGroup\x12\xae\x01\n" +
	...
	"2com.org.openmcf.provider.azure.azureserviceplan.v1B\tSpecProtoP\x01Zcgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azureserviceplan/v1;azureserviceplanv1\xa2\x02\x05OOPAA\xaa\x02.Org.Openmcf.Provider.Azure.Azureserviceplan.V1\xca\x02.Org\\Openmcf\\Provider\\Azure\\Azureserviceplan\\V1\xe2\x02:Org\\Openmcf\\Provider\\Azure\\Azureserviceplan\\V1\\GPBMetadata\xea\x023Org::Openmcf::Provider::Azure::Azureserviceplan::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_goTypes = []any{
	(*AzureServicePlanSpec)(nil), // 0: org.openmcf.provider.azure.azureserviceplan.v1.AzureServicePlanSpec
	(*v1.StringValueOrRef)(nil),  // 1: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_depIdxs = []int32{
	1, // 0: org.openmcf.provider.azure.azureserviceplan.v1.AzureServicePlanSpec.resource_group:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_init() }
func file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_init() {
	if File_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto = out.File
	file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_azure_azureserviceplan_v1_spec_proto_depIdxs = nil
}
