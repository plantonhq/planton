...
OciDevopsProject is an OpenMCF component that deploys an OCI DevOps project. It provides a single declarative manifest to create the organizational container for CI/CD pipelines, code repositories, deployment environments, artifacts, and triggers.
