...
- **Automatic Tagging**: Standard OpenMCF freeform tags applied to the node pool and its node config (resource kind, resource ID, organization, environment, and user-defined labels from metadata).
