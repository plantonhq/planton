...
- **Automatic Tagging**: Standard OpenMCF freeform tags are applied to the subnet and any created route table (resource kind, resource ID, organization, environment, and user-defined labels from metadata).
