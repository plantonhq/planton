...
OciQueue is an OpenMCF component that deploys an OCI Queue. It provides a single declarative manifest to create a fully managed, serverless message queue with configurable delivery semantics, encryption, and consumption patterns.
