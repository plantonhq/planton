...
- **Automatic Tagging**: Standard OpenMCF freeform tags applied to the cluster (resource kind, resource ID, organization, environment, and user-defined labels from metadata).
