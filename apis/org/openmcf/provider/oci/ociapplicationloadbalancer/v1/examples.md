...
metadata:
  ...
  labels:
    ...
    pulumi.openmcf.org/organization: acme
    pulumi.openmcf.org/project: platform
    pulumi.openmcf.org/stack.name: staging.OciApplicationLoadBalancer.canary-lb
spec:
  compartmentId:
    value: "ocid1.compartment.oc1..example"
  shape: "flexible"
...
metadata:
  ...
  labels:
    ...
    pulumi.openmcf.org/organization: acme
    pulumi.openmcf.org/project: platform
    pulumi.openmcf.org/stack.name: prod.OciApplicationLoadBalancer.stateful-app
spec:
  compartmentId:
    value: "ocid1.compartment.oc1..example"
  shape: "flexible"
...
**What happens:**
- Infrastructure references use `valueFrom` to compose with OciCompartment, OciSubnet, and OciSecurityGroup. This enables the load balancer to be deployed as part of an infra chart where compartments, subnets, and NSGs are created by upstream components.
