...
The module follows the standard OpenMCF Pulumi module pattern: `main.go` orchestrates, `locals.go` prepares derived values, resource-specific files create infrastructure, and `outputs.go` defines constant keys for stack exports.
