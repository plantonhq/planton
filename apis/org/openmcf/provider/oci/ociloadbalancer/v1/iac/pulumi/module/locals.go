...
type Locals struct {
	OciLoadBalancer *ociloadbalancerv1.OciLoadBalancer
	DisplayName     string
	FreeformTags    map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ociloadbalancerv1.OciLoadBalancerStackInput) *Locals {
	locals := &Locals{}
	locals.OciLoadBalancer = stackInput.Target
	...
	locals.FreeformTags = map[string]string{
		"resource":      "true",
		"resource_kind": cloudresourcekind.CloudResourceKind_OciLoadBalancer.String(),
