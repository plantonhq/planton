...
func createBackendSet(ctx *pulumi.Context, locals *Locals, provider *oci.Provider, lb *loadbalancer.LoadBalancer, bsSpec *ociloadbalancerv1.OciLoadBalancerSpec_BackendSet) (*loadbalancer.BackendSet, error) {
	policyMap := map[ociloadbalancerv1.OciLoadBalancerSpec_BackendSet_Policy]string{
		ociloadbalancerv1.OciLoadBalancerSpec_BackendSet_round_robin:       "ROUND_ROBIN",
		ociloadbalancerv1.OciLoadBalancerSpec_BackendSet_least_connections: "LEAST_CONNECTIONS",
		ociloadbalancerv1.OciLoadBalancerSpec_BackendSet_ip_hash:           "IP_HASH",
	}
...
func createBackend(ctx *pulumi.Context, provider *oci.Provider, lb *loadbalancer.LoadBalancer, bs *loadbalancer.BackendSet, bsName string, beSpec *ociloadbalancerv1.OciLoadBalancerSpec_Backend) error {
...
func buildHealthChecker(hc *ociloadbalancerv1.OciLoadBalancerSpec_HealthChecker) loadbalancer.BackendSetHealthCheckerArgs {
	protocolMap := map[ociloadbalancerv1.OciLoadBalancerSpec_HealthChecker_Protocol]string{
		ociloadbalancerv1.OciLoadBalancerSpec_HealthChecker_http: "HTTP",
		ociloadbalancerv1.OciLoadBalancerSpec_HealthChecker_tcp:  "TCP",
	}
...
func buildBackendSetSslConfiguration(ssl *ociloadbalancerv1.OciLoadBalancerSpec_SslConfiguration) *loadbalancer.BackendSetSslConfigurationArgs {
...
func buildLbCookieSessionPersistence(cfg *ociloadbalancerv1.OciLoadBalancerSpec_LbCookieSessionPersistenceConfig) *loadbalancer.BackendSetLbCookieSessionPersistenceConfigurationArgs {
...
func buildSessionPersistence(cfg *ociloadbalancerv1.OciLoadBalancerSpec_SessionPersistenceConfig) *loadbalancer.BackendSetSessionPersistenceConfigurationArgs {
