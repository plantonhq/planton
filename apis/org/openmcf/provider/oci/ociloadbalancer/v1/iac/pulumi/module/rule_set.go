...
var actionMap = map[ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem_Action]string{
	ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem_add_http_request_header:          "ADD_HTTP_REQUEST_HEADER",
	ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem_add_http_response_header:         "ADD_HTTP_RESPONSE_HEADER",
	ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem_extend_http_request_header_value:  "EXTEND_HTTP_REQUEST_HEADER_VALUE",
	ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem_extend_http_response_header_value: "EXTEND_HTTP_RESPONSE_HEADER_VALUE",
	ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem_remove_http_request_header:        "REMOVE_HTTP_REQUEST_HEADER",
	ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem_remove_http_response_header:       "REMOVE_HTTP_RESPONSE_HEADER",
	ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem_redirect:                          "REDIRECT",
	ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem_allow:                             "ALLOW",
	ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem_control_access_using_http_methods: "CONTROL_ACCESS_USING_HTTP_METHODS",
	ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem_http_header:                       "HTTP_HEADER",
	ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem_ip_based_max_connections:          "IP_BASED_MAX_CONNECTIONS",
}
...
func buildRuleSetItems(items []*ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem) loadbalancer.RuleSetItemArray {
...
func buildRuleSetItem(item *ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItem) *loadbalancer.RuleSetItemArgs {
...
func buildRedirectUri(ru *ociloadbalancerv1.OciLoadBalancerSpec_RedirectUri) *loadbalancer.RuleSetItemRedirectUriArgs {
...
func buildConditions(conditions []*ociloadbalancerv1.OciLoadBalancerSpec_RuleSetItemCondition) loadbalancer.RuleSetItemConditionArray {
