...
OciNetworkFirewall bundles the firewall appliance, its policy, and all policy sub-resources into a single component. This is the most complex OCI component in OpenMCF, with 7 distinct resource types created from one manifest.
