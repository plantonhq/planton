...
1. **OpenMCF convention.** Resources are always deployed to their active state. To decommission a resource, delete it. This is consistent across all OpenMCF components.
