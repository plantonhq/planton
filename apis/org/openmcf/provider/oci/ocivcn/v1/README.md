...
- **Automatic Tagging**: Standard OpenMCF freeform tags are applied to the VCN and all gateways (resource kind, resource ID, organization, environment, and user-defined labels from metadata).
