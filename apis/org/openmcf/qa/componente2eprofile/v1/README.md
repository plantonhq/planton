...
This makes CI discovery mechanical. The `openmcf e2e discover` command scans
...
```
apis/org/openmcf/provider/{provider}/{component}/v1/e2e/
...
`apis/org/openmcf/shared/iac.proto`.
