...
func Resources(ctx *pulumi.Context, stackInput *gcpmanagedkafkaconnectorv1alpha1.GcpManagedKafkaConnectorStackInput) error {
	...
	if err := connector(ctx, locals, gcpProvider); err != nil {
