locals {
  ...
  connection_profile_id = var.spec.connection_profile_id != "" ? var.spec.connection_profile_id : var.metadata.name
  ...
  private_connection = var.spec.private_connection != "" ? var.spec.private_connection : null
  ...
  base_labels = {
    ...
    "planton-ai_kind"     = "gcpdatastreamconnectionprofile"
  }
