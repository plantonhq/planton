...
// 	protoc        (unknown)
// source: catalog/gcp/gcptpuqueuedresource/v1alpha1/input.proto
...
var File_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto protoreflect.FileDescriptor
...
const file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_rawDesc = "" +
	...
	"InputProtoP\x01Zcgithub.com/plantonhq/planton/catalog/gcp/gcptpuqueuedresource/v1alpha1;gcptpuqueuedresourcev1alpha1\xa2\x02\x04DPGG\xaa\x02-Dev.Planton.Gcp.Gcptpuqueuedresource.V1alpha1\xca\x02-Dev\\Planton\\Gcp\\Gcptpuqueuedresource\\V1alpha1\xe2\x029Dev\\Planton\\Gcp\\Gcptpuqueuedresource\\V1alpha1\\GPBMetadata\xea\x021Dev::Planton::Gcp::Gcptpuqueuedresource::V1alpha1b\x06proto3"

var (
	file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_rawDescData []byte
)

func file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_rawDesc), len(file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_rawDesc)))
	})
	return file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_rawDescData
}
...
func init() { file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_init() }
func file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_init() {
	if File_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto != nil {
		return
	}
	file_catalog_gcp_gcptpuqueuedresource_v1alpha1_api_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_rawDesc), len(file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto = out.File
	file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_goTypes = nil
	file_catalog_gcp_gcptpuqueuedresource_v1alpha1_input_proto_depIdxs = nil
}
