...
// 	protoc        (unknown)
// source: catalog/gcp/gcpmodelarmorfloorsetting/v1alpha1/outputs.proto
...
type GcpModelArmorFloorSettingStackOutputs struct {
	...
	// The parent the floor governs: projects/{id}, folders/{id}, or
	// organizations/{id}.
...
var File_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto protoreflect.FileDescriptor
...
var (
	file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_rawDescData []byte
)

func file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_rawDesc), len(file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_rawDesc)))
	})
	return file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_rawDescData
}
...
func init() { file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_init() }
func file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_init() {
	if File_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_rawDesc), len(file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto = out.File
	file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_goTypes = nil
	file_catalog_gcp_gcpmodelarmorfloorsetting_v1alpha1_outputs_proto_depIdxs = nil
}
