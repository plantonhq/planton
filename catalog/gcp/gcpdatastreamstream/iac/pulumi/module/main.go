...
func Resources(ctx *pulumi.Context, stackInput *gcpdatastreamstreamv1alpha1.GcpDatastreamStreamStackInput) error {
	...
	if err := stream(ctx, locals, gcpProvider); err != nil {
