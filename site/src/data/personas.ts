...
export const PERSONAS: readonly Persona[] = [
  ...
  },
  {
    ...
    beats: [
      ...
      { chapter: 'how-it-compares', weight: 'supporting', angle: 'Posture platforms observe after the fact; Planton prevents at creation. They complement each other, and neither replaces the other.', proof: [0, 1], provenAt: '/trust/security-posture' },
