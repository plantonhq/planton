...
import { ShowcaseTabs } from "@/components/showcase";
import type { TerminalLineData } from "@/components/showcase";
import { OPERATING_SYSTEMS } from "@/site";

// A single-manifest apply — the `kubectl apply -f` parallel (one component).
...
/** The hero: positioning, the primary CTA, and the desktop/terminal duality up top. */
    ...
    <section className="px-4 pt-32 sm:px-6 sm:pt-40 lg:px-8">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-pretty text-lg leading-relaxed text-muted-foreground">
          Planton is a free Desktop App and CLI you download and open. It finds the
          cloud you&rsquo;re already signed into; pick a stack and fill a short form,
          or <code className="font-mono text-foreground">planton apply -f</code> a
          manifest — and watch it deploy, with clean, auditable infrastructure-as-code
          running underneath. No account. No connections. No ceremony.
        </p>
      ...
      <div className="mx-auto mt-16 max-w-4xl sm:mt-20">
        <ShowcaseTabs
          desktop={{ title: "Planton", label: "Planton Desktop" }}
