...
description: "A Pages project with no git connection. You build the site in your own CI and push it with `wrangler pages deploy`, while the project, its bindings, and its domains are managed declaratively here."
type: "preset"
rank: "02"
presetSlug: "02-direct-upload-site"
