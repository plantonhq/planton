...
description: "Full-featured Worker with KV bindings, custom domain DNS routing, and environment variables. Use for production APIs that need storage, a custom hostname, and config. Script bundle must be pre-built..."
type: "preset"
rank: "01"
presetSlug: "01-api-with-custom-domain"
