...
description: "Creates an MX record for email delivery. Priority is required; MX records cannot be proxied. Use for configuring mail servers (Google Workspace, Microsoft 365, custom mail) for your domain."
type: "preset"
rank: "02"
presetSlug: "02-mx-email"
