...
description: "Creates a CAA record that controls which certificate authorities may issue certificates for your domain. CAA records are structured: their flags, tag, and value are supplied through the `data.caa`..."
type: "preset"
rank: "04"
presetSlug: "04-caa-certificate-authority"
