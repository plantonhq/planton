...
description: "Creates an SRV record that advertises the host and port of a service (SIP, XMPP, Minecraft, etc.). SRV records are structured: their priority, weight, port, and target are supplied through the..."
type: "preset"
rank: "03"
presetSlug: "03-srv-service"
