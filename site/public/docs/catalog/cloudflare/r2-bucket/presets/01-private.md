...
description: "Creates a private R2 bucket with no public access. Data is accessible only via Workers, API tokens, or the Cloudflare Dashboard. Use for backups, logs, or any object storage that must stay private."
type: "preset"
rank: "01"
