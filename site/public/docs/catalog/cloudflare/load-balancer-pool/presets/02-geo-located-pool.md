...
description: "A regional pool tagged with latitude/longitude and a least-connections origin policy, for use with a load balancer's `proximity` or `geo` steering."
type: "preset"
rank: "02"
presetSlug: "02-geo-located-pool"
