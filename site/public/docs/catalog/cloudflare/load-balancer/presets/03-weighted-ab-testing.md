...
description: "Two origins with steering=random and different weights: traffic is distributed by weight (e.g., 70% control, 30% variant). Use for A/B tests, canary deployments, or gradual rollouts."
type: "preset"
rank: "03"
