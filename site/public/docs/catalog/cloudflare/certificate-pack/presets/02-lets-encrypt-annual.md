...
description: "A single-hostname (apex) certificate issued by Let's Encrypt with the longest validity (365 days). Useful when you only need to cover the bare domain and prefer a yearly rotation cadence."
type: "preset"
rank: "02"
presetSlug: "02-lets-encrypt-annual"
