...
description: "A Hyperdrive config that connects to a PostgreSQL origin requiring mutual TLS, verifying both the CA and the server hostname."
type: "preset"
rank: "02"
presetSlug: "02-postgres-mtls"
