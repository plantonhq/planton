---
title: "MongoDB Atlas"
description: "MongoDB Atlas deployment documentation"
icon: "package"
order: 100
...
|-------|------|-------------|------------|
| `clusterConfig.projectId` | `string` | The unique ID for the MongoDB Atlas project where the cluster is created. | — |
...
|--------|------|-------------|
| `id` | `string` | Provider-assigned unique ID for the MongoDB Atlas cluster |
