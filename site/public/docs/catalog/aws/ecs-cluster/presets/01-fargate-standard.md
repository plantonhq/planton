...
description: "This preset creates an ECS cluster using AWS Fargate with CloudWatch Container Insights enabled. Fargate eliminates the need to manage EC2 instances for container workloads -- AWS handles the compute..."
type: "preset"
rank: "01"
