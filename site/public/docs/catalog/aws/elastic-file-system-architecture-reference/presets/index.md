---
title: "Presets"
description: "Ready-to-deploy configuration presets for Elastic File System: Architecture Reference"
type: "preset-list"
componentSlug: "elastic-file-system-architecture-reference"
componentTitle: "Elastic File System: Architecture Reference"
provider: "aws"
icon: "package"
order: 200
presets:
...
# Elastic File System: Architecture Reference Presets

Ready-to-deploy configuration presets for Elastic File System: Architecture Reference. Each preset is a complete manifest you can copy, customize, and deploy.
