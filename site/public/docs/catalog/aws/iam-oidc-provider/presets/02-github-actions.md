...
description: "This preset registers GitHub Actions as a trusted OIDC identity provider, enabling keyless deployments from CI. Workflows assume an IAM deploy role with a short-lived token on every run, removing..."
type: "preset"
rank: "02"
presetSlug: "02-github-actions"
