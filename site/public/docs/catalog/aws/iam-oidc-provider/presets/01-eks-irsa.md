...
description: "This preset registers an EKS cluster's OIDC issuer as a trusted IAM identity provider, enabling IAM Roles for Service Accounts (IRSA). It references the cluster directly, so the issuer URL is..."
type: "preset"
rank: "01"
presetSlug: "01-eks-irsa"
