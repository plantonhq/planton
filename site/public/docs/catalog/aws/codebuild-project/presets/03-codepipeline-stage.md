...
description: "This preset creates a CodeBuild project designed to run as a build or test stage within an AWS CodePipeline. Source code and build artifacts are managed by the pipeline — CodeBuild receives input..."
type: "preset"
rank: "03"
presetSlug: "03-codepipeline-stage"
