...
- [AwsSqsQueue](/docs/catalog/aws/sqs-queue) — common subscription target for fan-out and decoupling patterns
- [AwsKmsKey](/docs/catalog/aws/kms-key) — provides a customer-managed encryption key for topic encryption
- [AwsLambda](/docs/catalog/aws/lambda) — subscribe Lambda functions for serverless event processing
- [AwsIamRole](/docs/catalog/aws/iam-role) — provides roles for Firehose subscriptions and cross-account access
- [AwsEventBridgeBus](/docs/catalog/aws/eventbridge-bus) — routes EventBridge events to SNS topics as targets
