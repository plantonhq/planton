...
description: "This preset creates a minimal IPv4-only VPC with a `/16` CIDR and DNS enabled -- a clean foundation for development and testing networks. Add `AwsSubnet` components (and, if outbound internet access..."
type: "preset"
rank: "02"
