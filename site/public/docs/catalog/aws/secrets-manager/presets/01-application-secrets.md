...
description: "This preset creates a set of secrets in AWS Secrets Manager for a typical application. It provisions empty secret placeholders for database credentials, API keys, and TLS certificates. Secret values..."
type: "preset"
rank: "01"
presetSlug: "01-application-secrets"
