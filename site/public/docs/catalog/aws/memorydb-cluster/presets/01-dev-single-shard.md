...
description: "This preset creates a single-shard, single-node MemoryDB cluster with TLS encryption and the open-access ACL. It is the simplest way to get a durable Redis-compatible database running for development."
type: "preset"
rank: "01"
