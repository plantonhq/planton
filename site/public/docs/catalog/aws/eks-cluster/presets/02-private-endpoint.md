...
description: "This preset creates an EKS cluster with the API server endpoint restricted to VPC-internal access only. The Kubernetes API is not reachable from the public internet. Use this for security-sensitive..."
type: "preset"
rank: "02"
