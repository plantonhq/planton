...
description: "This preset deploys a Fargate-based ECS service fronted by an Application Load Balancer using path-based routing. It runs 2 replicas across two Availability Zones with CloudWatch logging and a..."
type: "preset"
rank: "01"
presetSlug: "01-web-service-alb"
