...
description: "An internet gateway attached to a Planton-managed `AwsVpc` by reference. This is the canonical composition path: create an `AwsVpc`, create this gateway pointing at it, then give your public subnets..."
type: "preset"
rank: "01"
presetSlug: "01-public-internet-gateway"
