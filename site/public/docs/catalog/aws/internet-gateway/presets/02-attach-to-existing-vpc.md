...
description: "An internet gateway attached to a VPC that already exists outside Planton, by literal vpc-id. Use this when the VPC is managed elsewhere (an existing landing zone, another tool, or a hand-created..."
type: "preset"
rank: "02"
presetSlug: "02-attach-to-existing-vpc"
