...
description: "A private NAT gateway (no Elastic IP) placed in an `AwsSubnet` by reference. A private gateway provides outbound access to other private networks — peered VPCs, a transit gateway, or an on-premises..."
type: "preset"
rank: "02"
presetSlug: "02-private-nat-gateway"
