...
description: "This preset creates a production-grade Global Accelerator that distributes TCP traffic across two AWS regions — `us-east-1` (60% traffic) and `eu-west-1` (40% traffic). It configures HTTP health..."
type: "preset"
rank: "02"
presetSlug: "02-multi-region-production"
