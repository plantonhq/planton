...
description: "This preset creates a production-grade OpenSearch domain with 3 data nodes across 3 Availability Zones, 3 dedicated master nodes, VPC deployment, fine-grained access control with internal user..."
type: "preset"
rank: "02"
presetSlug: "02-production-vpc"
...
- **VPC with valueFrom references** — Subnet and security group IDs pulled from other OpenMCF resources for full infrastructure composability
