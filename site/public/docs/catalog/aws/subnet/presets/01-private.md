...
description: "A private subnet whose default route points at a NAT gateway: instances can reach the internet outbound (patching, image pulls, external APIs) but cannot be reached from it. This is the standard..."
type: "preset"
rank: "01"
