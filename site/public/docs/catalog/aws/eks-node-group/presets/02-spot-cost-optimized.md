...
description: "This preset creates an EKS managed node group using Spot instances for up to 70% cost savings compared to on-demand. The `node-lifecycle: spot` label enables workload targeting via node selectors or..."
type: "preset"
rank: "02"
