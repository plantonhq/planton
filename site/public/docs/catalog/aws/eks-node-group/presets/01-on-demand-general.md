...
description: "This preset creates an EKS managed node group using on-demand `t3.medium` instances across two Availability Zones. The group scales between 2 and 5 nodes with 100 GiB root disks. This is the standard..."
type: "preset"
rank: "01"
