...
description: "This preset creates an AWS Client VPN endpoint using mutual TLS certificate authentication with split-tunnel routing. Only traffic destined for the VPC flows through the VPN -- all other internet..."
type: "preset"
rank: "01"
