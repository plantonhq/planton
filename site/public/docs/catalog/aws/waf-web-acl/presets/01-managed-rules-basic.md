...
description: "This preset creates a Web ACL with two AWS Managed Rule Groups that cover the most common web application threats. It allows all traffic by default and relies on the managed rules to block known bad..."
type: "preset"
rank: "01"
presetSlug: "01-managed-rules-basic"
