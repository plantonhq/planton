...
description: "An egress-only internet gateway attached to a Planton-managed dual-stack `AwsVpc` by reference. This is the canonical composition path: create an `AwsVpc` with an IPv6 CIDR, create this gateway..."
type: "preset"
rank: "01"
presetSlug: "01-ipv6-egress"
