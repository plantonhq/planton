...
description: "A minimal Athena workgroup for interactive SQL analytics with query results stored in S3. All governance defaults apply — configuration enforcement is enabled, CloudWatch metrics are published."
type: "preset"
rank: "01"
presetSlug: "01-basic-sql-workgroup"
