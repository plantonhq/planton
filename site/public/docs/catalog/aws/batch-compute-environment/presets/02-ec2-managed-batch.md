...
description: "This preset creates an EC2-based AWS Batch compute environment with auto-scaling from 0 to 512 vCPUs. Uses `optimal` instance type selection and two priority-separated job queues. Ideal for..."
type: "preset"
rank: "02"
