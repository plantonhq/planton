...
description: "This preset creates a serverless AWS Batch compute environment using Fargate. AWS manages all infrastructure — no EC2 instances to configure, patch, or scale. Ideal for teams that want to run batch..."
type: "preset"
rank: "01"
