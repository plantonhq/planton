---
title: "AzureRedisCache: Deployment Landscape & Design Research"
description: "AzureRedisCache: Deployment Landscape & Design Research deployment documentation"
icon: "package"
order: 100
...
| **OpenMCF AzureRedisCache** | Full stack | Declarative | Composable | Multi-cloud consistency, infra charts |

### Why OpenMCF for Redis?

OpenMCF's value is **composability**. A Redis cache rarely exists in isolation -- it's
part of a larger deployment alongside databases, compute, and networking. OpenMCF's
...
connection string, not via other OpenMCF resources. The exception is
