...
description: "Applicationinsights deployment documentation"
icon: "package"
order: 100
...
OpenMCF adds composability (StringValueOrRef for resource_group and workspace_id) and consistency (same API pattern across all cloud providers) on top of Terraform/Pulumi.
...
## 7. OpenMCF Design: The 80/20 Applied
