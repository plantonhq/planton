...
description: "This preset deploys a background worker that processes messages from an Azure Service Bus queue. It has no ingress (not accessible via HTTP), scales to zero when the queue is empty, and scales up to..."
type: "preset"
rank: "02"
presetSlug: "02-background-worker"
