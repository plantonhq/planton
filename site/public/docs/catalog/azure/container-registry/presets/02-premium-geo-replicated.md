...
description: "This preset creates an Azure Container Registry with Premium SKU and geo-replication to a secondary region. Premium tier provides 500 GB storage, geo-replication for multi-region image distribution,..."
type: "preset"
rank: "02"
