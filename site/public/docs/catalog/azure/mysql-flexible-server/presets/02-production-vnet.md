...
description: "This preset creates an Azure Database for MySQL Flexible Server injected into a virtual network subnet. Public network access is automatically disabled when `delegatedSubnetId` is set, ensuring the..."
type: "preset"
rank: "02"
