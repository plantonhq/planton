...
description: "This preset creates a minimal Azure Database for MySQL Flexible Server using the Burstable B1ms SKU (~$12/month) with 20 GB storage, no high availability, no geo-redundant backup, and public access..."
type: "preset"
rank: "03"
