...
description: "This preset creates an Azure Database for MySQL Flexible Server with General Purpose compute, 32 GB storage with auto-grow enabled, and public network access controlled by firewall rules. A starter..."
type: "preset"
rank: "01"
