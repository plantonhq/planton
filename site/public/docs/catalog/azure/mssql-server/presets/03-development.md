...
description: "This preset creates an Azure SQL logical server with a single Basic-tier database (~$5/month for 5 DTU, 2 GB max). Designed for development, testing, and staging environments where cost matters more..."
type: "preset"
rank: "03"
