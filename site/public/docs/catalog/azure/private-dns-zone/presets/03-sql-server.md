...
description: "This preset creates a Private DNS Zone for Azure SQL Server (MSSQL) Private Endpoint connectivity. The zone name `privatelink.database.windows.net` is required by Azure for DNS resolution of SQL..."
type: "preset"
rank: "03"
presetSlug: "03-sql-server"
