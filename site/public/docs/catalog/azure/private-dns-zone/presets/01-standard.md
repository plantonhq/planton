...
description: "This preset creates an Azure Private DNS Zone for PostgreSQL Flexible Server Private Link resolution, linked to a Virtual Network. When a private endpoint is created for a PostgreSQL server, its..."
type: "preset"
rank: "01"
