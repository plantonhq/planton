...
description: "A Standard-tier Front Door profile configured as an API gateway with multi-origin health-based failover and path-based routing to separate API and static asset backends."
type: "preset"
rank: "02"
presetSlug: "02-multi-region-api-gateway"
