...
description: "This preset creates an Azure Database for PostgreSQL Flexible Server injected into a virtual network subnet. Public network access is automatically disabled when `delegatedSubnetId` is set, ensuring..."
type: "preset"
rank: "02"
presetSlug: "02-production-vnet"
