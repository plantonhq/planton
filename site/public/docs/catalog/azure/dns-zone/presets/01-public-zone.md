...
description: "This preset creates an Azure DNS Zone for hosting public DNS records for a domain. The zone is created empty -- DNS records are managed separately via `AzureDnsRecord` resources or added inline via..."
type: "preset"
rank: "01"
