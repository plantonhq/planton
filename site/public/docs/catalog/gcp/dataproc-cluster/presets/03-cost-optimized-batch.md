...
description: "An ephemeral Dataproc cluster optimized for batch Spark jobs using Spot VMs for secondary workers, with aggressive auto-delete for cost control."
type: "preset"
rank: "03"
