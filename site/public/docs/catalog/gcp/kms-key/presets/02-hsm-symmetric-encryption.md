...
description: "Use this preset when you need a customer-managed encryption key that is protected by hardware security modules (HSM). This is required for compliance scenarios that mandate FIPS 140-2 Level 3..."
type: "preset"
rank: "02"
