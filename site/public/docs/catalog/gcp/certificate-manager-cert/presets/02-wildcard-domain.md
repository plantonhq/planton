...
description: "This preset creates a Google-managed wildcard TLS certificate (`*.example.com`) with the apex domain (`example.com`) as a Subject Alternative Name. This covers all subdomains under a single..."
type: "preset"
rank: "02"
