...
description: "This preset creates a Google-managed TLS certificate without auto-creating DNS validation records in Cloud DNS. The `cloudDnsZoneId` field is intentionally omitted so the module exports the required..."
type: "preset"
rank: "03"
