...
description: "This preset creates the project's default Firestore Native database in the US multi-region (nam5) with delete protection enabled. This is the primary database that client libraries connect to when no..."
type: "preset"
rank: "01"
presetSlug: "01-default-native"
