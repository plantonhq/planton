...
description: "This preset creates a set of common application secrets in Google Cloud Secret Manager. The secrets are created as empty shells -- secret values must be populated separately via the GCP console,..."
type: "preset"
rank: "01"
