...
description: "This preset adds a user to a group, enabling group-based access control. When the authorization model grants `group#member` access to resources, all members of the group inherit those permissions...."
type: "preset"
rank: "02"
presetSlug: "02-group-membership"
