...
description: "This preset creates an OpenFGA authorization model with hierarchical folder/document permissions where access is inherited through parent relationships (Google Drive-style). Viewers and editors on a..."
type: "preset"
rank: "02"
presetSlug: "02-document-access-dsl"
