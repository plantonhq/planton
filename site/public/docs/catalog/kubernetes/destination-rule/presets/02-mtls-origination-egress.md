...
description: "Configure the sidecar to originate mutual TLS to an external service, presenting client certificates loaded from a Kubernetes secret. This is how you let in-mesh workloads talk to an external..."
type: "preset"
rank: "02"
presetSlug: "02-mtls-origination-egress"
