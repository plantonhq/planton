...
Planton ships **typed** Pulumi resources for the Istio kinds, generated by crd2pulumi from
a pinned Istio release (`pkg/kubernetes/kubernetestypes/Makefile` → `istio_release`). The
custom resources Planton emits are therefore frozen to that schema version. For those CRs
