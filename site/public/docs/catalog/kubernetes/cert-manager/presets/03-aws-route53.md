...
description: "This preset deploys cert-manager with an AWS Route53 DNS provider for DNS-01 ACME certificate challenges. Authentication uses IAM Roles for Service Accounts (IRSA), so no AWS access keys are stored..."
type: "preset"
rank: "03"
