...
description: "This preset deploys cert-manager with an Azure DNS provider for DNS-01 ACME certificate challenges. Authentication uses Azure Managed Identity, so no client secrets are stored in the cluster."
type: "preset"
rank: "04"
presetSlug: "04-azure-dns"
