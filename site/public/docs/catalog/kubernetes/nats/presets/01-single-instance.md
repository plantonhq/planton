...
description: "This preset deploys a single-node NATS server with JetStream enabled and the NATS Box diagnostic tool. JetStream provides persistent messaging, key-value store, and object store capabilities."
type: "preset"
rank: "01"
