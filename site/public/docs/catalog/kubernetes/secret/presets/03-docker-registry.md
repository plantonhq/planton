...
description: "This preset creates a Docker registry authentication secret (`kubernetes.io/dockerconfigjson`) for pulling images from private container registries. Referenced by pods via `imagePullSecrets`."
type: "preset"
rank: "03"
presetSlug: "03-docker-registry"
