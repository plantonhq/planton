...
description: "This preset deploys a monitoring agent on every node in the cluster, including control-plane nodes. Suitable for node-level metrics collection, log forwarding, or security agents that need to run on..."
type: "preset"
rank: "01"
presetSlug: "01-monitoring-agent"
