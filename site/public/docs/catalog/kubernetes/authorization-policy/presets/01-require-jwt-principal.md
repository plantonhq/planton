...
description: "The canonical AuthorizationPolicy: allow a request only if it carries a valid JWT identity (`request_principals: [\"*\"]` matches any issuer/subject). Anonymous requests -- those with no token, or a..."
type: "preset"
rank: "01"
presetSlug: "01-require-jwt-principal"
