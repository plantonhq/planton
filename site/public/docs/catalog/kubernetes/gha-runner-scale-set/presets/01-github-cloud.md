...
description: "This preset deploys a self-hosted GitHub Actions runner scale set that connects to GitHub.com. Runners scale from 0 to 10 based on queued workflow jobs, using ephemeral pods that are created per job..."
type: "preset"
rank: "01"
presetSlug: "01-github-cloud"
