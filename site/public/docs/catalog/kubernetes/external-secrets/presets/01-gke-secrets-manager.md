...
description: "This preset deploys the External Secrets Operator (ESO) on a GKE cluster with Google Cloud Secret Manager as the backing store. Authentication uses GKE Workload Identity via a Google service account."
type: "preset"
rank: "01"
presetSlug: "01-gke-secrets-manager"
