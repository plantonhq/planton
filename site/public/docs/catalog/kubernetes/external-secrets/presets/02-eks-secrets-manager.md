...
description: "This preset deploys the External Secrets Operator (ESO) on an EKS cluster with AWS Secrets Manager as the backing store. Authentication uses IRSA (IAM Roles for Service Accounts); an IAM role is..."
type: "preset"
rank: "02"
presetSlug: "02-eks-secrets-manager"
