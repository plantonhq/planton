...
description: "This preset creates a CronJob that runs every 6 hours with a Forbid concurrency policy. The most common CronJob pattern: a periodic task that should not overlap with previous runs."
type: "preset"
rank: "01"
presetSlug: "01-scheduled-task"
