...
description: "This preset deploys OpenBao in high-availability mode with GCP Cloud KMS auto-unseal and GKE Workload Identity. Pods unseal automatically on every restart without human intervention, eliminating the..."
type: "preset"
rank: "03"
