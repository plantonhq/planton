...
description: "Register a service that has a fixed set of backing IPs (a VM-hosted database, a legacy service, an appliance) as a MESH_INTERNAL destination with STATIC resolution. Mesh workloads then reach it by..."
type: "preset"
rank: "02"
presetSlug: "02-static-mesh-internal-endpoints"
