...
description: "The canonical ServiceEntry: register an external service (a SaaS API, a partner endpoint) so mesh workloads can call it as a first-class destination, with TLS routed by SNI and the host resolved via..."
type: "preset"
rank: "01"
presetSlug: "01-external-https-api"
