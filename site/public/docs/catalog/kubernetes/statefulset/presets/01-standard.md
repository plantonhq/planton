...
description: "This preset deploys a single-replica StatefulSet without persistent volumes. Suitable for stateful applications that need stable pod identities and network names but do not require persistent storage."
type: "preset"
rank: "01"
