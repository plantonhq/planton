...
description: "This preset deploys a single-replica Redis instance with persistence enabled and 1Gi of disk storage. The most common Redis configuration for caching and session storage."
type: "preset"
rank: "01"
