...
description: "Customize the dimensions (labels) Istio attaches to its Prometheus metrics for a namespace or workload: add high-value tags (request host, method) and drop noisy/high-cardinality ones (response..."
type: "preset"
rank: "02"
presetSlug: "02-prometheus-metric-dimensions"
