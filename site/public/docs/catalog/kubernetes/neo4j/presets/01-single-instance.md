...
description: "This preset deploys a single-replica Neo4j graph database with persistence. Neo4j is memory-intensive, so this preset allocates higher memory than typical database defaults."
type: "preset"
rank: "01"
