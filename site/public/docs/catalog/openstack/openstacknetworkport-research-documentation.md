---
title: "OpenStackNetworkPort Research Documentation"
description: "OpenStackNetworkPort Research Documentation deployment documentation"
icon: "package"
order: 100
...
This is the first OpenMCF component to use `repeated StringValueOrRef`. Each element in the list independently resolves as either a literal UUID or a `value_from` reference. This enables InfraChart DAG wiring to multiple security groups created in the same chart.
