...
description: "This preset creates an Octavia load balancer with a VIP on the specified subnet. The load balancer itself is just the VIP endpoint -- attach listeners, pools, members, and monitors to complete the..."
type: "preset"
rank: "01"
