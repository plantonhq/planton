...
description: "This preset allocates a floating IP and immediately associates it with a port, providing external connectivity to whatever is attached to that port (typically an instance). This is a single-resource..."
type: "preset"
rank: "02"
presetSlug: "02-with-port-association"
