---
title: "OpenStackSecurityGroup: Research & Design Documentation"
description: "OpenStackSecurityGroup: Research & Design Documentation deployment documentation"
icon: "package"
order: 100
...
This document captures the research, design decisions, and implementation rationale behind the OpenMCF `OpenStackSecurityGroup` deployment component.
...
2. **Neutron security groups** (Icehouse+): The modern implementation, managed through the Networking (Neutron) API. This is what OpenMCF targets.
...
This is the first OpenMCF component that creates N+1 resources from a single spec:
