...
description: "This preset creates a Cinder volume pre-populated with a Glance image. The resulting volume is bootable and can be used as a root disk for instances. Create the volume first, then reference it in an..."
type: "preset"
rank: "02"
presetSlug: "02-bootable-from-image"
