...
description: "This preset creates an empty Cinder volume for application data storage. The volume is unformatted -- attach it to an instance via `OpenStackVolumeAttach`, then partition and format it from within..."
type: "preset"
rank: "01"
presetSlug: "01-blank-data"
