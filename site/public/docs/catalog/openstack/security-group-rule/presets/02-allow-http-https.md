...
description: "This preset creates a standalone security group rule that allows inbound HTTPS (TCP port 443) from any source. This is the most common standalone rule for web-facing services. For HTTP (port 80),..."
type: "preset"
rank: "02"
presetSlug: "02-allow-http-https"
