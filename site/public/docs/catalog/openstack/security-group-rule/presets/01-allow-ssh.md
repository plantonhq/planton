...
description: "This preset creates a standalone security group rule that allows inbound SSH (TCP port 22) from a trusted CIDR. Use standalone rules (instead of inline rules in `OpenStackSecurityGroup`) when..."
type: "preset"
rank: "01"
presetSlug: "01-allow-ssh"
