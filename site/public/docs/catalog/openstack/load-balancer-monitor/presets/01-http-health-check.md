...
description: "This preset creates an HTTP health monitor that checks backend members by sending a GET request to `/healthz` every 10 seconds. A member is considered healthy after 3 consecutive successful responses..."
type: "preset"
rank: "01"
presetSlug: "01-http-health-check"
