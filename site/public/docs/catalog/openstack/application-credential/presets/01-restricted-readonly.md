...
description: "This preset creates an application credential with read-only access to compute, network, and block-storage APIs. It uses the `reader` role and further restricts access via `accessRules` to GET..."
type: "preset"
rank: "01"
presetSlug: "01-restricted-readonly"
