...
description: "This preset adds a backend server to an Octavia pool. Each member has an IP address and port that the pool forwards traffic to based on its load-balancing algorithm. Create one member resource per..."
type: "preset"
rank: "01"
