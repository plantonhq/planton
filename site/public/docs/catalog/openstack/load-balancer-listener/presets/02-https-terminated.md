...
description: "This preset creates an HTTPS listener on port 443 that terminates TLS at the load balancer. Traffic is decrypted at the Octavia amphora and forwarded to backend pools as plain HTTP. The..."
type: "preset"
rank: "02"
presetSlug: "02-https-terminated"
