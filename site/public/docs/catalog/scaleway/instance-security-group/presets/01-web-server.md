...
description: "This preset creates a security group for web-facing instances using an allowlist model. Inbound traffic is dropped by default, with explicit rules accepting SSH (from a restricted CIDR), HTTP, and..."
type: "preset"
rank: "01"
