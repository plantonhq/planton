...
description: "This preset creates a single-node Scaleway Redis cluster using the smallest available node type with public ACL access. It is the fastest path to a working Redis instance for development, caching,..."
type: "preset"
rank: "01"
