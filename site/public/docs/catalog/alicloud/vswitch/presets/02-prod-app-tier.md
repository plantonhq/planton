...
description: "This preset creates a VSwitch sized for production application workloads using a /20 CIDR from the 10.x.x.x range. The larger address space (4,096 IPs) accommodates Kubernetes node pools, ECS fleets,..."
type: "preset"
rank: "02"
presetSlug: "02-prod-app-tier"
