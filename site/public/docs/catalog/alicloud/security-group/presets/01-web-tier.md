...
description: "This preset creates a security group suitable for public-facing web servers or load balancers. It allows HTTP (port 80) and HTTPS (port 443) inbound from any source, with unrestricted outbound access."
type: "preset"
rank: "01"
