...
description: "This preset creates a locked-down security group for database instances (RDS, PolarDB, Redis, MongoDB). It only allows connections on standard database ports from the VPC CIDR range, with no public..."
type: "preset"
rank: "02"
