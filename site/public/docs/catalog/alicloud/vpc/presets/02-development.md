...
description: "This preset creates a minimal VPC for development and testing environments. It uses a 192.168.x.x CIDR range (different from the 10.x production range) so development and production VPCs can coexist..."
type: "preset"
rank: "02"
