...
description: "This preset creates a RAM role that Alibaba Cloud Function Compute can assume when executing functions. It includes Log Service (SLS) full access so function invocation logs are written to your SLS..."
type: "preset"
rank: "02"
presetSlug: "02-fc-execution-role"
