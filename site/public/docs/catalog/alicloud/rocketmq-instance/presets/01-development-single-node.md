...
description: "A minimal RocketMQ 5.x instance for development and testing. Uses the standard edition with a single-node deployment, which is the cheapest way to get a working message broker for local integration..."
type: "preset"
rank: "01"
presetSlug: "01-development-single-node"
