...
description: "Connects two VPCs in the same Alibaba Cloud region via a Cloud Enterprise Network (CEN) instance. This is the most common CEN pattern -- isolating workloads (production, staging, shared-services)..."
type: "preset"
rank: "01"
presetSlug: "01-multi-vpc-same-region"
