---
title: "Hetzner Cloud Certificate"
description: "Hetzner Cloud Certificate deployment documentation"
icon: "package"
order: 100
...
- [HetznerCloudLoadBalancer](/docs/catalog/hetznercloud/hetzner-cloud-load-balancer) — The primary consumer of certificates. Load balancer HTTPS services reference `certificate_id` to terminate TLS connections.
