---
title: "Hetzner Cloud Placement Group"
description: "Hetzner Cloud Placement Group deployment documentation"
icon: "package"
order: 100
...
- [HetznerCloudServer](/docs/catalog/hetznercloud/hetzner-cloud-server) — References placement group IDs for anti-affinity server placement
- [HetznerCloudSshKey](/docs/catalog/hetznercloud/hetzner-cloud-ssh-key) — Commonly deployed alongside placement groups as a foundation for server provisioning
- [HetznerCloudFirewall](/docs/catalog/hetznercloud/hetzner-cloud-firewall) — Security boundaries applied to servers in placement groups
