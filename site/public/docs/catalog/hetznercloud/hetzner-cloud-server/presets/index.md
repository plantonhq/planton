---
title: "Presets"
description: "Ready-to-deploy configuration presets for Hetzner Cloud Server"
type: "preset-list"
...
# Hetzner Cloud Server Presets

Ready-to-deploy configuration presets for Hetzner Cloud Server. Each preset is a complete manifest you can copy, customize, and deploy.
