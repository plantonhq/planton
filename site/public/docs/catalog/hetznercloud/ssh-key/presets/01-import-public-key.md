...
description: "This preset registers an existing SSH public key in Hetzner Cloud so it can be injected into servers at creation time. Generate a keypair locally with `ssh-keygen` and import only the public half --..."
type: "preset"
rank: "01"
