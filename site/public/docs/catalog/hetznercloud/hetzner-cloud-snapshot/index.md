---
title: "Hetzner Cloud Snapshot"
description: "Hetzner Cloud Snapshot deployment documentation"
icon: "package"
order: 100
...
- [HetznerCloudServer](/docs/catalog/hetznercloud/hetzner-cloud-server) — The source server to snapshot (referenced via `serverId`) and the consumer of snapshot images (via the `image` field)
