...
description: "This preset creates a DNS zone in secondary mode where Hetzner Cloud acts as a secondary (slave) nameserver, synchronizing records from your external primary nameserver via zone transfer (AXFR/IXFR)...."
type: "preset"
rank: "02"
presetSlug: "02-secondary-zone"
