...
description: "This preset creates a DigitalOcean Cloud Firewall for database Droplets. It restricts inbound access to PostgreSQL (port 5432) from web-tier Droplets only, and limits SSH to a management CIDR...."
type: "preset"
rank: "02"
