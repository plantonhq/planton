...
description: "This preset creates a DigitalOcean Cloud Firewall for web-facing Droplets. It allows inbound HTTP/HTTPS from anywhere, restricts SSH to a management CIDR, and permits all outbound traffic. The..."
type: "preset"
rank: "01"
