...
description: "This preset creates a load balancer that terminates TLS on port 443 and forwards traffic to backend Droplets over HTTP on port 80. Uses tag-based targeting so any Droplet with the `web` tag in the..."
type: "preset"
rank: "01"
presetSlug: "01-https-ssl-termination"
