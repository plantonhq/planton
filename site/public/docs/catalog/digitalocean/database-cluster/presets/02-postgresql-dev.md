...
description: "This preset creates a single-node PostgreSQL database for development and testing. No VPC is required, and the smallest node size keeps costs minimal. Ideal for local development, CI/CD test..."
type: "preset"
rank: "02"
presetSlug: "02-postgresql-dev"
