...
description: "This preset creates a DNS zone with a single A record pointing the root domain to your web server or load balancer IP. Minimal configuration for getting a domain live quickly. TTL is set to 1 hour..."
type: "preset"
rank: "01"
