...
description: "This preset creates a DNS zone with A, MX, and TXT (SPF) records for a production website that also receives email. The A record points the domain to your web server; MX directs mail to your mail..."
type: "preset"
rank: "02"
presetSlug: "02-production-with-email"
