...
description: "This preset creates a long-lived compartment for a project, team, or workload. The compartment is retained even if the IaC resource is destroyed (`enableDelete: false`), which is OCI's safety..."
type: "preset"
rank: "01"
presetSlug: "01-project"
