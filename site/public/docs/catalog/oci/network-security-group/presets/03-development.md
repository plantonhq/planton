...
description: "This preset creates a fully permissive Network Security Group that allows all inbound and outbound traffic on all protocols and ports. This is the simplest NSG configuration, suitable for..."
type: "preset"
rank: "03"
