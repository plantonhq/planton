...
description: "This preset creates a non-sharded OCI Cache (Redis) cluster with 3 nodes: one primary and two replicas. The primary handles all writes while replicas serve read traffic and provide automatic..."
type: "preset"
rank: "01"
presetSlug: "01-non-sharded-cluster"
