...
description: "This preset creates a sharded OCI Cache (Redis) cluster with 3 shards and 3 nodes per shard (9 nodes total). Data is automatically distributed across shards using Redis Cluster's hash slot mechanism,..."
type: "preset"
rank: "02"
presetSlug: "02-sharded-cluster"
