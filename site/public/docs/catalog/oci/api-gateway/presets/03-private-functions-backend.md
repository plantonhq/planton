...
description: "This preset creates a private (VCN-internal) OCI API Gateway that routes requests to OCI Functions backends. The gateway is accessible only from within the VCN (or via peered VCNs, VPN, and..."
type: "preset"
rank: "03"
presetSlug: "03-private-functions-backend"
