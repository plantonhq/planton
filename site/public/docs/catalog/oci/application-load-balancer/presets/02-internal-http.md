...
description: "This preset creates a private OCI Application Load Balancer for distributing traffic across backend services within the VCN. It uses the flexible shape with 10-50 Mbps bandwidth, deploys in a single..."
type: "preset"
rank: "02"
presetSlug: "02-internal-http"
...
| `<internal-lb-nsg-ocid>` | OCID of the NSG controlling access to the internal load balancer (allow traffic from VCN CIDR) | OCI Console > Networking > NSGs, or `OciSecurityGroup` status outputs |
