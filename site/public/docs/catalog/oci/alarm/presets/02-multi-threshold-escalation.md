...
description: "This preset creates a single monitoring alarm with tiered alerting using the override mechanism. The base rule fires a WARNING when CPU exceeds 70% for 5 minutes, while the override escalates to..."
type: "preset"
rank: "02"
presetSlug: "02-multi-threshold-escalation"
componentSlug: "alarm"
