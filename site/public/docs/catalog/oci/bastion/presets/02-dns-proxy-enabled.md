...
description: "This preset creates an OCI Bastion with DNS proxy and SOCKS5 support enabled, allowing sessions to target resources using fully qualified domain names (FQDNs) instead of IP addresses. This is..."
type: "preset"
rank: "02"
presetSlug: "02-dns-proxy-enabled"
