---
title: "Examples"
description: "Copy-paste-ready manifest examples for deploying infrastructure with OpenMCF across multiple cloud providers"
icon: "code"
order: 50
---
...
This section provides ready-to-use manifest examples for deploying infrastructure with OpenMCF. Each example is a complete, valid manifest that you can copy, customize, and deploy.
...
4. **Deploy** with the OpenMCF CLI:

```bash
# Preview what will be created
openmcf plan -f my-resource.yaml

# Deploy the resource
openmcf apply -f my-resource.yaml
```
