---
title: "Guides"
description: "How-to guides for OpenMCF — manifests, credentials, provider setup, state backends, Kustomize, CI/CD, and migration"
icon: "guide"
order: 30
---
...
Practical how-to guides for deploying and managing infrastructure with OpenMCF. Each guide focuses on a specific task and assumes you have completed the [Getting Started](/docs/getting-started) walkthrough.
...
- **[Migrating to OpenMCF](./migrating-to-openmcf)** — Step-by-step migration from raw Terraform or Pulumi
