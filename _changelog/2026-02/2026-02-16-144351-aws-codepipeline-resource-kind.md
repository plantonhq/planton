...
- No declarative pipeline-as-code option within the Planton framework
- CodeBuild projects existed in Planton but had no orchestrator to chain them with source and deploy stages
- Teams needed to manage pipelines outside of Planton, breaking the single-pane-of-glass model
