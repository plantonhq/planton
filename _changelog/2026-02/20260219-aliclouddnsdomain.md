# AlicloudDnsDomain Component Added

**Date**: 2026-02-19
**Component**: AlicloudDnsDomain
**Enum**: 3040
**ID Prefix**: acdns

## Summary

Added the AlicloudDnsDomain deployment component -- manages DNS domains in the Alibaba Cloud Alidns service. This is the prerequisite for creating DNS records (A, AAAA, CNAME, MX, TXT, etc.) via the AlicloudDnsRecord component.
...
### API Definition
- `apis/org/openmcf/provider/alicloud/aliclouddnsdomain/v1/` -- Full proto API (spec, api, stack_input, stack_outputs)
- Registered `AlicloudDnsDomain = 3040` in `CloudResourceKind` enum under the DNS category
