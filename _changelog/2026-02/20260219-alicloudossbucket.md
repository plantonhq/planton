# AlicloudOssBucket Component Added

**Date**: 2026-02-19
**Component**: AlicloudOssBucket
**Enum**: 3050
**ID Prefix**: acoss

## Summary

Added the AlicloudOssBucket deployment component -- the first Storage-tier resource in the Alibaba Cloud catalog. This component manages an Alibaba Cloud OSS bucket with configurable access control, storage class, zone redundancy, versioning, server-side encryption, lifecycle management, CORS rules, and access logging.

## What Was Created

### API Definition
- `apis/org/openmcf/provider/alicloud/alicloudossbucket/v1/` -- Full proto API (spec, api, stack_input, stack_outputs)
- Registered `AlicloudOssBucket = 3050` in `CloudResourceKind` enum under the Storage category
- 5 nested messages: `AlicloudOssBucketEncryption`, `AlicloudOssBucketLifecycleRule`, `AlicloudOssBucketLifecycleTransition`, `AlicloudOssBucketCorsRule`, `AlicloudOssBucketLogging`
