...
bazel run //:openmcf -- load-manifest \
  ~/scm/github.com/plantonhq/planton/ops/organizations/planton/infra-hub/cloud-resources/app-prod/kubernetes/addon/external-dns/external-dns.planton.cloud.yaml
```
...
metadata:
  ...
  env: app-prod
  labels:
    pulumi.openmcf.org/stack.name: app-prod.ExternalDnsKubernetes.external-dns-planton
spec:
  targetCluster:
