...
var Schema = &cobra.Command{
	Use:   "schema",
	Short: "Generate the universal kustomize OpenAPI schema for all OpenMCF resource kinds",
	Long: `Generate a single kustomize-compatible OpenAPI schema JSON that covers all
OpenMCF cloud resource kinds. The schema declares strategic merge patch
